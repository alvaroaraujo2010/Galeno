...
namespace ConsultaExterna.VistaModelo
{
    ...
    /// </para>
    /// </summary>
    public class VistaModeloAtencionAmbulatoriaBase : ViewModelBase, IDataErrorInfo
    {
        //------------------------------------------------
        ...
        /// <para>NOMBRE: g2con_idesec_mter (char:20)</para>
        /// <para>ORDEN VISTA EN TABLA: 9</para>
        /// <para>DESCRIPCION:
        ...
        private ModeloDetServicios _tmpg2regactivo;
        /// <summary>
        ///  Registro activo de la tabla: fcmmaedetallfac
        /// </summary>
        public ModeloDetServicios TmpG2RegActivo
        {
        ...
        private ObservableCollection<ModeloDetServicios> _tmpg2listabrow;
        /// <summary>
        ///  Lista de registros tabla: fcmmaedetallfac
        /// </summary>
        public ObservableCollection<ModeloDetServicios> TmpG2ListaBrow
        {
        ...
        private ObservableCollection<ModeloDetServicios> _tmpg2listaedt;
        /// <summary>
        ///  Lista de registros tabla: fcmmaedetallfac
        /// </summary>
        public ObservableCollection<ModeloDetServicios> TmpG2ListaEdt
        {
        ...
        public RelayCommand<ModeloDetServicios> SelectionChangedCommand { get; set; }
        ...
        public virtual void fcvRegistrarComandos()
        {
            ...
            SelectionChangedCommand = new RelayCommand<ModeloDetServicios>(lobjRegistro =>
            {
        ...
        public VistaModeloAtencionAmbulatoriaBase()
        {
            fcvIniciarComboBox();
            TmpG2ListaBrow = new ObservableCollection<ModeloDetServicios>(ModeloDetServicios.flsListaFcmmaedetallfac(""));
        ...
        public virtual void AdicionarRel()
        {
            ...
            {
                fcvReiniVariables("2");
                TmpG2RegActivo = new ModeloDetServicios();
        ...
        public virtual void Guardar()
        {
            try
            {
                ...
                {
                    foreach (ModeloDetServicios lobReg in TmpG2ListaEdt)
                    {
        ...
        public virtual void Filtro()
        {
            try
            {
                ...
                if (lobTmpReg.Count > 0)
                {
                    ...
                    TmpG2ListaBrow = new ObservableCollection<ModeloDetServicios>(ModeloDetServicios.flsListaFcmmaedetallfac(GcrFiltroDatos));
                    if (TmpG2ListaBrow.Count > 0)
                    {
                        fcvValidarDatosRips("1");
                        TmpG2RegActivo = (ModeloDetServicios)TmpG2ListaBrow[0];
                        fcvCargarVariablesDesdeRegActivo("2");
                    }
                    else 
                    {
        ...
        /// </summary>
        public virtual void fcvGestionEdtRelacion(ModeloDetServicios tobRegistro)
        {
            try
            {
        ...
        public virtual void fcvReiniVariables(string tcrZona)
        {
            try
            {
                ...
                if (tcrZona == "T" || tcrZona == "A")
                {
                    ...
                    //--- Temp para tabla 2
                    TmpG2RegActivo = new ModeloDetServicios();
                    TmpG2ListaBrow = new ObservableCollection<ModeloDetServicios>();
                    TmpG2ListaEdt = new ObservableCollection<ModeloDetServicios>();
                }
            }
            catch (NotImplementedException ex)
            {
            ...
            try
            {
                ...
                if (tcrZona == "2" || tcrZona == "A")
                {
                    if (TmpG2RegActivo != null)
                    {
                        ...
                        TmpG2RegActivo.Con_idesec_mter = G2Con_idesec_mter;
                        ...
                        TmpG2RegActivo.Inv_secart_mart = G2Inv_secart_mart;
                        TmpG2RegActivo.Inv_codart_mart = G2Inv_codart_mart;
                        ...
                        TmpG2RegActivo.Inv_codalm_malm = G2Inv_codalm_malm;
            ...
            try
            {
                ...
                if (tcrZona == "2" || tcrZona == "A")
                {
                    if (TmpG2RegActivo != null)
                    {
                        ...
                        G2Con_idesec_mter = TmpG2RegActivo.Con_idesec_mter;
                        ...
                        G2Inv_secart_mart = TmpG2RegActivo.Inv_secart_mart;
                        G2Inv_codart_mart = TmpG2RegActivo.Inv_codart_mart;
                        ...
                        G2Inv_codalm_malm = TmpG2RegActivo.Inv_codalm_malm;
        ...
        public virtual bool CanEDT()
        {
            ...
            try
            {
                if (TmpG1RegActivo != null && GlgSIS_ModoEdicion == false && G1Adm_estrad_rgad == "1")
                {
                    // verificar si el perfil tiene permiso
        ...
        public void fcvValidarDatosRips(String tcrNivelValidacion)
        {
            var lnuConRipsIncom = 0;
            GlgSIS_CanFinalizarAtencion = false;
            if (TmpG2ListaBrow.Count > 0 && G1Adm_estrad_rgad == "1")
            {
                foreach (ModeloDetServicios lobReg in TmpG2ListaBrow)
                {
                    lobReg.Fcm_desest_rips = lobReg.Fcm_ripsco_dfac == "2" ? "COMPLETO" : "PENDIENTE";
