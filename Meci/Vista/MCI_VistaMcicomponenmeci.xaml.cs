...
namespace Meci.Vista
{
    ...
    /// </summary>
    public partial class VistaMcicomponenmeci : Window, SIS_Interface
    {
        //-------------------------------------------------
        // Inicio Formulario
        //-------------------------------------------------
        ...
        VistaModeloMcicomponenmeci gobObjVModelo = null;
        DialogVistaErrores lobDlgLogs = null;
        /// <summary>
        /// Inicializar nueva instancia de la clase
        /// </summary>
        public VistaMcicomponenmeci()
        {
            InitializeComponent();

            gobObjVModelo = this.DataContext as VistaModeloMcicomponenmeci;
        ...
        private void fcvNuevoRegistro(object sender, RoutedEventArgs e)
        {
            ...
            FocusManager.SetFocusedElement(this, txtG1Mci_descom_mcco);
        }
        ...
        public void fcvActivarModoEdicion(string tcrTipoEdicion)
        {
            ...
            {
                FocusManager.SetFocusedElement(this, txtG1Mci_idesec_mcco);
        ...
        public void fcvBuscarRegistro(string tcrCodigo)
        {
            ...
            {
                case "txtG1Mci_idesec_mcmo":
                    txtG1Mci_idesec_mcmo.Text = tcrCodigo;
                    break;

            }
        }
        #region Cargar Modulos en browser
        /// <summary>
        /// <para>Seleccionar Módulos</para>
        /// </summary>
        #region evento TextChanged
        private void txtG1Mci_idesec_mcmo_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (llgObjetosCargados)
            {
                if (!String.IsNullOrWhiteSpace(txtG1Mci_idesec_mcmo.Text))
                {
                    
                    var tmp = MCIValidarCodigo.fobRegBuscarMcimoduloevmeci(txtG1Mci_idesec_mcmo.Text);
                    if (tmp != null)
                    {
                        this.txtG1Mci_desmod_mcmo.Text = tmp.mci_desmod_mcmo;
                        this.txtG1Mci_idesec_mcpl.Text = tmp.mci_idesec_mcpl;
                        this.txtG1Mci_estreg_mcmo.Text = tmp.mci_estreg_mcmo == "1" ? "ACTIVO" : "INACTIVO";
                    }
        ...
        #region KeyDown para campos con F2 Tabla: MCICOMPONENMECI
        #region MCI_IDESEC_MCMO : Módulos Plantilla Evaluación Meci
        private void txtG1Mci_idesec_mcmo_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Return)
            {
                e.Handled = true;
            ...
            if (e.Key == Key.F2)
            {
                txtG1Mci_idesec_mcmo_Browser();
            }
        }
        private void cmdG1Mci_idesec_mcmo_Click(object sender, RoutedEventArgs e)
        {
            txtG1Mci_idesec_mcmo_Browser();
        }
        private void txtG1Mci_idesec_mcmo_Browser()
        {
            Browser01 frbro = new Browser01("MCI", "MCIMODULOEVMECI", "", "Módulos Plantilla Evaluación Meci...");
            gcrCtrF2TexBox = "txtG1Mci_idesec_mcmo";
            frbro.Owner = this;
            frbro.ShowDialog();
        }
        #endregion
        #region Browser Módulos
        private void fcvBrowserBuscar(object sender, RoutedEventArgs e)
        {
            Browser01 frbro = new Browser01("MCI", "mcimoduloevmeci", "", "Módulos...");
            gcrCtrF2TexBox = "txtG1Mci_idesec_mcmo";
            frbro.Owner = this;
            frbro.ShowDialog();
        }
        ...
        private void SeleccionComboBoxOpcion(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "cboG1Mci_estreg_mcco":
                            txtG1Mci_estreg_mcco.Text = CrtForms.fcrSeletDesdeComb(lobList.IdIndice,
                                                                                    txtG1Mci_estreg_mcco.Text, ",",
                                                                                    lobList.ListaValoresSel);
                            lobCombo.SelectedIndex = CrtForms.fnuMostrarItemCombo(txtG1Mci_estreg_mcco.Text, ",", lobList.ListaValoresSel);
                            break;
                    }
                }
            }
        ...
        private void ActualizarComboBoxOpcion(object sender, TextChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "txtG1Mci_estreg_mcco":
                            CrtForms.ListaComboBox lobG1ComboBox1 = (CrtForms.ListaComboBox)cboG1Mci_estreg_mcco.SelectedItem;
                            cboG1Mci_estreg_mcco.SelectedIndex = CrtForms.fnuMostrarItemCombo(lcrValor, ",", lobG1ComboBox1.ListaValoresSel);
                            break;
                    }
                }
            }
