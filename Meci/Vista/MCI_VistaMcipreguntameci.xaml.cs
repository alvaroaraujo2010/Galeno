//- MARMOTA-GENCODE: VERSION 2.0 - 24/04/2015 10:08:51 PM
using System;
...
{
    /// <summary>
    /// Descripcion para la Vista de  la tabla: mcipreguntameci
    /// </summary>
    public partial class VistaMcipreguntameci : Window, SIS_Interface
    {
        //-------------------------------------------------
        // Inicio Formulario
        //-------------------------------------------------
        ...
        VistaModeloMcipreguntameci gobObjVModelo = null;
        DialogVistaErrores lobDlgLogs = null;
        /// <summary>
        /// Inicializar nueva instancia de la clase
        /// </summary>
        public VistaMcipreguntameci()
        {
            InitializeComponent();

            gobObjVModelo = this.DataContext as VistaModeloMcipreguntameci;
        ...
        private void fcvNuevoRegistro(object sender, RoutedEventArgs e)
        {
            ...
            FocusManager.SetFocusedElement(this, txtG1Mci_despre_mcpr);
        }
        ...
        public void fcvActivarModoEdicion(string tcrTipoEdicion)
        {
            ...
            {
                FocusManager.SetFocusedElement(this, txtG1Mci_idesec_mcpr);
        ...
        public void fcvBuscarRegistro(string tcrCodigo)
        {
            ...
            {
                case "txtG1Mci_idesec_mcgr":
                    txtG1Mci_idesec_mcgr.Text = tcrCodigo;
                    break;

            }
        }
        /// <summary>
        /// <para>Seleccionar Grupos</para>
        /// </summary>
        #region evento TextChanged
        private void txtG1Mci_idesec_mcgr_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (llgObjetosCargados)
            {
                if (!String.IsNullOrWhiteSpace(txtG1Mci_idesec_mcgr.Text))
                {

                    var tmp = MCIValidarCodigo.fobRegBuscarMcigrupoprgmeci(txtG1Mci_idesec_mcgr.Text);
                    if (tmp != null)
                    {
                        this.txtG1Mci_desgrp_mcgr.Text = tmp.mci_desgrp_mcgr;
                        ...
                        this.txtG1Mci_idesec_mcpa.Text = tmp.mci_idesec_mcpa;
                        this.txtG1Mci_estreg_mcgr.Text = tmp.mci_estreg_mcgr == "1" ? "ACTIVO" : "INACTIVO";
                    }
        ...
        {
            Browser01 frbro = new Browser01("MCI", "mcigrupoprgmeci", "", "Grupos...");
            gcrCtrF2TexBox = "txtG1Mci_idesec_mcgr";
            frbro.Owner = this;
            frbro.ShowDialog();
        }
        #endregion                 
        // MCIPREGUNTAMECI : Preguntas Dentro de Grupos en la Plantilla del Módulos Meci
        #region KeyDown para campos con F2 Tabla: MCIPREGUNTAMECI
        #region MCI_IDESEC_MCGR : Grupos en Parametros en Componentes de Módulos Meci
        private void txtG1Mci_idesec_mcgr_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Return)
            {
                e.Handled = true;
            ...
            if (e.Key == Key.F2)
            {
                txtG1Mci_idesec_mcgr_Browser();
            }
        }
        private void cmdG1Mci_idesec_mcgr_Click(object sender, RoutedEventArgs e)
        {
            txtG1Mci_idesec_mcgr_Browser();
        }
        private void txtG1Mci_idesec_mcgr_Browser()
        {
            Browser01 frbro = new Browser01("MCI", "MCIGRUPOPRGMECI", "", "Grupos en Parametros en Componentes de Módulos Meci...");
            gcrCtrF2TexBox = "txtG1Mci_idesec_mcgr";
            frbro.Owner = this;
            frbro.ShowDialog();
        }
        ...
        private void SeleccionComboBoxOpcion(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "cboG1Mci_estreg_mcpr":
                            txtG1Mci_estreg_mcpr.Text = CrtForms.fcrSeletDesdeComb(lobList.IdIndice,
                                                                                    txtG1Mci_estreg_mcpr.Text, ",",
                                                                                    lobList.ListaValoresSel);
                            lobCombo.SelectedIndex = CrtForms.fnuMostrarItemCombo(txtG1Mci_estreg_mcpr.Text, ",", lobList.ListaValoresSel);
                            break;
                    }
                }
            }
        ...
        private void ActualizarComboBoxOpcion(object sender, TextChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "txtG1Mci_estreg_mcpr":
                            CrtForms.ListaComboBox lobG1ComboBox1 = (CrtForms.ListaComboBox)cboG1Mci_estreg_mcpr.SelectedItem;
                            cboG1Mci_estreg_mcpr.SelectedIndex = CrtForms.fnuMostrarItemCombo(lcrValor, ",", lobG1ComboBox1.ListaValoresSel);
                            break;
                    }
                }
            }
