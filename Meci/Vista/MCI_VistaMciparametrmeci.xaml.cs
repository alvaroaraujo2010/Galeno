//- MARMOTA-GENCODE: VERSION 2.0 - 24/04/2015 07:33:23 AM
using System;
...
namespace Meci.Vista
{
    ...
    /// </summary>
    public partial class VistaMciparametrmeci : Window, SIS_Interface
    {
        //-------------------------------------------------
        // Inicio Formulario
        //-------------------------------------------------
        ...
        VistaModeloMciparametrmeci gobObjVModelo = null;
        DialogVistaErrores lobDlgLogs = null;
        /// <summary>
        /// Inicializar nueva instancia de la clase
        /// </summary>
        public VistaMciparametrmeci()
        {
            InitializeComponent();

            gobObjVModelo = this.DataContext as VistaModeloMciparametrmeci;
        ...
        private void fcvNuevoRegistro(object sender, RoutedEventArgs e)
        {
            ...
            FocusManager.SetFocusedElement(this, txtG1Mci_despar_mcpa);
        }
        ...
        public void fcvActivarModoEdicion(string tcrTipoEdicion)
        {
            ...
            {
                FocusManager.SetFocusedElement(this, txtG1Mci_idesec_mcpa);
        ...
        public void fcvBuscarRegistro(string tcrCodigo)
        {
            ...
            {
                case "txtG1Mci_idesec_mcco":
                    txtG1Mci_idesec_mcco.Text = tcrCodigo;
                    break;

            }
        }
        #region Cargar Componentes en browser
        /// <summary>
        /// <para>Seleccionar Componentes</para>
        /// </summary>
        #region evento TextChanged
        private void txtG1Mci_idesec_mcco_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (llgObjetosCargados)
            {
                if (!String.IsNullOrWhiteSpace(txtG1Mci_idesec_mcco.Text))
                {

                    var tmp = MCIValidarCodigo.fobRegBuscarMcicomponenmeci(txtG1Mci_idesec_mcco.Text);
                    if (tmp != null)
                    {
                        this.txtG1Mci_descom_mcco.Text = tmp.mci_descom_mcco;
                        this.txtG1Mci_idesec_mcpl.Text = tmp.mci_idesec_mcpl;
                        this.txtG1Mci_idesec_mcmo.Text = tmp.mci_idesec_mcmo;
                        this.txtG1Mci_estreg_mcco.Text = tmp.mci_estreg_mcco == "1" ? "ACTIVO" : "INACTIVO";
                    }
        ...
        #region KeyDown para campos con F2 Tabla: MCIPARAMETRMECI
        #region MCI_IDESEC_MCCO : Componentes de los Módulos Meci
        private void txtG1Mci_idesec_mcco_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Return)
            {
                e.Handled = true;
            ...
            if (e.Key == Key.F2)
            {
                txtG1Mci_idesec_mcco_Browser();
            }
        }
        private void cmdG1Mci_idesec_mcco_Click(object sender, RoutedEventArgs e)
        {
            txtG1Mci_idesec_mcco_Browser();
        }
        private void txtG1Mci_idesec_mcco_Browser()
        {
            Browser01 frbro = new Browser01("MCI", "MCICOMPONENMECI", "", "Componentes de los Módulos Meci...");
            gcrCtrF2TexBox = "txtG1Mci_idesec_mcco";
            frbro.Owner = this;
            frbro.ShowDialog();
        }
        #endregion
        ...
        {
            Browser01 frbro = new Browser01("MCI", "mcicomponenmeci", "", "Componentes...");
            gcrCtrF2TexBox = "txtG1Mci_idesec_mcco";
            frbro.Owner = this;
            frbro.ShowDialog();
        }
        ...
        private void SeleccionComboBoxOpcion(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "cboG1Mci_estreg_mcpa":
                            txtG1Mci_estreg_mcpa.Text = CrtForms.fcrSeletDesdeComb(lobList.IdIndice,
                                                                                    txtG1Mci_estreg_mcpa.Text, ",",
                                                                                    lobList.ListaValoresSel);
                            lobCombo.SelectedIndex = CrtForms.fnuMostrarItemCombo(txtG1Mci_estreg_mcpa.Text, ",", lobList.ListaValoresSel);
                            break;
                    }
                }
            }
        ...
        private void ActualizarComboBoxOpcion(object sender, TextChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "txtG1Mci_estreg_mcpa":
                            CrtForms.ListaComboBox lobG1ComboBox1 = (CrtForms.ListaComboBox)cboG1Mci_estreg_mcpa.SelectedItem;
                            cboG1Mci_estreg_mcpa.SelectedIndex = CrtForms.fnuMostrarItemCombo(lcrValor, ",", lobG1ComboBox1.ListaValoresSel);
                            break;
                    }
                }
            }
