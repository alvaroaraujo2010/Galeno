//- MARMOTA-GENCODE: VERSION 2.0 - 22/04/2015 10:06:54 AM
using System;
...
namespace Meci.Vista
{
    ...
    /// </summary>
    public partial class VistaMciplantillmeci : Window, SIS_Interface
    {
        //-------------------------------------------------
        // Inicio Formulario
        //-------------------------------------------------
        ...
        VistaModeloMciplantillmeci gobObjVModelo = null;
        DialogVistaErrores lobDlgLogs = null;
        /// <summary>
        /// Inicializar nueva instancia de la clase
        /// </summary>
        public VistaMciplantillmeci()
        {
            InitializeComponent();

            gobObjVModelo = this.DataContext as VistaModeloMciplantillmeci;
        ...
        private void fcvNuevoRegistro(object sender, RoutedEventArgs e)
        {
            ...
            FocusManager.SetFocusedElement(this, txtG1Mci_despla_mcpl);
        }
        ...
        private void fcvNuevoRegistroRel(object sender, RoutedEventArgs e)
        {
            ...
            FocusManager.SetFocusedElement(this, txtG2Mci_etqpla_mcmo);
        }
        ...
        public void fcvBuscarRegistro(string tcrCodigo)
        {
            ...
            {
                case "txtG1Mci_idesec_mcpl":
                    txtG1Mci_idesec_mcpl.Text = tcrCodigo;
                    break;

                case "txtG2Mci_idesec_mcpl":
                   // txtG2Mci_idesec_mcpl.Text = tcrCodigo;
                    break;
        ...
        #region KeyDown para campos con F2 Tabla: MCIPLANTILLMECI
        #endregion
        // MCIMODULOEVMECI : MÓDULOS PLANTILLA EVALUACIÓN MECI
        #region KeyDown para campos con F2 Tabla: MCIMODULOEVMECI
        #region MCI_IDESEC_MCPL : PLANTILLAS DE EVALUACIÓN
        private void txtG2Mci_idesec_mcpl_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Return)
            {
                e.Handled = true;
            ...
            if (e.Key == Key.F2)
            {
                txtG2Mci_idesec_mcpl_Browser();
            }
        }
        private void cmdG2Mci_idesec_mcpl_Click(object sender, RoutedEventArgs e)
        {
            txtG2Mci_idesec_mcpl_Browser();
        }
        private void txtG2Mci_idesec_mcpl_Browser()
        {
            Browser01 frbro = new Browser01("MCI", "MCIPLANTILLMECI", "", "PLANTILLAS DE EVALUACIÓN...");
            gcrCtrF2TexBox = "txtG2Mci_idesec_mcpl";
            frbro.Owner = this;
            frbro.ShowDialog();
        }
        #endregion
        ...
        {
            Browser01 frbro = new Browser01("MCI", "MCIPLANTILLMECI", "", "PLANTILLAS DE EVALUACIÓN...");
            gcrCtrF2TexBox = "txtG1Mci_idesec_mcpl";
            frbro.Owner = this;
            frbro.ShowDialog();
        }
        #endregion
        ...
        private void SeleccionComboBoxOpcion(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "cboG1Mci_estreg_mcpl":
                            txtG1Mci_estreg_mcpl.Text = CrtForms.fcrSeletDesdeComb(lobList.IdIndice,
                                                                                    txtG1Mci_estreg_mcpl.Text, ",",
                                                                                    lobList.ListaValoresSel);
                            lobCombo.SelectedIndex = CrtForms.fnuMostrarItemCombo(txtG1Mci_estreg_mcpl.Text, ",", lobList.ListaValoresSel);
                            break;
                        case "cboG2Mci_estreg_mcmo":
                            txtG2Mci_estreg_mcmo.Text = CrtForms.fcrSeletDesdeComb(lobList.IdIndice,
                                                                                    txtG2Mci_estreg_mcmo.Text, ",",
                                                                                    lobList.ListaValoresSel);
                            lobCombo.SelectedIndex = CrtForms.fnuMostrarItemCombo(txtG2Mci_estreg_mcmo.Text, ",", lobList.ListaValoresSel);
                            break;
                    }
                }
            }
        ...
        private void ActualizarComboBoxOpcion(object sender, TextChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "txtG1Mci_estreg_mcpl":
                            CrtForms.ListaComboBox lobG1ComboBox1 = (CrtForms.ListaComboBox)cboG1Mci_estreg_mcpl.SelectedItem;
                            cboG1Mci_estreg_mcpl.SelectedIndex = CrtForms.fnuMostrarItemCombo(lcrValor, ",", lobG1ComboBox1.ListaValoresSel);
                            break;
                        case "txtG2Mci_estreg_mcmo":
                            CrtForms.ListaComboBox lobG2ComboBox1 = (CrtForms.ListaComboBox)cboG2Mci_estreg_mcmo.SelectedItem;
                            cboG2Mci_estreg_mcmo.SelectedIndex = CrtForms.fnuMostrarItemCombo(lcrValor, ",", lobG2ComboBox1.ListaValoresSel);
                            break;
                    }
                }
            }
