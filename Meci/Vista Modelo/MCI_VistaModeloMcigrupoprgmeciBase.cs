//- MARMOTA-GENCODE: VERSION 2.0 - 24/04/2015 05:29:26 PM
using System;
...
namespace Meci.VistaModelo
{
    ...
    /// </para>
    /// </summary>
    public class VistaModeloMcigrupoprgmeciBase : ViewModelBase, IDataErrorInfo
    {
        //------------------------------------------------
        //-Identificador unico de esta Clase
        //------------------------------------------------
        public const string gcrIdVistaModeloForm = "MCI004";
        //------------------------------------------------
        ...
        //------------------------------------------------
        #region Notificacion campos: MCIGRUPOPRGMECI
        ...
        #endregion
        #region G1Mci_etqgrp_mcgr: Etiqueta Grupo
        public const string gcrNomProp_G1Mci_etqgrp_mcgr = "G1Mci_etqgrp_mcgr";
        private string _g1mci_etqgrp_mcgr = string.Empty;
        /// <summary>
        /// <para>TABLA: mcigrupoprgmeci</para>
        /// <para>TABLA NATIVA: mcigrupoprgmeci</para>
        /// <para>CAMPO: Etiqueta Grupo</para>
        /// <para>NOMBRE: g1mci_etqgrp_mcgr (char:10)</para>
        /// <para>ORDEN VISTA EN TABLA: 6</para>
        /// <para>DESCRIPCION:
        ///Etiqueta Grupo
        /// </para>
        /// </summary>
        public string G1Mci_etqgrp_mcgr
        {
            get { return _g1mci_etqgrp_mcgr; }
            set
            {
                if (_g1mci_etqgrp_mcgr == value) return;
                _g1mci_etqgrp_mcgr = value;
                RaisePropertyChanged(gcrNomProp_G1Mci_etqgrp_mcgr);
            }
        }
        #endregion
        ...
        #endregion
        #region G1Mci_ordvis_mcgr: Orden Vista
        public const string gcrNomProp_G1Mci_ordvis_mcgr = "G1Mci_ordvis_mcgr";
        private int _g1mci_ordvis_mcgr = 0;
        /// <summary>
        /// <para>TABLA: mcigrupoprgmeci</para>
        /// <para>TABLA NATIVA: mcigrupoprgmeci</para>
        /// <para>CAMPO: Orden Vista</para>
        /// <para>NOMBRE: g1mci_ordvis_mcgr (int:3)</para>
        /// <para>ORDEN VISTA EN TABLA: 8</para>
        /// <para>DESCRIPCION:
        ///Orden Vista
        /// </para>
        /// </summary>
        public int G1Mci_ordvis_mcgr
        {
            get { return _g1mci_ordvis_mcgr; }
            set
            {
                if (_g1mci_ordvis_mcgr == value) return;
                _g1mci_ordvis_mcgr = value;
                RaisePropertyChanged(gcrNomProp_G1Mci_ordvis_mcgr);
            }
        }
        #endregion
        #region G1Mci_secdet_mcgr: Secuencial detalle MCGR
        public const string gcrNomProp_G1Mci_secdet_mcgr = "G1Mci_secdet_mcgr";
        private int _g1mci_secdet_mcgr = 0;
        /// <summary>
        /// <para>TABLA: mcigrupoprgmeci</para>
        /// <para>TABLA NATIVA: mcigrupoprgmeci</para>
        /// <para>CAMPO: Secuencial detalle MCGR</para>
        /// <para>NOMBRE: g1mci_secdet_mcgr (int:10)</para>
        ...
        /// </para>
        /// </summary>
        public int G1Mci_secdet_mcgr
        {
            get { return _g1mci_secdet_mcgr; }
            set
            {
                if (_g1mci_secdet_mcgr == value) return;
                _g1mci_secdet_mcgr = value;
                RaisePropertyChanged(gcrNomProp_G1Mci_secdet_mcgr);
            }
        }
        #endregion
        #region G1Mci_estreg_mcgr: Estado del grupo
        public const string gcrNomProp_G1Mci_estreg_mcgr = "G1Mci_estreg_mcgr";
        private string _g1mci_estreg_mcgr = string.Empty;
        /// <summary>
        /// <para>TABLA: mcigrupoprgmeci</para>
        /// <para>TABLA NATIVA: mcigrupoprgmeci</para>
        /// <para>CAMPO: Estado del grupo</para>
        /// <para>NOMBRE: g1mci_estreg_mcgr (char:1)</para>
        /// <para>ORDEN VISTA EN TABLA: 10</para>
        /// <para>DESCRIPCION:
        ///Estado del grupo
        /// </para>
        /// </summary>
        public string G1Mci_estreg_mcgr
        {
            get { return _g1mci_estreg_mcgr; }
            set
            {
                if (_g1mci_estreg_mcgr == value) return;
                _g1mci_estreg_mcgr = value;
                RaisePropertyChanged(gcrNomProp_G1Mci_estreg_mcgr);
            }
        }
        #endregion
        ...
        #endregion
        //------------------------------------------------
        //MCIGRUPOPRGMECI COMBOBOX: Grupos en Parametros en Componentes de Módulos Meci
        //------------------------------------------------
        #region Campos ComboBox: MCIGRUPOPRGMECI
        #region  G1CbMci_estreg_mcgr: Estado del grupo
        public const string gcrNomProp_G1CbMci_estreg_mcgr = "G1CbMci_estreg_mcgr";
        private List<CrtForms.ListaComboBox> _g1cbmci_estreg_mcgr;
        /// <summary>
        /// <para>TABLA: mcigrupoprgmeci</para>
        /// <para>TABLA NATIVA: mcigrupoprgmeci</para>
        /// <para>CAMPO: Estado del grupo</para>
        /// <para>NOMBRE: g1cbmci_estreg_mcgr (char:1)</para>
        /// <para>ORDEN VISTA EN TABLA: 10</para>
        /// <para>DESCRIPCION:
        ///Estado del grupo
        /// </para>
        /// </summary>
        public List<CrtForms.ListaComboBox> G1CbMci_estreg_mcgr
        {
            get { return _g1cbmci_estreg_mcgr; }
            set
            {
                if (_g1cbmci_estreg_mcgr == value) return;
                _g1cbmci_estreg_mcgr = value;
                RaisePropertyChanged(gcrNomProp_G1CbMci_estreg_mcgr);
            }
        }
        #endregion
        #endregion
        //------------------------------------------------
        //MCIGRUPOPRGMECI: Registro Activo y Lista Browser
        //------------------------------------------------
        ...
        private ModeloMcigrupoprgmeci _tmpg1regactivo;
        /// <summary>
        ///  Registro activo de la tabla: mcigrupoprgmeci
        /// </summary>
        public ModeloMcigrupoprgmeci TmpG1RegActivo
        {
        ...
        private ObservableCollection<ModeloMcigrupoprgmeci> _tmpg1listabrow;
        /// <summary>
        ///  Lista de registros tabla: mcigrupoprgmeci
        /// </summary>
        public ObservableCollection<ModeloMcigrupoprgmeci> TmpG1ListaBrow
        {
        ...
        public RelayCommand<ModeloMcigrupoprgmeci> SelectionChangedCommand { get; set; }
        ...
        public virtual void fcvRegistrarComandos()
        {
            ...
            SelectionChangedCommand = new RelayCommand<ModeloMcigrupoprgmeci>(lobjRegistro =>
            {
        ...
        public VistaModeloMcigrupoprgmeciBase()
        {
            fcvIniciarComboBox();
            fcvReiniVariables();
            TmpG1ListaBrow = new ObservableCollection<ModeloMcigrupoprgmeci>(ModeloMcigrupoprgmeci.flsListaMcigrupoprgmeci("",""));
        ...
        public virtual void Guardar()
        {
            try
            {
                ...
                {
                    TmpG1RegActivo.Mci_idesec_mcgr = ModeloMcigrupoprgmeci.flgAddRegistro(TmpG1RegActivo);
                ...
                {
                    fcvCargarRegActivoDesdeVariables();
                    ModeloMcigrupoprgmeci.fcvActualizar(TmpG1RegActivo);
                }
                if (string.IsNullOrEmpty(G1Mci_idesec_mcgr))
                {
                    Restaurar();
                }
        ...
        public virtual void Eliminar()
        {
            try
            {
                ...
                {
                    ModeloMcigrupoprgmeci.fcvEliminar(TmpG1RegActivo.Mci_idesec_mcgr);
        ...
        public virtual void Filtro()
        {
            try
            {
                if (GcrFiltroDatos != gcrFiltroAplicado && GlgSIS_ModoEdicion == false && !String.IsNullOrWhiteSpace(G1Mci_idesec_mcpa))
                {
                    Restaurar();
                    TmpG1ListaBrow = new ObservableCollection<ModeloMcigrupoprgmeci>(ModeloMcigrupoprgmeci.flsListaMcigrupoprgmeci(G1Mci_idesec_mcpa,GcrFiltroDatos));
        ...
        public virtual void fcvReiniVariables()
        {
            try
            {
                ...
                G1Mci_etqgrp_mcgr = string.Empty;
                G1Mci_desgrp_mcgr = string.Empty;
                G1Mci_ordvis_mcgr = 0;
                G1Mci_secdet_mcgr = 0;
                G1Mci_estreg_mcgr = string.Empty;
                //G1Mci_despar_mcpa = string.Empty;
                #endregion
                TmpG1RegActivo = new ModeloMcigrupoprgmeci();
                tmpLogErrores = new List<LogsErrores>();
            }
            catch (NotImplementedException ex)
            {
        ...
        public virtual void fcvCargarRegActivoDesdeVariables()
        {
            try
            {
                ...
                TmpG1RegActivo.Mci_etqgrp_mcgr = G1Mci_etqgrp_mcgr;
                TmpG1RegActivo.Mci_desgrp_mcgr = G1Mci_desgrp_mcgr;
                TmpG1RegActivo.Mci_ordvis_mcgr = G1Mci_ordvis_mcgr;
                TmpG1RegActivo.Mci_secdet_mcgr = G1Mci_secdet_mcgr;
                TmpG1RegActivo.Mci_estreg_mcgr = G1Mci_estreg_mcgr;
        ...
        public virtual void fcvCargarVariablesDesdeRegActivo()
        {
            try
            {
                ...
                G1Mci_etqgrp_mcgr = TmpG1RegActivo.Mci_etqgrp_mcgr;
                G1Mci_desgrp_mcgr = TmpG1RegActivo.Mci_desgrp_mcgr;
                G1Mci_ordvis_mcgr = TmpG1RegActivo.Mci_ordvis_mcgr;
                G1Mci_secdet_mcgr = TmpG1RegActivo.Mci_secdet_mcgr;
                G1Mci_estreg_mcgr = TmpG1RegActivo.Mci_estreg_mcgr;
        ...
        public virtual bool CanADD()
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(GcrUsuCodigoPerfil) && GlgSIS_ModoEdicion == false && !String.IsNullOrWhiteSpace(G1Mci_idesec_mcpa))
                {
        ...
        public virtual bool CanEDT()
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(TmpG1RegActivo.Mci_idesec_mcgr) && GlgSIS_ModoEdicion == false)
                {
                    // verificar si el perfil tiene permiso
            ...
            try
            {
                if (GlgSIS_ModoEdicion == true)
                {
                    ...
                    llgReturn = string.IsNullOrEmpty(fcrValidacion("G1Mci_idesec_mcpl")) &&
                                ...
                                string.IsNullOrEmpty(fcrValidacion("G1Mci_etqgrp_mcgr")) &&
                                string.IsNullOrEmpty(fcrValidacion("G1Mci_desgrp_mcgr")) &&
                                string.IsNullOrEmpty(fcrValidacion("G1Mci_ordvis_mcgr")) &&
                                string.IsNullOrEmpty(fcrValidacion("G1Mci_secdet_mcgr")) &&
                                string.IsNullOrEmpty(fcrValidacion("G1Mci_estreg_mcgr"));
                    #endregion
        ...
        public virtual void fcvIniciarComboBox()
        {
            ...
            {
                //-------------------------------------------------
                //MCI_ESTREG_MCGR: Estado del grupo
                //-------------------------------------------------
                #region MCI_ESTREG_MCGR: Estado del grupo
                string lcrG11Seleccion = "1,2";
                string lcrG11Descripcion = "Activo,Inactivo";
                G1CbMci_estreg_mcgr = new List<CrtForms.ListaComboBox>();
                G1CbMci_estreg_mcgr = CrtForms.flsCargarLista(lcrG11Seleccion, lcrG11Descripcion);
                #endregion
            }
            catch (NotImplementedException ex)
            {
