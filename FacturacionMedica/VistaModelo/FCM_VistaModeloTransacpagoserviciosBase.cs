...
namespace FacturacionMedica.VistaModelo
{
    ...
    /// </para>
    /// </summary>
    public class VistaModeloTransacpagoserviciosBase : ViewModelBase, IDataErrorInfo
    {
        //------------------------------------------------
        ...
        private ObservableCollection<FcmModeloServDetallFacturas> _tmpg5listabrow;
        /// <summary>
        /// Lista de registros tabla: fcmmaedetallfac Registros de servicios facturados
        /// </summary>
        public ObservableCollection<FcmModeloServDetallFacturas> TmpG5ListaBrow
        {
        ...
        public VistaModeloTransacpagoserviciosBase()
        {
            fcvIniciarComboBox();
        ...
        public virtual void fcvConfirmarFacturas()
        {
            try
            {
                ...
                TmpG5ListaBrow = new ObservableCollection<FcmModeloServDetallFacturas>(FcmModeloServDetallFacturas.flsListaFcmmaedetallfac(GcrFiltroDatos));
                foreach (FcmModeloMaestrofacturas lobFact in TmpG3ListaBrow)
                {
                    ...
                    lobFact.Sis_idterc_sitr = TmpA1RegActivo.Sis_idterc_sitr;
                    lobFact.Fcm_codest_fcws = lobFact.Cto_fcdian_cont == "1" ? "P01" : "NA";

                    // Actualizar datos de razon social y resolucion
                    var lobRegCntr = CTOValidarCodigo.FobRegBuscarContratoRazonSocialDataRow(lobFact.Cto_seccon_cont);
                    if (lobRegCntr != null)
                    {
                    ...
                    if (lobFact.Cto_fcdian_cont == "1") // se genera factura dian
                    {
                        lobReg = SysModeloFacturaDian.FobGenerarNumeroFacturaIdResolucion(lobFact.Fcm_secres_srfa);
                    }
                    else
                    {
                        // Secuencial del sistema
                        lobReg = SysModeloFacturaDian.fobGenerarNumeroFactura("2", lobFact.Fcm_fecfac_mfac);
                    }

                    //var lobReg = SysModeloFacturaDian.fobGenerarNumeroFactura(lobFact.Cto_fcdian_cont, lobFact.Fcm_fecfac_mfac);
                    ...
                    */
                    ...
                    lobFact.Fcm_valsub_dfac = lobFact.Fcm_valbru_dfac - (lflValorCopago + lobFact.Fcm_valusu_dfac + lobFact.Fcm_valdes_dfac);
                    ...
                    foreach (FcmModeloServDetallFacturas lobServ in TmpG5ListaBrow)
                    {
                        if (lobServ.Fcm_secreg_mfac.Trim() == lobFact.Fcm_secreg_mfac.Trim())
                        {
                            ...
                            lobServ.Fcm_autdes_ades = lobFact.Fcm_autdes_ades;
        ...
        public void fcvHclinicaGenerarActividad(FcmModeloServDetallFacturas tobRegistro, int tnuIndice)
        {
            try
            {
                ...
                if (lobReg.fcm_genhis_cpro == "1" && lobReg.grp_idepla_grpl != "NA" && lobReg.fcm_coddig_mant == tobRegistro.Fcm_coddig_mant)
                {
                    ...
                    lobHist.Hcl_nrohis_hicl = TmpA1RegActivo.Hcl_nrohis_hicl;
                    lobHist.Adm_secadm_rgad = TmpA1RegActivo.Adm_secadm_rgad;
                    lobHist.Cit_codasi_mcit = TmpA1RegActivo.Cit_codasi_mcit;
                    lobHist.Fcm_codcpr_cpro = lobReg.fcm_codcpr_cpro;
                    lobHist.Sia_idesec_usua = TmpA1RegActivo.Sia_idesec_usua;
                    lobHist.Sia_tipide_tide = TmpA1RegActivo.Sia_tipide_tide;
                    lobHist.Sia_nroide_usua = TmpA1RegActivo.Sia_nroide_usua;
                    ...
                    //HclModeloHistorialEventos.flgGenerarActividadUnica("HCL-APERTURA-GENERAL", lobHist, A1Sia_idesec_usua);
        ...
        public virtual void fcvReiniVariables(string tcrZona)
        {
            try
            {
                ...
                if (tcrZona == "1" || tcrZona == "A")
                {
                    ...
                    G1Fcm_rfecha_mtrc = DateTime.Now.ToShortDateString();
