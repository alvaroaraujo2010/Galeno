...
namespace FacturacionMedica.Vista
{
    ...
    /// </summary>
    public partial class VistaFcmsoatmanualma : Window, SIS_Interface
    {
        //-------------------------------------------------
        // Inicio Formulario
        //-------------------------------------------------
        ...
        VistaModeloFcmsoatmanualma vm = null;
        DialogVistaErrores lobDlgLogs = null;
        /// <summary>
        /// Inicializar nueva instancia de la clase
        /// </summary>
        public VistaFcmsoatmanualma()
        {
            InitializeComponent();

            vm = this.DataContext as VistaModeloFcmsoatmanualma;
            vm.Restaurar();
        ...
        private void fcvNuevoRegistro(object sender, RoutedEventArgs e)
        {
            ...
            FocusManager.SetFocusedElement(this, txtG1Fcm_codser_soat);
        }
        ...
        {
            vm.Restaurar();
            LocalizadorVistaModelo.fcvLiberarVistaModeloFcmsoatmanualma();
        ...
        #region KeyDown para campos con F2 Tabla: FCMSOATMANUALMA
        #endregion
        #endregion
    }
}
