...
namespace FacturacionMedica.Vista
{
    ...
    /// </summary>
    public partial class VistaFcmcenproduccio : Window, SIS_Interface
    {
        //-------------------------------------------------
        // Inicio Formulario
        //-------------------------------------------------
        ...
        VistaModeloFcmcenproduccio gobObjVModelo = null;
        DialogVistaErrores lobDlgLogs = null;
        /// <summary>
        /// Inicializar nueva instancia de la clase
        /// </summary>
        public VistaFcmcenproduccio()
        {
            InitializeComponent();

            gobObjVModelo = this.DataContext as VistaModeloFcmcenproduccio;
        ...
        private void fcvNuevoRegistro(object sender, RoutedEventArgs e)
        {
            ...
            FocusManager.SetFocusedElement(this, txtG1Fcm_descpr_cpro);
        }
        ...
        public void fcvActivarModoEdicion(string tcrTipoEdicion)
        {
            ...
            {
                FocusManager.SetFocusedElement(this, txtG1Fcm_codcpr_cpro);
        ...
        public void fcvBuscarRegistro(string tcrCodigo)
        {
            switch (gcrCtrF2TexBox)
            {
                ...
                case "txtG1Con_codafu_afun":
                    txtG1Con_codafu_afun.Text = tcrCodigo;
                    break;
        ...
        #region KeyDown para campos con F2 Tabla: FCMCENPRODUCCIO
        ...
        #endregion
        #region CON_CODAFU_AFUN : Areas funcionales
        private void txtG1Con_codafu_afun_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Return)
            {
                e.Handled = true;
            ...
            if (e.Key == Key.F2)
            {
                txtG1Con_codafu_afun_Browser();
            }
        }
        private void cmdG1Con_codafu_afun_Click(object sender, RoutedEventArgs e)
        {
            txtG1Con_codafu_afun_Browser();
        }
        private void txtG1Con_codafu_afun_Browser()
        {
            Browser01 frbro = new Browser01("CON", "CONAREASFUNCION", "", "Areas funcionales...");
            gcrCtrF2TexBox = "txtG1Con_codafu_afun";
            frbro.Owner = this;
            frbro.ShowDialog();
        }
        #endregion
        ...
        private void SeleccionComboBoxOpcion(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "cboG1Fcm_genhis_cpro":
                            txtG1Fcm_genhis_cpro.Text = CrtForms.fcrSeletDesdeComb(lobList.IdIndice,
                                                                                    txtG1Fcm_genhis_cpro.Text, ",",
                                                                                    lobList.ListaValoresSel);
                            lobCombo.SelectedIndex = CrtForms.fnuMostrarItemCombo(txtG1Fcm_genhis_cpro.Text, ",", lobList.ListaValoresSel);
                            break;
        ...
        private void ActualizarComboBoxOpcion(object sender, TextChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "txtG1Fcm_genhis_cpro":
                            CrtForms.ListaComboBox lobG1ComboBox1 = (CrtForms.ListaComboBox)cboG1Fcm_genhis_cpro.SelectedItem;
                            cboG1Fcm_genhis_cpro.SelectedIndex = CrtForms.fnuMostrarItemCombo(lcrValor, ",", lobG1ComboBox1.ListaValoresSel);
                            break;
