...
namespace FirmaXadesNet
{
    ...
    public class XadesService
    {
        ...
        public SignatureDocument Sign(Stream input, SignatureParameters parameters)
        {
            ...
            switch (parameters.SignaturePackaging)
            {
                case SignaturePackaging.INTERNALLY_DETACHED:
                    ...
                    {
                        // carga  el xml y Cuando hay un ElementIdToSign establece ese elemento para firmarlo
        ...
        private void SetSignatureId(XadesSignedXml xadesSignedXml)
        {
            ...
            xadesSignedXml.Signature.Id = "xmldsig-" + id;
            xadesSignedXml.SignatureValueId = "xmldsig-" + id + "-sigvalue";
        }
        ...
        private void PrepareSignature(SignatureDocument sigDocument, SignatureParameters parameters) // ojo-KeyInfo agrega 
        {
            sigDocument.XadesSignature.SignedInfo.SignatureMethod = parameters.SignatureMethod.URI;

            AddCertificateInfo(sigDocument, parameters); // Aqui- X509Certificate
            ...
            {
                // Aqui- es donde se inserta la firma dentro del documento XML (Factura/Nota D/Nota C)
        ...
        private void AddXadesInfo(SignatureDocument sigDocument, SignatureParameters parameters) // ojo-Object esta en : .../ds:ExtensionContent/ds:Signature/ds:Object 
        {
        ...
        /// <summary>
        /// Agrega el certificado y la llave en la seccion: .../ds:SignedInfo/ds:KeyInfo
        /// </summary>
        /// <param name="sigDocument"></param>
        /// <param name="parameters"></param>
        private void AddCertificateInfo(SignatureDocument sigDocument, SignatureParameters parameters)
        {
            // Aqui-keyInfo para agregar la llave y el certificado de firma
            ...
            //keyInfo.Id = sigDocument.XadesSignature.Signature.Id + "-keyinfo"; // Aqui-ds:KeyInfo en minuscula
            //keyInfo.Id = "KeyInfoId-" + sigDocument.XadesSignature.Signature.Id;
            keyInfo.AddClause(new KeyInfoX509Data(parameters.Signer.Certificate)); // Aqui-X509Data
            //keyInfo.AddClause(new RSAKeyValue((RSA)parameters.Signer.SigningKey)); // Aqui-RSAKeyValue - (no va en la factura)
