//- MARMOTA-GENCODE: VERSION 2.0 - 01/07/2016 06:45:21 AM
using System;
...
namespace HistoriasClinicas.Vista
{
    ...
    /// </summary>
    public partial class VistaHclvariabgrupos : Window, SIS_Interface
    {
        //-------------------------------------------------
        // Inicio Formulario
        //-------------------------------------------------
        ...
        VistaModeloHclvariabgrupos vm = null;
        DialogVistaErrores lobDlgLogs = null;
        /// <summary>
        /// Inicializar nueva instancia de la clase
        /// </summary>
        public VistaHclvariabgrupos()
        {
            InitializeComponent();

            vm = this.DataContext as VistaModeloHclvariabgrupos;
            vm.Restaurar();
        ...
        private void fcvNuevoRegistro(object sender, RoutedEventArgs e)
        {
            ...
            FocusManager.SetFocusedElement(this, txtG1Hcl_desgru_hcgv);
        }
        ...
        public void fcvActivarModoEdicion(string tcrTipoEdicion)
        {
            ...
            {
                FocusManager.SetFocusedElement(this, txtG1Hcl_secgru_hcgv);
        ...
        {
            vm.Restaurar();
            LocalizadorVistaModelo.fcvLiberarVistaModeloHclvariabgrupos();
        ...
        #region KeyDown para campos con F2 Tabla: HCLVARIABGRUPOS
        #endregion
        #endregion
        //-------------------------------------------------
        ...
        private void SeleccionComboBoxOpcion(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "cboG1Hcl_sisgru_hcgv":
                            txtG1Hcl_sisgru_hcgv.Text = CrtForms.fcrSeletDesdeComb(lobList.IdIndice,
                                                                                    txtG1Hcl_sisgru_hcgv.Text, ",",
                                                                                    lobList.ListaValoresSel);
                            lobCombo.SelectedIndex = CrtForms.fnuMostrarItemCombo(txtG1Hcl_sisgru_hcgv.Text, ",", lobList.ListaValoresSel);
                            break;
        ...
        private void ActualizarComboBoxOpcion(object sender, TextChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "txtG1Hcl_sisgru_hcgv":
                            CrtForms.ListaComboBox lobG1ComboBox1 = (CrtForms.ListaComboBox)cboG1Hcl_sisgru_hcgv.SelectedItem;
                            cboG1Hcl_sisgru_hcgv.SelectedIndex = CrtForms.fnuMostrarItemCombo(lcrValor, ",", lobG1ComboBox1.ListaValoresSel);
                            break;
