...
namespace HistoriasClinicas.VistaModelo
{
    ...
    /// </para>
    /// </summary>
    public class VistaModeloHcltiporegactivBase : ViewModelBase, IDataErrorInfo
    {
        //------------------------------------------------
        //-Identificador unico de esta Clase
        //------------------------------------------------
        public const string gcrIdVistaModeloForm = "HCL004";
        //------------------------------------------------
        ...
        #endregion
        #region G1Sys_codtip_sytm: Codigo tipo de mensajes
        public const string gcrNomProp_G1Sys_codtip_sytm = "G1Sys_codtip_sytm";
        private string _g1sys_codtip_sytm = string.Empty;
        /// <summary>
        /// <para>TABLA: hcltiporegactiv</para>
        /// <para>TABLA NATIVA: sysadmstipomens</para>
        /// <para>CAMPO: Codigo tipo de mensajes</para>
        /// <para>NOMBRE: g1sys_codtip_sytm (char:10)</para>
        ...
        /// </para>
        /// </summary>
        public string G1Sys_codtip_sytm
        {
            get { return _g1sys_codtip_sytm; }
            set
            {
                if (_g1sys_codtip_sytm == value) return;
                _g1sys_codtip_sytm = value;
                RaisePropertyChanged(gcrNomProp_G1Sys_codtip_sytm);
            }
        }
        #endregion
        #region G1Hcl_imagen_hcca: Imagen (jpg)
        public const string gcrNomProp_G1Hcl_imagen_hcca = "G1Hcl_imagen_hcca";
        private string _g1hcl_imagen_hcca = string.Empty;
        /// <summary>
        /// <para>TABLA: hcltiporegactiv</para>
        /// <para>TABLA NATIVA: hcltiporegactiv</para>
        /// <para>CAMPO: Imagen (jpg)</para>
        /// <para>NOMBRE: g1hcl_imagen_hcca (char:60)</para>
        ...
        /// </para>
        /// </summary>
        public string G1Hcl_imagen_hcca
        {
            get { return _g1hcl_imagen_hcca; }
            set
            {
                if (_g1hcl_imagen_hcca == value) return;
                _g1hcl_imagen_hcca = value;
                RaisePropertyChanged(gcrNomProp_G1Hcl_imagen_hcca);
            }
        }
        #endregion
        ...
        #endregion
        #region G1Sys_desmsj_sytm: Descripcion tipo
        public const string gcrNomProp_G1Sys_desmsj_sytm = "G1Sys_desmsj_sytm";
        private string _g1sys_desmsj_sytm = string.Empty;
        /// <summary>
        /// <para>TABLA: hcltiporegactiv</para>
        /// <para>TABLA NATIVA: sysadmstipomens</para>
        /// <para>CAMPO: Descripcion tipo</para>
        /// <para>NOMBRE: g1sys_desmsj_sytm (char:80)</para>
        /// <para>ORDEN VISTA EN TABLA: 2</para>
        /// <para>DESCRIPCION:
        ...
        /// </para>
        /// </summary>
        public string G1Sys_desmsj_sytm
        {
            get { return _g1sys_desmsj_sytm; }
            set
            {
                if (_g1sys_desmsj_sytm == value) return;
                _g1sys_desmsj_sytm = value;
                RaisePropertyChanged(gcrNomProp_G1Sys_desmsj_sytm);
            }
        }
        #endregion
        #endregion
        //------------------------------------------------
        //HCLTIPOREGACTIV COMBOBOX: Tipo registro de actividad en historial
        //------------------------------------------------
        ...
        private ModeloHcltiporegactiv _tmpg1regactivo;
        /// <summary>
        ///  Registro activo de la tabla: hcltiporegactiv
        /// </summary>
        public ModeloHcltiporegactiv TmpG1RegActivo
        {
        ...
        private ObservableCollection<ModeloHcltiporegactiv> _tmpg1listabrow;
        /// <summary>
        ///  Lista de registros tabla: hcltiporegactiv
        /// </summary>
        public ObservableCollection<ModeloHcltiporegactiv> TmpG1ListaBrow
        {
        ...
        public RelayCommand<ModeloHcltiporegactiv> SelectionChangedCommand { get; set; }
        ...
        public virtual void fcvRegistrarComandos()
        {
            ...
            SelectionChangedCommand = new RelayCommand<ModeloHcltiporegactiv>(lobjRegistro =>
            {
        ...
        public VistaModeloHcltiporegactivBase()
        {
            fcvReiniVariables();
            //TmpG1ListaBrow = new ObservableCollection<ModeloHcltiporegactiv>(ModeloHcltiporegactiv.flsListaHcltiporegactiv(""));
        ...
        public virtual void Guardar()
        {
            try
            {
                ...
                {
                    //TmpG1RegActivo.Hcl_codreg_hcca = ModeloHcltiporegactiv.flgAddRegistro(TmpG1RegActivo);
                ...
                {
                    fcvCargarRegActivoDesdeVariables();
                    //ModeloHcltiporegactiv.fcvActualizar(TmpG1RegActivo);
                }
                if (string.IsNullOrEmpty(G1Hcl_codreg_hcca))
                {
                    Restaurar();
                }
        ...
        public virtual void Eliminar()
        {
            try
            {
                ...
                {
                    //ModeloHcltiporegactiv.fcvEliminar(TmpG1RegActivo.Hcl_codreg_hcca);
        ...
        public virtual void Filtro()
        {
            try
            {
                ...
                {
                    Restaurar();
                    TmpG1ListaBrow = new ObservableCollection<ModeloHcltiporegactiv>(ModeloHcltiporegactiv.flsListaHcltiporegactiv(GcrFiltroDatos));
        ...
        public virtual void fcvReiniVariables()
        {
            try
            {
                ...
                G1Sys_codtip_sytm = string.Empty;
                G1Hcl_imagen_hcca = "Edt_edt_xcap_documento.png";
                G1Grp_despla_grpl = string.Empty;
                G1Sys_desmsj_sytm = string.Empty;
                #endregion
                TmpG1RegActivo = new ModeloHcltiporegactiv();
                tmpLogErrores = new List<LogsErrores>();
            }
            catch (NotImplementedException ex)
            {
        ...
        public virtual void fcvCargarRegActivoDesdeVariables()
        {
            try
            {
                ...
                TmpG1RegActivo.Sys_codtip_sytm = G1Sys_codtip_sytm;
                TmpG1RegActivo.Hcl_imagen_hcca = G1Hcl_imagen_hcca;
                TmpG1RegActivo.Grp_despla_grpl = G1Grp_despla_grpl;
                TmpG1RegActivo.Sys_desmsj_sytm = G1Sys_desmsj_sytm;
                #endregion
            }
            catch (NotImplementedException ex)
            {
        ...
        public virtual void fcvCargarVariablesDesdeRegActivo()
        {
            try
            {
                ...
                G1Sys_codtip_sytm = TmpG1RegActivo.Sys_codtip_sytm;
                G1Hcl_imagen_hcca = TmpG1RegActivo.Hcl_imagen_hcca;
                G1Grp_despla_grpl = TmpG1RegActivo.Grp_despla_grpl;
                G1Sys_desmsj_sytm = TmpG1RegActivo.Sys_desmsj_sytm;
                #endregion
            }
            catch (NotImplementedException ex)
            {
        ...
        public virtual bool CanEDT()
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(TmpG1RegActivo.Hcl_codreg_hcca) && GlgSIS_ModoEdicion == false)
                {
                    // verificar si el perfil tiene permiso
        ...
        public virtual bool CanSAV()
        {
            ...
            try
            {
                ...
                {
                    #region Valores Variables
                    llgReturn = string.IsNullOrEmpty(fcrValidacion("G1Hcl_codreg_hcca")) &&
                                string.IsNullOrEmpty(fcrValidacion("G1Hcl_desreg_hcca")) &&
                                string.IsNullOrEmpty(fcrValidacion("G1Grp_idepla_grpl")) &&
                                string.IsNullOrEmpty(fcrValidacion("G1Sys_codtip_sytm")) &&
                                string.IsNullOrEmpty(fcrValidacion("G1Hcl_imagen_hcca"));
                    #endregion
