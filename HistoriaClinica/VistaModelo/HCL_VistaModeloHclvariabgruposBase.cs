...
namespace HistoriasClinicas.VistaModelo
{
    ...
    /// </para>
    /// </summary>
    public class VistaModeloHclvariabgruposBase : ViewModelBase, IDataErrorInfo
    {
        //------------------------------------------------
        //-Identificador unico de esta Clase
        //------------------------------------------------
        public String gcrIdVistaModeloForm = "HCL006";
        //------------------------------------------------
        ...
        //------------------------------------------------
        #region Notificacion campos: HCLVARIABGRUPOS
        #region G1Hcl_secgru_hcgv: Codigo grupo
        ...
        #endregion
        #region G1Hcl_conobj_hcgv: Generador de registros
        public const string gcrNomProp_G1Hcl_conobj_hcgv = "G1Hcl_conobj_hcgv";
        private int _g1hcl_conobj_hcgv = 0;
        /// <summary>
        /// <para>TABLA: hclvariabgrupos</para>
        /// <para>TABLA NATIVA: hclvariabgrupos</para>
        /// <para>CAMPO: Generador de registros</para>
        /// <para>NOMBRE: g1hcl_conobj_hcgv (int:6)</para>
        /// <para>ORDEN VISTA EN TABLA: 4</para>
        /// <para>DESCRIPCION:
        ///Contador para generar id unicos de registros
        /// </para>
        /// </summary>
        public int G1Hcl_conobj_hcgv
        {
            get { return _g1hcl_conobj_hcgv; }
            set
            {
                if (_g1hcl_conobj_hcgv == value) return;
                _g1hcl_conobj_hcgv = value;
                RaisePropertyChanged(gcrNomProp_G1Hcl_conobj_hcgv);
            }
        }
        #endregion
        ...
        #endregion
        //------------------------------------------------
        //HCLVARIABGRUPOS COMBOBOX: Maestro grupos de variables publicas
        //------------------------------------------------
        #region Campos ComboBox: HCLVARIABGRUPOS
        #region  G1CbHcl_sisgru_hcgv: Grupo protegido
        public const string gcrNomProp_G1CbHcl_sisgru_hcgv = "G1CbHcl_sisgru_hcgv";
        private List<CrtForms.ListaComboBox> _g1cbhcl_sisgru_hcgv;
        /// <summary>
        /// <para>TABLA: hclvariabgrupos</para>
        /// <para>TABLA NATIVA: hclvariabgrupos</para>
        /// <para>CAMPO: Grupo protegido</para>
        /// <para>NOMBRE: g1cbhcl_sisgru_hcgv (char:1)</para>
        /// <para>ORDEN VISTA EN TABLA: 5</para>
        /// <para>DESCRIPCION:
        /// Grupo del sistema: 1= Grupo protegido de sistema 2=Grupo normal
        /// no protegido
        /// </para>
        /// </summary>
        public List<CrtForms.ListaComboBox> G1CbHcl_sisgru_hcgv
        {
            get { return _g1cbhcl_sisgru_hcgv; }
            set
            {
                if (_g1cbhcl_sisgru_hcgv == value) return;
                _g1cbhcl_sisgru_hcgv = value;
                RaisePropertyChanged(gcrNomProp_G1CbHcl_sisgru_hcgv);
            }
        }
        #endregion
        ...
        #endregion
        //------------------------------------------------
        //HCLVARIABGRUPOS: Registro Activo y Lista Browser
        //------------------------------------------------
        ...
        private ModeloHclvariabgrupos _tmpg1regactivo;
        /// <summary>
        ///  Registro activo de la tabla: hclvariabgrupos
        /// </summary>
        public ModeloHclvariabgrupos TmpG1RegActivo
        {
        ...
        private ObservableCollection<ModeloHclvariabgrupos> _tmpg1listabrow;
        /// <summary>
        ///  Lista de registros tabla: hclvariabgrupos
        /// </summary>
        public ObservableCollection<ModeloHclvariabgrupos> TmpG1ListaBrow
        {
        ...
        public RelayCommand<ModeloHclvariabgrupos> SelectionChangedCommand { get; set; }
        ...
        public virtual void fcvRegistrarComandos()
        {
            ...
            SelectionChangedCommand = new RelayCommand<ModeloHclvariabgrupos>(lobjRegistro =>
            {
        ...
        public VistaModeloHclvariabgruposBase()
        {
            fcvIniciarComboBox();
            fcvReiniVariables();
            TmpG1ListaBrow = new ObservableCollection<ModeloHclvariabgrupos>(ModeloHclvariabgrupos.flsListaHclvariabgrupos(""));
        ...
        public virtual void Guardar()
        {
            try
            {
                ...
                {
                    TmpG1RegActivo.Hcl_secgru_hcgv = ModeloHclvariabgrupos.flgAddRegistro(TmpG1RegActivo);
                    G1Hcl_secgru_hcgv = TmpG1RegActivo.Hcl_secgru_hcgv;
                    TmpG1ListaBrow.Add(TmpG1RegActivo);
                }
                else
                {
                    fcvCargarRegActivoDesdeVariables();
                    ModeloHclvariabgrupos.fcvActualizar(TmpG1RegActivo);
                }
                if (string.IsNullOrEmpty(G1Hcl_secgru_hcgv))
                {
                    Restaurar();
                }
        ...
        public virtual void Eliminar()
        {
            try
            {
                ...
                {
                    ModeloHclvariabgrupos.fcvEliminar(TmpG1RegActivo.Hcl_secgru_hcgv);
        ...
        public virtual void Filtro()
        {
            try
            {
                ...
                {
                    Restaurar();
                    TmpG1ListaBrow = new ObservableCollection<ModeloHclvariabgrupos>(ModeloHclvariabgrupos.flsListaHclvariabgrupos(GcrFiltroDatos));
        ...
        public virtual void fcvReiniVariables()
        {
            try
            {
                ...
                G1Hcl_secgru_hcgv = string.Empty;
                G1Hcl_desgru_hcgv = string.Empty;
                G1Hcl_nomvar_hcgv = string.Empty;
                G1Hcl_conobj_hcgv = 0;
                G1Hcl_sisgru_hcgv = string.Empty;
                G1Sis_estreg_esrg = string.Empty;
                #endregion
                TmpG1RegActivo = new ModeloHclvariabgrupos();
                tmpLogErrores = new List<LogsErrores>();
            }
            catch (NotImplementedException ex)
            {
        ...
        public virtual void fcvCargarRegActivoDesdeVariables()
        {
            try
            {
                ...
                TmpG1RegActivo.Hcl_nomvar_hcgv = G1Hcl_nomvar_hcgv;
                TmpG1RegActivo.Hcl_conobj_hcgv = G1Hcl_conobj_hcgv;
                TmpG1RegActivo.Hcl_sisgru_hcgv = G1Hcl_sisgru_hcgv;
        ...
        public virtual void fcvCargarVariablesDesdeRegActivo()
        {
            try
            {
                #region Valores Variables
                G1Hcl_secgru_hcgv = TmpG1RegActivo.Hcl_secgru_hcgv;
                G1Hcl_desgru_hcgv = TmpG1RegActivo.Hcl_desgru_hcgv;
                G1Hcl_nomvar_hcgv = TmpG1RegActivo.Hcl_nomvar_hcgv;
                G1Hcl_conobj_hcgv = TmpG1RegActivo.Hcl_conobj_hcgv;
                G1Hcl_sisgru_hcgv = TmpG1RegActivo.Hcl_sisgru_hcgv;
        ...
        public virtual bool CanEDT()
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(TmpG1RegActivo.Hcl_secgru_hcgv) && GlgSIS_ModoEdicion == false && G1Hcl_sisgru_hcgv == "2")
                {
                    // verificar si el perfil tiene permiso
        ...
        public virtual bool CanSAV()
        {
            ...
            try
            {
                ...
                {
                    #region Valores Variables
                    llgReturn = string.IsNullOrEmpty(fcrValidacion("G1Hcl_desgru_hcgv")) &&
                                string.IsNullOrEmpty(fcrValidacion("G1Hcl_nomvar_hcgv")) &&
                                string.IsNullOrEmpty(fcrValidacion("G1Hcl_conobj_hcgv")) &&
                                string.IsNullOrEmpty(fcrValidacion("G1Hcl_sisgru_hcgv")) &&
        ...
        public virtual void fcvIniciarComboBox()
        {
            ...
            {
                //-------------------------------------------------
                //HCL_SISGRU_HCGV: Grupo protegido
                //-------------------------------------------------
                #region HCL_SISGRU_HCGV: Grupo protegido
                string lcrG11Seleccion = "1,2";
                string lcrG11Descripcion = "Grupo protegido,Grupo modificable";
                G1CbHcl_sisgru_hcgv = new List<CrtForms.ListaComboBox>();
                G1CbHcl_sisgru_hcgv = CrtForms.flsCargarLista(lcrG11Seleccion, lcrG11Descripcion);
                #endregion
                //-------------------------------------------------
