...
namespace Microsoft.Xades
{
	...
	public class XadesObject
	{
		...
		public void LoadXml(XmlElement xmlElement, XmlElement counterSignedXmlElement)
		{
			...
			this.qualifyingProperties = new QualifyingProperties(); // Aqui-QualifyingProperties
		...
		public XmlElement GetXml()
		{
			...
			retVal = creationXmlDocument.CreateElement("ds", "Object", SignedXml.XmlDsigNamespaceUrl); // Aqui-ds:Object
			if (this.id != null && this.id != "")
			{
