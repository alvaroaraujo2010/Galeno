...
namespace Microsoft.Xades
{
	...
	public class QualifyingProperties
	{
		...
		/// Retorna el XML que representa el objeto para xades:QualifyingProperties
		/// </summary>
		/// <returns>XML element containing the state of this object</returns>
		public XmlElement GetXml() // Aqui-xades:QualifyingProperties  Devuelve el objeto
		{
			XmlDocument creationXmlDocument;
			XmlElement retVal;

			creationXmlDocument = new XmlDocument();
			// Aqui- QualifyingProperties se quita el atributo xmlns:xades
            ...
            if (!String.IsNullOrEmpty(this.id))
			{
				//retVal.SetAttribute("Id", this.id); // Aqui- Se inhabilita el atributo id
			}
			...
			if (this.signedProperties != null && this.signedProperties.HasChanged()) // signedProperties.HasChanged() - Valida  
			{
