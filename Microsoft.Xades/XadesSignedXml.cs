...
namespace Microsoft.Xades
{
    ...
    /// -----------
    /// Clase tipo fachada para la biblioteca de firmas XAdES. La clase hereda de
    /// la clase: System.Security.Cryptography.Xml.SignedXml y hacia atrás
    /// compatible con con esta, por lo que esta clase puede alojar firmas xmldsig y XAdES
    /// firmas La propiedad SignatureStandard indicará el tipo de firma: XMLDSIG o XAdES.
    /// </summary>
    public class XadesSignedXml : System.Security.Cryptography.Xml.SignedXml
    {
        ...
        /// Nombre de tipo obligatorio para la referencia Uri al elemento SignedProperties
        /// path: .../ds:SignedInfo/ds:Reference
        /// </summary>
        public const string SignedPropertiesType = "http://uri.etsi.org/01903#SignedProperties"; // .../ds:SignedInfo/ds:Reference
        ...
        public void AddXadesObject(XadesObject xadesObject)
        {
            ...
            if (this.SignatureStandard != KnownSignatureStandard.Xades)
            {
                ...
                this.AddObject(dataObject); // Add the XAdES object  // Aqui-ds:Object
        ...
        public X509Certificate2 GetSigningCertificate() // Aqui-X509Certificate
        {
        ...
        public virtual bool CheckXmldsigSignature() // Aqui-X509Certificate
        {
            bool retVal = false;
        ...
        /// namespace prefix to all XmlDsig nodes - ojo-SignedInfo
        /// </summary>
