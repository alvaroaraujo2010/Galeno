//- MARMOTA-GENCODE: VERSION 2.0 - 16/04/2014 10:01:49 AM
using System;
...
{
    /// <summary>
    /// Descripcion para la Vista de  la tabla: sptabcampos4505
    /// </summary>
    public class ModeloSptabcampos4505 : clBaseInpc
    {
        ...
        public static string flgAddRegistro(ModeloSptabcampos4505 tobjModelo)
        {
            var lcrCodigoGen = string.Empty;
            using (_context = new DbAplicacion())
            {
                var lobjRegistro = new EFsptabcampos4505
                {
                ...
                _context.AddToSptabcampos4505(lobjRegistro);
        ...
        public static void fcvActualizar(ModeloSptabcampos4505 tobjModelo)
        {
            using (_context = new DbAplicacion())
            {
                var lobjRegistro = _context.Sptabcampos4505.FirstOrDefault(p => p.ssp_codcam_resc == tobjModelo.Ssp_codcam_resc);
        ...
        public static List<ModeloSptabcampos4505> flsListaSptabcampos4505(string tcrBuscar)
        {
            using (_context = new DbAplicacion())
            {
                if (string.IsNullOrEmpty(tcrBuscar))
                {
                    var lobConsulta = from sptabcampos4505 in _context.Sptabcampos4505
                                      select new ModeloSptabcampos4505
                                      {
                                          Ssp_codcam_resc = sptabcampos4505.ssp_codcam_resc,
                                          Ssp_nomcam_resc = sptabcampos4505.ssp_nomcam_resc,
                                          Ssp_ordvis_resc = (int)sptabcampos4505.ssp_ordvis_resc,
                                          Ssp_descam_resc = sptabcampos4505.ssp_descam_resc,
                                          Ssp_tipval_resc = sptabcampos4505.ssp_tipval_resc,
                                          Ssp_valper_resc = sptabcampos4505.ssp_valper_resc,
                                          Ssp_camdig_resc = sptabcampos4505.ssp_camdig_resc,
                                          Ssp_ranini_resc = sptabcampos4505.ssp_ranini_resc,
                                          Ssp_ranfin_resc = sptabcampos4505.ssp_ranfin_resc,
                                      };
                ...
                {
                    var lobConsulta = from sptabcampos4505 in _context.Sptabcampos4505
                                      where sptabcampos4505.ssp_codcam_resc.Contains(tcrBuscar) || sptabcampos4505.ssp_nomcam_resc.Contains(tcrBuscar)
                                      select new ModeloSptabcampos4505
                                      {
                                          Ssp_codcam_resc = sptabcampos4505.ssp_codcam_resc,
                                          Ssp_nomcam_resc = sptabcampos4505.ssp_nomcam_resc,
