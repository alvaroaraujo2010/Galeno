...
namespace SaludPublica.VistaModelo
{
    ...
    /// </para>
    /// </summary>
    public class VistaModeloSptabcampos4045 : VistaModeloSptabcampos4045Base
    {
        //-------------------------------------------------
            ...
            try
            {
                switch (tcrNombrePropiedad)
                {
                    case "G1Ssp_codcam_resc":
                        ...
                        {
                            if (GlgSIS_ModoAdicion == true && SSPValidarCodigo.flgBuscarSptabcampos4045(G1Ssp_codcam_resc))
                            {
                    ...
                    case "G1Ssp_ordvis_resc":
                        if (string.IsNullOrWhiteSpace(G1Ssp_ordvis_resc))
                        {
