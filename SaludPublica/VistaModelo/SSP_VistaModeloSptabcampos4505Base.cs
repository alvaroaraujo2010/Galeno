...
namespace SaludPublica.VistaModelo
{
    ...
    /// </para>
    /// </summary>
    public class VistaModeloSptabcampos4505Base : ViewModelBase, IDataErrorInfo
    {
        //------------------------------------------------
        ...
        //------------------------------------------------
        #region notificacion campos: SPTABCAMPOS4505
        ...
        /// <para>DESCRIPCION:
        /// Consecutivo Único de campo o nombre (ejemplo: SSP_CAM025_MS45)
        /// </para>
        /// </summary>
        ...
        private int _g1ssp_ordvis_resc = 0;
        /// <summary>
        /// <para>TABLA: sptabcampos4505</para>
        /// <para>TABLA NATIVA: sptabcampos4505</para>
        ...
        #endregion
        //------------------------------------------------
        //SPTABCAMPOS4505 COMBOBOX: Campos de la Resolución 4505
        //------------------------------------------------
        #region Campos ComboBox: SPTABCAMPOS4505
        ...
        #endregion
        //------------------------------------------------
        //SPTABCAMPOS4505: Registro Activo y Lista Browser
        //------------------------------------------------
        ...
        private ModeloSptabcampos4505 _tmpg1regactivo;
        /// <summary>
        ///  Registro activo de la tabla: sptabcampos4505
        /// </summary>
        public ModeloSptabcampos4505 TmpG1RegActivo
        {
        ...
        private ObservableCollection<ModeloSptabcampos4505> _tmpg1listabrow;
        /// <summary>
        ///  Lista de registros tabla: sptabcampos4505
        /// </summary>
        public ObservableCollection<ModeloSptabcampos4505> TmpG1ListaBrow
        {
        ...
        public RelayCommand<ModeloSptabcampos4505> SelectionChangedCommand { get; set; }
        ...
        public virtual void fcvRegistrarComandos()
        {
            ...
            SelectionChangedCommand = new RelayCommand<ModeloSptabcampos4505>(lobjRegistro =>
            {
        ...
        public VistaModeloSptabcampos4505Base()
        {
            fcvIniciarComboBox();
            fcvReiniVariables();
            TmpG1ListaBrow = new ObservableCollection<ModeloSptabcampos4505>(ModeloSptabcampos4505.flsListaSptabcampos4505(""));
        ...
        public virtual void Guardar()
        {
            try
            {
                ...
                {
                    TmpG1RegActivo.Ssp_codcam_resc = ModeloSptabcampos4505.flgAddRegistro(TmpG1RegActivo);
                ...
                {
                    fcvCargarRegActivoDesdeVariables();
                    ModeloSptabcampos4505.fcvActualizar(TmpG1RegActivo);
                }
        ...
        public virtual void Eliminar()
        {
            try
            {
                ...
                {
                    ModeloSptabcampos4505.fcvEliminar(TmpG1RegActivo.Ssp_codcam_resc);
        ...
        public virtual void Filtro()
        {
            try
            {
                ...
                {
                    Restaurar();
                    TmpG1ListaBrow = new ObservableCollection<ModeloSptabcampos4505>(ModeloSptabcampos4505.flsListaSptabcampos4505(GcrFiltroDatos));
        ...
        public virtual void fcvReiniVariables()
        {
            try
            {
                ...
                #endregion
                TmpG1RegActivo = new ModeloSptabcampos4505();
            }
            catch (NotImplementedException ex)
            {
        ...
        public virtual void fcvIniciarComboBox()
        {
            try
            {
                ...
                string lcrG11Descripcion = "FECHA,CARACTER,NÚMERICO";
