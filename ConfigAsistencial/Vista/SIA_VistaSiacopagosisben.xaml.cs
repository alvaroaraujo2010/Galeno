//- MARMOTA-GENCODE: VERSION 2.0 - 26/08/2013 05:55:15 PM
using System;
...
namespace ConfigAsistencial.Vista
{
    ...
    /// </summary>
    public partial class VistaSiacopagosisben : Window, SIS_Interface
    {
        //-------------------------------------------------
        // Inicio Formulario
        //-------------------------------------------------
        ...
        private void fcvNuevoRegistro(object sender, RoutedEventArgs e)
        {
            ...
            FocusManager.SetFocusedElement(this, txtG1Sia_codcpo_cpsb);
        }
        ...
        #region KeyDown para campos con F2 Tabla: SIACOPAGOSISBEN
                ...
                if (llgObjetosCargados == true)
                {
                    ...
                    switch (lobTexto.Name)
                    {
                        case "txtG1Sia_tipcob_cpcb":
                            CrtForms.ListaComboBox lobG1ComboBox1 = (CrtForms.ListaComboBox)cboG1Sia_tipcob_cpcb.SelectedItem;
                            cboG1Sia_tipcob_cpcb.SelectedIndex = CrtForms.fnuMostrarItemCombo(lcrValor, ",", lobG1ComboBox1.ListaValoresSel);
                            break;
                        case "txtG1Sia_tippor_cpsb":
                            CrtForms.ListaComboBox lobG1ComboBox2 = (CrtForms.ListaComboBox)cboG1Sia_tippor_cpsb.SelectedItem;
                            cboG1Sia_tippor_cpsb.SelectedIndex = CrtForms.fnuMostrarItemCombo(lcrValor, ",", lobG1ComboBox2.ListaValoresSel);
                            break;
                    }
                }
            }
