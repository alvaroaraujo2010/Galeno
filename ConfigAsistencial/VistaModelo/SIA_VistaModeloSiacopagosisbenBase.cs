//- MARMOTA-GENCODE: VERSION 2.0 - 27/08/2013 06:26:39 AM
using System;
...
namespace ConfigAsistencial.VistaModelo
{
    ...
    /// </para>
    /// </summary>
    public class VistaModeloSiacopagosisbenBase : ViewModelBase, IDataErrorInfo
    {
        //------------------------------------------------
        ...
        //------------------------------------------------
        #region notificacion campos: SIACOPAGOSISBEN
        #region G1Sia_codcpo_cpsb: Código rango
        public const string gcrNomProp_G1Sia_codcpo_cpsb = "G1Sia_codcpo_cpsb";
        private string _g1sia_codcpo_cpsb = string.Empty;
        /// <summary>
        /// <para>TABLA: siacopagosisben</para>
        /// <para>TABLA NATIVA: siacopagosisben</para>
        /// <para>CAMPO: Código rango</para>
        /// <para>NOMBRE: g1sia_codcpo_cpsb (char:2)</para>
        ...
        /// </para>
        /// </summary>
        public string G1Sia_codcpo_cpsb
        {
            get { return _g1sia_codcpo_cpsb; }
            set
            {
                if (_g1sia_codcpo_cpsb == value) return;
                _g1sia_codcpo_cpsb = value;
                RaisePropertyChanged(gcrNomProp_G1Sia_codcpo_cpsb);
            }
        }
        #endregion
        #region G1Sia_descpo_cpsb: Descripción Copago
        public const string gcrNomProp_G1Sia_descpo_cpsb = "G1Sia_descpo_cpsb";
        private string _g1sia_descpo_cpsb = string.Empty;
        /// <summary>
        /// <para>TABLA: siacopagosisben</para>
        /// <para>TABLA NATIVA: siacopagosisben</para>
        /// <para>CAMPO: Descripción Copago</para>
        /// <para>NOMBRE: g1sia_descpo_cpsb (char:40)</para>
        /// <para>ORDEN VISTA EN TABLA: 2</para>
        /// <para>DESCRIPCION:
        ///Descripción del porcentaje copago aplicado
        /// </para>
        /// </summary>
        public string G1Sia_descpo_cpsb
        {
            get { return _g1sia_descpo_cpsb; }
            set
            {
                if (_g1sia_descpo_cpsb == value) return;
                _g1sia_descpo_cpsb = value;
                RaisePropertyChanged(gcrNomProp_G1Sia_descpo_cpsb);
            }
        }
        #endregion
        ...
        #endregion
        #region G1Sia_porapl_cpsb: Porcentaje copago
        ...
        #endregion
        //------------------------------------------------
        //SIACOPAGOSISBEN COMBOBOX: Copagos y cuotas moderadoras Sisben
        //------------------------------------------------
        #region Campos ComboBox: SIACOPAGOSISBEN
        ...
        #endregion
        //------------------------------------------------
        //SIACOPAGOSISBEN: Registro Activo y Lista Browser
        //------------------------------------------------
        ...
        private ModeloSiacopagosisben _tmpg1regactivo;
        /// <summary>
        ///  Registro activo de la tabla: siacopagosisben
        /// </summary>
        public ModeloSiacopagosisben TmpG1RegActivo
        {
        ...
        private ObservableCollection<ModeloSiacopagosisben> _tmpg1listabrow;
        /// <summary>
        ///  Lista de registros tabla: siacopagosisben
        /// </summary>
        public ObservableCollection<ModeloSiacopagosisben> TmpG1ListaBrow
        {
        ...
        public RelayCommand<ModeloSiacopagosisben> SelectionChangedCommand { get; set; }
        ...
        public virtual void fcvRegistrarComandos()
        {
            ...
            SelectionChangedCommand = new RelayCommand<ModeloSiacopagosisben>(lobjRegistro =>
            {
        ...
        public VistaModeloSiacopagosisbenBase()
        {
            fcvIniciarComboBox();
            fcvReiniVariables();
            TmpG1ListaBrow = new ObservableCollection<ModeloSiacopagosisben>(ModeloSiacopagosisben.flsListaSiacopagosisben(""));
        ...
        public virtual void Guardar()
        {
            try
            {
                ...
                {
                    TmpG1RegActivo.Sia_codcpo_cpsb = ModeloSiacopagosisben.flgAddRegistro(TmpG1RegActivo);
                    G1Sia_codcpo_cpsb = TmpG1RegActivo.Sia_codcpo_cpsb;
                    TmpG1ListaBrow.Add(TmpG1RegActivo);
                }
                else
                {
                    fcvCargarRegActivoDesdeVariables();
                    ModeloSiacopagosisben.fcvActualizar(TmpG1RegActivo);
                }
                if (string.IsNullOrEmpty(G1Sia_codcpo_cpsb))
                {
                    Restaurar();
                }
        ...
        public virtual void Eliminar()
        {
            try
            {
                ...
                {
                    ModeloSiacopagosisben.fcvEliminar(TmpG1RegActivo.Sia_codcpo_cpsb);
        ...
        public virtual void Filtro()
        {
            try
            {
                ...
                {
                    Restaurar();
                    TmpG1ListaBrow = new ObservableCollection<ModeloSiacopagosisben>(ModeloSiacopagosisben.flsListaSiacopagosisben(GcrFiltroDatos));
        ...
        public virtual void fcvReiniVariables()
        {
            try
            {
                ...
                G1Sia_codcpo_cpsb = string.Empty;
                G1Sia_descpo_cpsb = string.Empty;
                ...
                #endregion
                TmpG1RegActivo = new ModeloSiacopagosisben();
            }
            catch (NotImplementedException ex)
            {
        ...
        public virtual void fcvCargarRegActivoDesdeVariables()
        {
            ...
            {
                #region Valores Variables
                TmpG1RegActivo.Sia_codcpo_cpsb = G1Sia_codcpo_cpsb;
                TmpG1RegActivo.Sia_descpo_cpsb = G1Sia_descpo_cpsb;
        ...
        public virtual void fcvCargarVariablesDesdeRegActivo()
        {
            try
            {
                #region Valores Variables
                G1Sia_codcpo_cpsb = TmpG1RegActivo.Sia_codcpo_cpsb;
                G1Sia_descpo_cpsb = TmpG1RegActivo.Sia_descpo_cpsb;
        ...
        public virtual bool CanEDT()
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(TmpG1RegActivo.Sia_codcpo_cpsb) && GlgSIS_ModoEdicion == false)
                {
                    // verificar si el perfil tiene permiso
        ...
        public virtual bool CanSAV()
        {
            ...
            try
            {
                ...
                {
                    #region Valores Variables
                    llgReturn = string.IsNullOrEmpty(fcrValidacion("G1Sia_codcpo_cpsb")) &&
                                string.IsNullOrEmpty(fcrValidacion("G1Sia_descpo_cpsb")) &&
        ...
        public virtual void fcvIniciarComboBox()
        {
            try
            {
                ...
                string lcrG11Descripcion = "Copago,Cuota Moderadora";
                G1CbSia_tipcob_cpcb = new List<CrtForms.ListaComboBox>();
                G1CbSia_tipcob_cpcb = CrtForms.flsCargarLista(lcrG11Seleccion, lcrG11Descripcion);
                #endregion
                //-------------------------------------------------
                ...
                string lcrG12Descripcion = "Sobre tarifa del servicio,Sobre SMLMV (minimo mensual),Salario SMLDV (minimo diario)";
                G1CbSia_tippor_cpsb = new List<CrtForms.ListaComboBox>();
                G1CbSia_tippor_cpsb = CrtForms.flsCargarLista(lcrG12Seleccion, lcrG12Descripcion);
                #endregion
            }
            catch (NotImplementedException ex)
            {
