...
namespace Systemas.Vista
{
    ...
    /// </summary>
    public partial class VistaSysusuarios : Window, SIS_Interface
    {
        //-------------------------------------------------
        // Inicio Formulario
        //-------------------------------------------------
        ...
        VistaModeloSysusuarios vm = null;
        DialogVistaErrores lobDlgLogs = null;
        /// <summary>
        /// Inicializar nueva instancia de la clase
        /// </summary>
        public VistaSysusuarios()
        {
            InitializeComponent();

            vm = this.DataContext as VistaModeloSysusuarios;
            vm.Restaurar();
        ...
        private void fcvNuevoRegistro(object sender, RoutedEventArgs e)
        {
            ...
            FocusManager.SetFocusedElement(this, txtG1Sys_ideusu_usux);
        }
        ...
        public void fcvActivarModoEdicion(string tcrTipoEdicion)
        {
            ...
            {
                FocusManager.SetFocusedElement(this, txtG1Sys_codusu_usux);
        ...
        {
            vm.Restaurar();
            LocalizadorVistaModelo.fcvLiberarVistaModeloSysusuarios();
        ...
        private void fcvTextBox2_GotFocus(object sender, RoutedEventArgs e)
        {
        ...
        #region KeyDown para campos con F2 Tabla: SYSUSUARIOS
        #region SYS_CODPER_PERF : Maestro perfiles de usuarios
        private void txtG1Sys_codper_perf_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Return)
            {
                e.Handled = true;
            ...
            if (e.Key == Key.F2)
            {
                txtG1Sys_codper_perf_Browser();
            }
        }
        private void cmdG1Sys_codper_perf_Click(object sender, RoutedEventArgs e)
        {
            txtG1Sys_codper_perf_Browser();
        }
        private void txtG1Sys_codper_perf_Browser()
        {
        ...
        private void SeleccionComboBoxOpcion(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "cboG1Sys_estusu_usux":
                            txtG1Sys_estusu_usux.Text = CrtForms.fcrSeletDesdeComb(lobList.IdIndice,
                                                                                    txtG1Sys_estusu_usux.Text, ",",
                                                                                    lobList.ListaValoresSel);
                            lobCombo.SelectedIndex = CrtForms.fnuMostrarItemCombo(txtG1Sys_estusu_usux.Text, ",", lobList.ListaValoresSel);
                            break;
                    }
                }
            }
        ...
        private void ActualizarComboBoxOpcion(object sender, TextChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "txtG1Sys_estusu_usux":
                            CrtForms.ListaComboBox lobG1ComboBox1 = (CrtForms.ListaComboBox)cboG1Sys_estusu_usux.SelectedItem;
                            cboG1Sys_estusu_usux.SelectedIndex = CrtForms.fnuMostrarItemCombo(lcrValor, ",", lobG1ComboBox1.ListaValoresSel);
                            break;
                    }
                }
            }
