...
namespace Sistema.Vista
{
    ...
    /// </summary>
    public partial class VistaSisparametroips : Window, SIS_Interface
    {
        //-------------------------------------------------
        // Inicio Formulario
        //-------------------------------------------------
        ...
        VistaModeloSisparametroips gobObjVModelo = null;
        DialogVistaErrores lobDlgLogs = null;
        /// <summary>
        /// Inicializar nueva instancia de la clase
        /// </summary>
        public VistaSisparametroips()
        {
            InitializeComponent();

            gobObjVModelo = this.DataContext as VistaModeloSisparametroips;
            ...
            gobObjVModelo.TmpG1RegActivo = ModeloSisparametroips.flsListaSisparametroipsRg();
            gobObjVModelo.fcvCargarVariablesDesdeRegActivo();
        }
        #endregion
        //-------------------------------------------------
        // Gestion Edicion
        ...
        private void fcvNuevoRegistro(object sender, RoutedEventArgs e)
        {
            ...
            FocusManager.SetFocusedElement(this, txtG1Sis_idereg_pips);
        }
        ...
        {
            Browser01 frbro = new Browser01("SIS", "SISPARAMETROIPS", "", "Parametros basicos configuración IPS...");
            gcrCtrF2TexBox = "txtG1Sis_idereg_pips";
            frbro.Owner = this;
            frbro.ShowDialog();
        }
        #endregion
        ...
        public void fcvBuscarRegistro(string tcrCodigo)
        {
            ...
            {
                case "txtG1Sis_idereg_pips":
                    txtG1Sis_idereg_pips.Text = tcrCodigo;
                    break;

            }
        }
        // SISPARAMETROIPS : Parametros basicos configuración IPS
        #region KeyDown para campos con F2 Tabla: SISPARAMETROIPS
        #endregion
        #endregion
    }
}