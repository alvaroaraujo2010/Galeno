...
namespace Hospitalizacion.Vista
{
    ...
    /// </summary>
    public partial class VistaHosconfigmodulo : Window, SIS_Interface
    {
        //-------------------------------------------------
        // Inicio Formulario
        //-------------------------------------------------
        ...
        VistaModeloHosconfigmodulo gobObjVModelo = null;
        DialogVistaErrores lobDlgLogs = null;
        /// <summary>
        /// Inicializar nueva instancia de la clase
        /// </summary>
        public VistaHosconfigmodulo()
        {
            InitializeComponent();

            gobObjVModelo = this.DataContext as VistaModeloHosconfigmodulo;
            ...
            this.txtG1Hos_codsys_hoxx.Text = "01";
        ...
        private void fcvNuevoRegistro(object sender, RoutedEventArgs e)
        {
            ...
            FocusManager.SetFocusedElement(this, txtG1Hos_codsys_hoxx);
        }
        ...
        {
            Browser01 frbro = new Browser01("HOS", "HOSCONFIGMODULO", "", "Configuración modulo hospitalización...");
            gcrCtrF2TexBox = "txtG1Hos_codsys_hoxx";
            frbro.Owner = this;
            frbro.ShowDialog();
        }
        #endregion
        ...
        public void fcvBuscarRegistro(string tcrCodigo)
        {
            ...
            {
                case "txtG1Hos_codsys_hoxx":
                    txtG1Hos_codsys_hoxx.Text = tcrCodigo;
                    break;

            }
        }
        // HOSCONFIGMODULO : Configuración modulo hospitalización
        #region KeyDown para campos con F2 Tabla: HOSCONFIGMODULO
        #endregion
        #endregion
        //-------------------------------------------------
        ...
        private void SeleccionComboBoxOpcion(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "cboG1Hos_epicri_hoxx":
                            txtG1Hos_epicri_hoxx.Text = CrtForms.fcrSeletDesdeComb(lobList.IdIndice,
                                                                                    txtG1Hos_epicri_hoxx.Text, ",",
                                                                                    lobList.ListaValoresSel);
                            lobCombo.SelectedIndex = CrtForms.fnuMostrarItemCombo(txtG1Hos_epicri_hoxx.Text, ",", lobList.ListaValoresSel);
                            break;
                        case "cboG1Hos_autegr_hoxx":
                            txtG1Hos_autegr_hoxx.Text = CrtForms.fcrSeletDesdeComb(lobList.IdIndice,
                                                                                    txtG1Hos_autegr_hoxx.Text, ",",
                                                                                    lobList.ListaValoresSel);
                            lobCombo.SelectedIndex = CrtForms.fnuMostrarItemCombo(txtG1Hos_autegr_hoxx.Text, ",", lobList.ListaValoresSel);
                            break;
                        case "cboG1Hos_format_hoxx":
                            txtG1Hos_format_hoxx.Text = CrtForms.fcrSeletDesdeComb(lobList.IdIndice,
                                                                                    txtG1Hos_format_hoxx.Text, ",",
                                                                                    lobList.ListaValoresSel);
                            lobCombo.SelectedIndex = CrtForms.fnuMostrarItemCombo(txtG1Hos_format_hoxx.Text, ",", lobList.ListaValoresSel);
                            break;
                    }
                }
            }
        ...
        private void ActualizarComboBoxOpcion(object sender, TextChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "txtG1Hos_epicri_hoxx":
                            CrtForms.ListaComboBox lobG1ComboBox1 = (CrtForms.ListaComboBox)cboG1Hos_epicri_hoxx.SelectedItem;
                            cboG1Hos_epicri_hoxx.SelectedIndex = CrtForms.fnuMostrarItemCombo(lcrValor, ",", lobG1ComboBox1.ListaValoresSel);
                            break;
                        case "txtG1Hos_autegr_hoxx":
                            CrtForms.ListaComboBox lobG1ComboBox2 = (CrtForms.ListaComboBox)cboG1Hos_autegr_hoxx.SelectedItem;
                            cboG1Hos_autegr_hoxx.SelectedIndex = CrtForms.fnuMostrarItemCombo(lcrValor, ",", lobG1ComboBox2.ListaValoresSel);
                            break;
                        case "txtG1Hos_format_hoxx":
                            CrtForms.ListaComboBox lobG1ComboBox3 = (CrtForms.ListaComboBox)cboG1Hos_format_hoxx.SelectedItem;
                            cboG1Hos_format_hoxx.SelectedIndex = CrtForms.fnuMostrarItemCombo(lcrValor, ",", lobG1ComboBox3.ListaValoresSel);
                            break;
                    }
                }
            }
