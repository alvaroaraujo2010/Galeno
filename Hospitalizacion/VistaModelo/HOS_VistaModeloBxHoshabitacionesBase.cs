//- MARMOTA-GENCODE: VERSION 2.0 - 18/02/2013 07:25:57 AM
using System;
...
namespace Hospitalizacion.VistaModelo
{
    ...
    /// </para>
    /// </summary>
    public class VistaModeloBxHoshabitacionesBase : ViewModelBase, IDataErrorInfo
    {
        //------------------------------------------------
        //-Identificador unico de esta Clase
        //------------------------------------------------
        public const string gcrIdVistaModeloForm = "FRM002";
        ...
        #endregion
        #region G2Hos_fechac_caho: Fecha de prueba
        public const string gcrNomProp_G2Hos_fechac_caho = "G2Hos_fechac_caho";
        private string _g2hos_fechac_caho = "  /  /    ";
        /// <summary>
        /// <para>TABLA: hoscamasareas</para>
        /// <para>TABLA NATIVA: hoscamasareas</para>
        /// <para>CAMPO: Fecha de prueba</para>
        /// <para>NOMBRE: hos_fechac_caho (fecha:8)</para>
        /// <para>ORDEN VISTA EN TABLA: 10</para>
        /// <para>DESCRIPCION:
        ///Fecha de prueba
        /// </para>
        /// </summary>
        public string G2Hos_fechac_caho
        {
            get { return _g2hos_fechac_caho; }
            set
            {
                if (_g2hos_fechac_caho == value) return;
                _g2hos_fechac_caho = value;
                RaisePropertyChanged(gcrNomProp_G2Hos_fechac_caho);
            }
        }
        #endregion
        #region G2Hos_horapr_caho: Hora de prueba
        public const string gcrNomProp_G2Hos_horapr_caho = "G2Hos_horapr_caho";
        private string _g2hos_horapr_caho = "  :  :AM";
        /// <summary>
        /// <para>TABLA: hoscamasareas</para>
        /// <para>TABLA NATIVA: hoscamasareas</para>
        /// <para>CAMPO: Hora de prueba</para>
        /// <para>NOMBRE: hos_horapr_caho (HML:8)</para>
        /// <para>ORDEN VISTA EN TABLA: 12</para>
        /// <para>DESCRIPCION:
        ///Hora de prueba de prueba
        /// </para>
        /// </summary>
        public string G2Hos_horapr_caho
        {
            get { return _g2hos_horapr_caho; }
            set
            {
                if (_g2hos_horapr_caho == value) return;
                _g2hos_horapr_caho = value;
                RaisePropertyChanged(gcrNomProp_G2Hos_horapr_caho);
            }
        }
        #endregion
        ...
        private ModeloBxHoshabitaciones _tmpg1regactivo;
        /// <summary>
        ///  Registro activo de la tabla: hoshabitaciones
        /// </summary>
        public ModeloBxHoshabitaciones TmpG1RegActivo
        {
        ...
        private ModeloBxHoscamasareas _tmpg2regactivo;
        /// <summary>
        ///  Registro activo de la tabla: hoscamasareas
        /// </summary>
        public ModeloBxHoscamasareas TmpG2RegActivo
        {
        ...
        private ObservableCollection<ModeloBxHoscamasareas> _tmpg2listabrow;
        /// <summary>
        ///  Lista de registros tabla: hoscamasareas
        /// </summary>
        public ObservableCollection<ModeloBxHoscamasareas> TmpG2ListaBrow
        {
        ...
        private ObservableCollection<ModeloBxHoscamasareas> _tmpg2listaedt;
        /// <summary>
        ///  Lista de registros tabla: hoscamasareas
        /// </summary>
        public ObservableCollection<ModeloBxHoscamasareas> TmpG2ListaEdt
        {
        ...
        public RelayCommand<ModeloBxHoscamasareas> SelectionChangedCommand { get; set; }
        ...
        private void fcvRegistrarComandos()
        {
            ...
            SelectionChangedCommand = new RelayCommand<ModeloBxHoscamasareas>(lobjRegistro =>
            {
        ...
        public VistaModeloBxHoshabitacionesBase()
        {
            fcvReiniVariables("T");
            TmpG2ListaBrow = new ObservableCollection<ModeloBxHoscamasareas>(ModeloBxHoscamasareas.flsListaHoscamasareas(""));
        ...
        public virtual void Adicionar()
        {
            ...
            {
                fcvReiniVariables("A");
                G1Sis_estreg_esrg = "1"; // en estado abierto
                AdicionarRel();
        ...
        public virtual void AdicionarRel()
        {
            ...
            {
                fcvReiniVariables("2");
                TmpG2RegActivo = new ModeloBxHoscamasareas();
        ...
        public virtual void Guardar()
        {
            try
            {
                ...
                {
                    TmpG1RegActivo.Hos_nrohab_habi = ModeloBxHoshabitaciones.flgAddRegistro(TmpG1RegActivo);
                    G1Hos_nrohab_habi = TmpG1RegActivo.Hos_nrohab_habi;
                }
                else
                {
                    ModeloBxHoshabitaciones.fcvActualizar(TmpG1RegActivo);
                }
                ...
                if (!string.IsNullOrEmpty(G1Hos_nrohab_habi))
                {
                    ...
                    {
                        foreach (ModeloBxHoscamasareas lobReg in TmpG2ListaEdt)
                        {
                            //lobReg.Sis_estreg_esrg = G1Sis_estreg_esrg; // Cambia estado de los registro
                            lobReg.Hos_nrohab_habi = G1Hos_nrohab_habi; // llave R1
                            // Actualizar en Base de Datos
                            ModeloBxHoscamasareas.flgAddRegistro(lobReg, G1Hos_nrohab_habi);
                        }
                    }
        ...
        public virtual void Confirmar()
        {
            try
            {
                ...
                {
                    G1Sis_estreg_esrg = "2"; // Cambia estado a cerrado
                    Guardar();
                }
            }
            catch (NotImplementedException ex)
        ...
        public virtual void Eliminar()
        {
            try
            {
                if (MessageBox.Show("Desea Eliminar el registro?", "Confirmación",
                                     MessageBoxButton.YesNo) == MessageBoxResult.Yes)
                {
                    ModeloBxHoshabitaciones.fcvEliminar(TmpG1RegActivo.Hos_nrohab_habi);
                    if (TmpG2ListaBrow.Count > 0)
                    {
                        foreach (ModeloBxHoscamasareas lobReg in TmpG2ListaBrow)
                        {
        ...
        public virtual void Filtro()
        {
            try
            {
                ...
                List<ModeloBxHoshabitaciones> lobTmpReg = ModeloBxHoshabitaciones.flsListaHoshabitaciones(GcrFiltroDatos);
                if (lobTmpReg.Count > 0)
                {
                    TmpG1RegActivo = (ModeloBxHoshabitaciones)lobTmpReg[0];
                    fcvCargarVariablesDesdeRegActivo("1");

                    TmpG2ListaBrow = new ObservableCollection<ModeloBxHoscamasareas>(ModeloBxHoscamasareas.flsListaHoscamasareas(GcrFiltroDatos));
                    if (TmpG2ListaBrow.Count > 0)
                    {
                        TmpG2RegActivo = (ModeloBxHoscamasareas)TmpG2ListaBrow[0];
                        fcvCargarVariablesDesdeRegActivo("2");
                    }
                }
            }
        ...
        /// </summary>
        public virtual void fcvGestionEdtRelacion(ModeloBxHoscamasareas tobRegistro)
        {
            try
            {
        ...
        public virtual void fcvReiniVariables(string tcrZona)
        {
            try
            {
                ...
                {
                    //-- temp para tabla 1
                    TmpG1RegActivo = new ModeloBxHoshabitaciones();
                    //--- Temp para tabla 2
                    TmpG2RegActivo = new ModeloBxHoscamasareas();
                    TmpG2ListaBrow = new ObservableCollection<ModeloBxHoscamasareas>();
                    TmpG2ListaEdt = new ObservableCollection<ModeloBxHoscamasareas>();
                }
            }
            catch (NotImplementedException ex)
            {
            ...
            try
            {
                ...
                if (tcrZona == "2" || tcrZona == "A")
                {
                    if (TmpG2RegActivo != null)
                    {
                        ...
                        TmpG2RegActivo.Hos_fechac_caho = Convert.ToDateTime(G2Hos_fechac_caho);
                        TmpG2RegActivo.Hos_horapr_caho = Decimal.Parse(Funciones.fcrConvierteHora(G2Hos_horapr_caho, "12", ":", gcrSeparadorDecimal)); 
            ...
            try
            {
                ...
                if (tcrZona == "2" || tcrZona == "A")
                {
                    if (TmpG2RegActivo != null)
                    {
                        ...
                        G2Hos_fechac_caho = TmpG2RegActivo.Hos_fechac_caho.ToShortDateString();
                        G2Hos_horapr_caho = Funciones.fcrConvierteHora(TmpG2RegActivo.Hos_horapr_caho.ToString(), "24", gcrSeparadorDecimal, ":"); 
        ...
        public virtual bool CanEDT()
        {
            ...
            try
            {
                if (TmpG1RegActivo.Sis_estreg_esrg == "1" && GlgSIS_ModoEdicion == false)
                {
                    // verificar si el perfil tiene permiso
        ...
        public virtual bool CanCON()
        {
            ...
            try
            {
                if (TmpG2ListaBrow.Count > 0 && G1Sis_estreg_esrg == "1")
                {
                    // verificar si el perfil tiene permiso
            ...
            {
                MessageBox.Show(ex.Message, "VistaModelo Error Metodo: Puede Confirmar (CanCON)");
            }
            return llgReturn;
        }
        #endregion
            ...
            try
            {
                if (GlgSIS_ModoEdicion == true)
                {
                    ...
                    llgReturn = string.IsNullOrEmpty(fcrValidacionRel("G2Hos_descam_caho")) &&
                                ...
                                string.IsNullOrEmpty(fcrValidacionRel("G2Hos_fechac_caho"));
                    #endregion
                    if (llgReturn == true) { gcrSIS_PerfilCmdSAV = "OK"; }
                }
            }
        ...
        public virtual bool CanANU()
        {
            ...
            try
            {
                if (TmpG1RegActivo.Sis_estreg_esrg == "2" && GlgSIS_ModoEdicion == false)
                {
                    // verificar si el perfil tiene permiso
            ...
            {
                MessageBox.Show(ex.Message, "VistaModelo Error Metodo:  Puede anular registro (CanANU)");
            }
            return llgReturn;
        }
        #endregion
        ...
        public virtual bool CanDELREL()
        {
            ...
            try
            {
                if (TmpG1RegActivo.Sis_estreg_esrg == "1" && GlgSIS_ModoEdicion == true && CanSAVREL()==true)
                {
                    // verificar si el perfil tiene permiso
                    if (string.IsNullOrEmpty(gcrSIS_PerfilCmdDEL))
                    {
        ...
        #region CanMODCON
        /// <summary>
        ///Activar ModoConfirmar del Entorno
        /// </summary>
