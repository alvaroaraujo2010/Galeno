//- MARMOTA-GENCODE: VERSION 2.0 - 18/02/2013 07:25:59 AM
using System;
using System.Linq;
using System.Text;
...
namespace Hospitalizacion.Modelo
{
    ...
    /// </summary>
    public class ModeloBxHoshabitaciones : clBaseInpc
    {
        ...
        public static string flgAddRegistro(ModeloBxHoshabitaciones tobjModelo)
        {
        ...
        public static void fcvActualizar(ModeloBxHoshabitaciones tobjModelo)
        {
            using (_context = new DbAplicacion())
            {
        ...
        public static List<ModeloBxHoshabitaciones> flsListaHoshabitaciones(string tcrBuscar)
        {
            using (_context = new DbAplicacion())
            {
                if (string.IsNullOrEmpty(tcrBuscar))
                {
                    return _context.Hoshabitaciones.Select(p => new ModeloBxHoshabitaciones
                    {
                ...
                else
                {
                    var lobConsulta = from tmp in _context.Hoshabitaciones
                                      ...
                                      select new ModeloBxHoshabitaciones
                                      {
    ...
    /// </summary>
    public class ModeloBxHoscamasareas : clBaseInpc
    {
        #region Modelo Attributos
        private static DbAplicacion _context;
        #region Modelo Propiedades pivadas
        ...
        private DateTime _hos_fechac_caho;
        private Decimal _hos_horapr_caho; 
        private string _hos_deshab_habi;
        ...
        #endregion
        #region Hos_fechac_caho: Fecha de prueba
        /// <summary>
        /// <para>TABLA: hoscamasareas</para>
        /// <para>TABLA NATIVA: hoscamasareas</para>
        ...
        /// </para>
        /// </summary>
        public DateTime Hos_fechac_caho
        {
            get { return _hos_fechac_caho; }
            set
            {
                if (_hos_fechac_caho == value) return;
                _hos_fechac_caho = value;
                OnPropertyChanged("Hos_fechac_caho");
            }
        }
        #endregion
        #region Hos_horapr_caho: Hora de prueba
        /// <summary>
        /// <para>TABLA: hoscamasareas</para>
        /// <para>TABLA NATIVA: hoscamasareas</para>
        /// <para>CAMPO: Hora de prueba</para>
        /// <para>NOMBRE: hos_horapr_caho (HML)</para>
        /// <para>ORDEN VISTA EN TABLA: 10</para>
        /// <para>DESCRIPCION:
        ///Hora de prueba
        /// </para>
        /// </summary>
        public Decimal Hos_horapr_caho
        {
            get { return _hos_horapr_caho; }
            set
            {
                if (_hos_horapr_caho == value) return;
                _hos_horapr_caho = value;
                OnPropertyChanged("Hos_horapr_caho");
            }
        }
        #endregion
        #region Hos_deshab_habi: Numero/nombre habitacion
        ...
        public static bool flgAddRegistro(ModeloBxHoscamasareas tobTempReg, string tcrCodigoR1)
        {
            bool llgReturn = false;
            try
            {
        ...
        #endregion
        #region Listar Registros
        public static List<ModeloBxHoscamasareas> flsListaHoscamasareas(string tcrBuscar)
        {
            using (_context = new DbAplicacion())
            {
                var lobConsulta = from tmp in _context.Hoscamasareas
                                  where tmp.hos_nrohab_habi == tcrBuscar
                                  select new ModeloBxHoscamasareas
                                  {
