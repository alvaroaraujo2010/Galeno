...
namespace Inventarios.VistaModelo
{
    ...
    /// </para>
    /// </summary>
    public class VistaModeloInvcontenedoresBase : ViewModelBase, IDataErrorInfo
    {
        //------------------------------------------------
        //-Identificador unico de esta Clase
        //------------------------------------------------
        public String gcrIdVistaModeloForm = "INV007";
        //------------------------------------------------
        ...
        //------------------------------------------------
        #region Notificacion campos: INVCONTENEDORES
        #region G1Inv_codctn_intc: Código Contenedor
        ...
        /// <para>DESCRIPCION:
        ///Código tipo de contenedor o presentación ANDRES
        /// </para>
        /// </summary>
        ...
        #endregion
        #region G1Inv_estreg_intc: Estado del registro
        public const String gcrNomProp_G1Inv_estreg_intc = "G1Inv_estreg_intc";
        private string _g1inv_estreg_intc = String.Empty;
        /// <summary>
        /// <para>TABLA: invcontenedores</para>
        /// <para>TABLA NATIVA: invcontenedores</para>
        /// <para>CAMPO: Estado del registro</para>
        /// <para>NOMBRE: g1inv_estreg_intc (char:1)</para>
        /// <para>ORDEN VISTA EN TABLA: 3</para>
        /// <para>DESCRIPCION:
        ///Estado del registro 1=Activo 2=Inactivo
        /// </para>
        /// </summary>
        public string G1Inv_estreg_intc
        {
            get { return _g1inv_estreg_intc; }
            set
            {
                if (_g1inv_estreg_intc == value) return;
                _g1inv_estreg_intc = value;
                RaisePropertyChanged(gcrNomProp_G1Inv_estreg_intc);
            }
        }
        #endregion
        #endregion
        //------------------------------------------------
        //INVCONTENEDORES COMBOBOX: Tabla tipos de contenedores (presentacion articulos)
        //------------------------------------------------
        #region Campos ComboBox: INVCONTENEDORES
        #region  G1CbInv_estreg_intc: Estado del registro
        public const String gcrNomProp_G1CbInv_estreg_intc = "G1CbInv_estreg_intc";
        private List<CrtForms.ListaComboBox> _g1cbinv_estreg_intc;
        /// <summary>
        /// <para>TABLA: invcontenedores</para>
        /// <para>TABLA NATIVA: invcontenedores</para>
        /// <para>CAMPO: Estado del registro</para>
        /// <para>NOMBRE: g1cbinv_estreg_intc (char:1)</para>
        /// <para>ORDEN VISTA EN TABLA: 3</para>
        /// <para>DESCRIPCION:
        ///Estado del registro 1=Activo 2=Inactivo
        /// </para>
        /// </summary>
        public List<CrtForms.ListaComboBox> G1CbInv_estreg_intc
        {
            get { return _g1cbinv_estreg_intc; }
            set
            {
                if (_g1cbinv_estreg_intc == value) return;
                _g1cbinv_estreg_intc = value;
                RaisePropertyChanged(gcrNomProp_G1CbInv_estreg_intc);
            }
        }
        #endregion
        #endregion
        //------------------------------------------------
        //INVCONTENEDORES: Registro Activo y Lista Browser
        //------------------------------------------------
        ...
        private ModeloInvcontenedores _tmpg1regactivo;
        /// <summary>
        ///  Registro activo de la tabla: invcontenedores
        /// </summary>
        public ModeloInvcontenedores TmpG1RegActivo
        {
        ...
        public VistaModeloInvcontenedoresBase()
        {
            fcvIniciarComboBox();
            fcvReiniVariables();
        ...
        public virtual void Guardar()
        {
            try
            {
                ...
                {
                    TmpG1RegActivo.Inv_codctn_intc = ModeloInvcontenedores.flgAddRegistro(TmpG1RegActivo);
                    G1Inv_codctn_intc = TmpG1RegActivo.Inv_codctn_intc;
                }
                else
                {
                    fcvCargarRegActivoDesdeVariables();
                    ModeloInvcontenedores.fcvActualizar(TmpG1RegActivo);
                }
                if (string.IsNullOrEmpty(G1Inv_codctn_intc))
                {
                    Restaurar();
                }
        ...
        public virtual void Cancelar()
        {
            ...
            Restaurar();
            G1Inv_codctn_intc = GcrFiltroDatos;
        }
        #endregion
        ...
        public virtual void Eliminar()
        {
            try
            {
                ...
                {
                    ModeloInvcontenedores.fcvEliminar(TmpG1RegActivo.Inv_codctn_intc);
                    Restaurar();
                }
            }
            catch (NotImplementedException ex)
        ...
        public virtual void Filtro()
        {
            try
            {
                ...
                List<ModeloInvcontenedores> TmpG1ListaBrow = ModeloInvcontenedores.flsListaInvcontenedores(GcrFiltroDatos);
                if (TmpG1ListaBrow.Count > 0)
                {
                    TmpG1RegActivo = (ModeloInvcontenedores)TmpG1ListaBrow[0];
        ...
        public virtual void fcvReiniVariables()
        {
            try
            {
                ...
                G1Inv_estreg_intc = String.Empty;
                #endregion
                TmpG1RegActivo = new ModeloInvcontenedores();
                gcrFiltroAplicado = string.Empty;
                tmpLogErrores = new List<LogsErrores>();
            }
            catch (NotImplementedException ex)
        ...
        public virtual void fcvCargarRegActivoDesdeVariables()
        {
            try
            {
                ...
                TmpG1RegActivo.Inv_estreg_intc = G1Inv_estreg_intc;
                #endregion
            }
            catch (NotImplementedException ex)
            {
        ...
        public virtual void fcvCargarVariablesDesdeRegActivo()
        {
            try
            {
                ...
                G1Inv_estreg_intc = TmpG1RegActivo.Inv_estreg_intc;
                #endregion
            }
            catch (NotImplementedException ex)
            {
        ...
        public virtual bool CanEDT()
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(TmpG1RegActivo.Inv_codctn_intc) && GlgSIS_ModoEdicion == false)
                {
                    // verificar si el perfil tiene permiso
        ...
        public virtual bool CanSAV()
        {
            ...
            try
            {
                ...
                {
                    #region Valores Variables
                    llgReturn = String.IsNullOrEmpty(fcrValidacion("G1Inv_codctn_intc")) &&
                                String.IsNullOrEmpty(fcrValidacion("G1Inv_desctn_intc")) &&
                                String.IsNullOrEmpty(fcrValidacion("G1Inv_estreg_intc"));
                    #endregion
        ...
        public virtual bool CanFIL()
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(G1Inv_codctn_intc))
                {
                    GcrFiltroDatos = G1Inv_codctn_intc;
        ...
        public virtual void fcvIniciarComboBox()
        {
            ...
            {
                //-------------------------------------------------
                //INV_ESTREG_INTC: Estado del registro
                //-------------------------------------------------
                #region INV_ESTREG_INTC: Estado del registro
                String lcrG11Seleccion = "1,2";
                String lcrG11Descripcion = "Activo,Inactivo";
                G1CbInv_estreg_intc = new List<CrtForms.ListaComboBox>();
                G1CbInv_estreg_intc = CrtForms.flsCargarLista(lcrG11Seleccion, lcrG11Descripcion);
                #endregion
            }
            catch (NotImplementedException ex)
            {
