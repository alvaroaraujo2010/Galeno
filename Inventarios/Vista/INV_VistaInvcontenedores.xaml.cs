...
{
    /// <summary>
    /// Descripcion para la Vista de  la tabla: invcontenedores
    /// </summary>
    public partial class VistaInvcontenedores : Window, SIS_Interface
    {
        //-------------------------------------------------
        // Inicio Formulario
        //-------------------------------------------------
        ...
        VistaModeloInvcontenedores vm = null;
        DialogVistaErrores lobDlgLogs = null;
        /// <summary>
        /// Inicializar nueva instancia de la clase
        /// </summary>
        public VistaInvcontenedores()
        {
            InitializeComponent();

            vm = this.DataContext as VistaModeloInvcontenedores;
            vm.Restaurar();
        ...
        private void fcvNuevoRegistro(object sender, RoutedEventArgs e)
        {
            ...
            FocusManager.SetFocusedElement(this, txtG1Inv_codctn_intc);
        }
        ...
        {
            vm.Restaurar();
            LocalizadorVistaModelo.fcvLiberarVistaModeloInvcontenedores();
        ...
        #region KeyDown para campos con F2 Tabla: INVCONTENEDORES
        #endregion
        #endregion
        //-------------------------------------------------
        ...
        private void SeleccionComboBoxOpcion(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "cboG1Inv_estreg_intc":
                            txtG1Inv_estreg_intc.Text = CrtForms.fcrSeletDesdeComb(lobList.IdIndice,
                                                                                    txtG1Inv_estreg_intc.Text, ",",
                                                                                    lobList.ListaValoresSel);
                            lobCombo.SelectedIndex = CrtForms.fnuMostrarItemCombo(txtG1Inv_estreg_intc.Text, ",", lobList.ListaValoresSel);
                            break;
                    }
                }
            }
        ...
        private void ActualizarComboBoxOpcion(object sender, TextChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "txtG1Inv_estreg_intc":
                            CrtForms.ListaComboBox lobG1ComboBox1 = (CrtForms.ListaComboBox)cboG1Inv_estreg_intc.SelectedItem;
                            cboG1Inv_estreg_intc.SelectedIndex = CrtForms.fnuMostrarItemCombo(lcrValor, ",", lobG1ComboBox1.ListaValoresSel);
                            break;
                    }
                }
            }
