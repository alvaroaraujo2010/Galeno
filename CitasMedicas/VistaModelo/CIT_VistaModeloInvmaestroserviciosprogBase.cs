//- MARMOTA-GENCODE: VERSION 2.0 - 31/05/2013 05:27:01 AM
using System;
...
namespace CitasMedicas.VistaModelo
{
    ...
    /// </para>
    /// </summary>
    public class VistaModeloInvmaestroserviciosprogBase : ViewModelBase, IDataErrorInfo
    {
        //------------------------------------------------
        ...
        /// <para>NOMBRE: g1fcm_descpr_cpro (char:40)</para>
        /// <para>ORDEN VISTA EN TABLA: 2</para>
        /// <para>DESCRIPCION:
        ...
        #endregion
        #region G2Fcm_tipact_sips: Tipo Asistencial o PyP
        public const string gcrNomProp_G2Fcm_tipact_sips = "G2Fcm_tipact_sips";
        private string _g2fcm_tipact_sips = string.Empty;
        /// <summary>
        /// <para>TABLA: citservprotocol</para>
        /// <para>TABLA NATIVA: fcmmanservicips</para>
        /// <para>CAMPO: Tipo Asistencial o PyP</para>
        /// <para>NOMBRE: g2fcm_tipact_sips (char:1)</para>
        /// <para>ORDEN VISTA EN TABLA: 4</para>
        /// <para>DESCRIPCION:
        ...
        /// </para>
        /// </summary>
        public string G2Fcm_tipact_sips
        {
            get { return _g2fcm_tipact_sips; }
            set
            {
                if (_g2fcm_tipact_sips == value) return;
                _g2fcm_tipact_sips = value;
                RaisePropertyChanged(gcrNomProp_G2Fcm_tipact_sips);
            }
        }
        #endregion
        ...
        #region  G2CbFcm_tipact_sips: Tipo Asistencial o PyP
        public const string gcrNomProp_G2CbFcm_tipact_sips = "G2CbFcm_tipact_sips";
        private List<CrtForms.ListaComboBox> _g2cbfcm_tipact_sips;
        /// <summary>
        /// <para>TABLA: citservprotocol</para>
        /// <para>TABLA NATIVA: fcmmanservicips</para>
        /// <para>CAMPO: Tipo Asistencial o PyP</para>
        /// <para>NOMBRE: g2cbfcm_tipact_sips (char:1)</para>
        /// <para>ORDEN VISTA EN TABLA: 4</para>
        /// <para>DESCRIPCION:
        /// Tipo servicio o actividad según manual de servicio IPS: 1=Asistencial
        /// 2=Promoción y Prevención
        /// </para>
        /// </summary>
        public List<CrtForms.ListaComboBox> G2CbFcm_tipact_sips
        {
            get { return _g2cbfcm_tipact_sips; }
            set
            {
                if (_g2cbfcm_tipact_sips == value) return;
                _g2cbfcm_tipact_sips = value;
                RaisePropertyChanged(gcrNomProp_G2CbFcm_tipact_sips);
            }
        }
        #endregion
        ...
        private ModeloInvmaestroserviciosprog _tmpg1regactivo;
        /// <summary>
        ///  Registro activo de la tabla: citservicioprog
        /// </summary>
        public ModeloInvmaestroserviciosprog TmpG1RegActivo
        {
        ...
        private ModeloInvmaestroprotocolo _tmpg2regactivo;
        /// <summary>
        ///  Registro activo de la tabla: citservprotocol
        /// </summary>
        public ModeloInvmaestroprotocolo TmpG2RegActivo
        {
        ...
        private ObservableCollection<ModeloInvmaestroprotocolo> _tmpg2listabrow;
        /// <summary>
        ///  Lista de registros tabla: citservprotocol
        /// </summary>
        public ObservableCollection<ModeloInvmaestroprotocolo> TmpG2ListaBrow
        {
        ...
        private ObservableCollection<ModeloInvmaestroprotocolo> _tmpg2listaedt;
        /// <summary>
        ///  Lista de registros tabla: citservprotocol
        /// </summary>
        public ObservableCollection<ModeloInvmaestroprotocolo> TmpG2ListaEdt
        {
        ...
        public RelayCommand<ModeloInvmaestroprotocolo> SelectionChangedCommand { get; set; }
        ...
        public virtual void fcvRegistrarComandos()
        {
            ...
            SelectionChangedCommand = new RelayCommand<ModeloInvmaestroprotocolo>(lobjRegistro =>
            {
        ...
        public VistaModeloInvmaestroserviciosprogBase()
        {
            fcvIniciarComboBox();
            TmpG2ListaBrow = new ObservableCollection<ModeloInvmaestroprotocolo>(ModeloInvmaestroprotocolo.flsListaCitservprotocol(""));
        ...
        public virtual void AdicionarRel()
        {
            ...
            {
                fcvReiniVariables("2");
                TmpG2RegActivo = new ModeloInvmaestroprotocolo();
        ...
        public virtual void Guardar()
        {
            try
            {
                ...
                {
                    TmpG1RegActivo.Cit_codspr_spro = ModeloInvmaestroserviciosprog.flgAddRegistro(TmpG1RegActivo);
                    G1Cit_codspr_spro = TmpG1RegActivo.Cit_codspr_spro;
                }
                else
                {
                    ModeloInvmaestroserviciosprog.fcvActualizar(TmpG1RegActivo);
                }
                ...
                if (!string.IsNullOrEmpty(G1Cit_codspr_spro))
                {
                    ...
                    {
                        foreach (ModeloInvmaestroprotocolo lobReg in TmpG2ListaEdt)
                        {
                            lobReg.Cit_codspr_spro = G1Cit_codspr_spro; // llave R1
                            // Actualizar en Base de Datos
                            ModeloInvmaestroprotocolo.flgAddRegistro(lobReg, G1Cit_codspr_spro);
                        }
                    }
        ...
        public virtual void Eliminar()
        {
            try
            {
                ...
                {
                    ModeloInvmaestroserviciosprog.fcvEliminar(TmpG1RegActivo.Cit_codspr_spro);
                    if (TmpG2ListaBrow.Count > 0)
                    {
                        foreach (ModeloInvmaestroprotocolo lobReg in TmpG2ListaBrow)
                        {
        ...
        public virtual void Filtro()
        {
            try
            {
                ...
                List<ModeloInvmaestroserviciosprog> lobTmpReg = ModeloInvmaestroserviciosprog.flsListaCitservicioprog(GcrFiltroDatos);
                if (lobTmpReg.Count > 0)
                {
                    TmpG1RegActivo = (ModeloInvmaestroserviciosprog)lobTmpReg[0];
                    fcvCargarVariablesDesdeRegActivo("1");

                    TmpG2ListaBrow = new ObservableCollection<ModeloInvmaestroprotocolo>(ModeloInvmaestroprotocolo.flsListaCitservprotocol(GcrFiltroDatos));
                    if (TmpG2ListaBrow.Count > 0)
                    {
                        /* foreach (ModeloInvmaestroprotocolo lobReg in TmpG2ListaBrow)
                        {
                        ...
                        TmpG2RegActivo = (ModeloInvmaestroprotocolo)TmpG2ListaBrow[0];
                        fcvCargarVariablesDesdeRegActivo("2");
                    }
                }
            }
        ...
        /// </summary>
        public virtual void fcvGestionEdtRelacion(ModeloInvmaestroprotocolo tobRegistro)
        {
            try
            {
        ...
        public virtual void fcvReiniVariables(string tcrZona)
        {
            try
            {
                ...
                if (tcrZona == "2" || tcrZona == "A")
                {
                    ...
                    G2Fcm_tipact_sips = string.Empty;
                    G2Fcm_totuni_dfac = 0;
                ...
                {
                    //-- temp para tabla 1
                    TmpG1RegActivo = new ModeloInvmaestroserviciosprog();
                    //--- Temp para tabla 2
                    TmpG2RegActivo = new ModeloInvmaestroprotocolo();
                    TmpG2ListaBrow = new ObservableCollection<ModeloInvmaestroprotocolo>();
                    TmpG2ListaEdt = new ObservableCollection<ModeloInvmaestroprotocolo>();
                }
            }
            catch (NotImplementedException ex)
            {
            ...
            try
            {
                ...
                if (tcrZona == "2" || tcrZona == "A")
                {
                    if (TmpG2RegActivo != null)
                    {
                        ...
                        TmpG2RegActivo.Fcm_tipact_sips = G2Fcm_tipact_sips;
            ...
            try
            {
                ...
                if (tcrZona == "2" || tcrZona == "A")
                {
                    if (TmpG2RegActivo != null)
                    {
                        ...
                        G2Fcm_tipact_sips = TmpG2RegActivo.Fcm_tipact_sips;
            ...
            try
            {
                if (GlgSIS_ModoEdicion == true)
                {
                    ...
                    llgReturn = string.IsNullOrEmpty(fcrValidacion("G1Fcm_idesec_sips")) &&
                                string.IsNullOrEmpty(fcrValidacionRel("G2Fcm_tipact_sips")) &&
        ...
        public virtual void fcvIniciarComboBox()
        {
            try
            {
                ...
                #endregion
                //-------------------------------------------------
                //FCM_TIPACT_SIPS: Tipo Asistencial o PyP
                //-------------------------------------------------
                #region FCM_TIPACT_SIPS: Tipo Asistencial o PyP
                string lcrG21Seleccion = "1,2";
                string lcrG21Descripcion = "Asistencial,Promoción y Prevención";
                G2CbFcm_tipact_sips = new List<CrtForms.ListaComboBox>();
                G2CbFcm_tipact_sips = CrtForms.flsCargarLista(lcrG21Seleccion, lcrG21Descripcion);
                #endregion
                //-------------------------------------------------
                ...
                G2CbCit_incrme_sprt = CrtForms.flsCargarLista(lcrG22Seleccion, lcrG22Descripcion);
                #endregion
                //-------------------------------------------------
                ...
                G2CbCit_incfac_sprt = CrtForms.flsCargarLista(lcrG23Seleccion, lcrG23Descripcion);
                #endregion
                //-------------------------------------------------
                ...
                string lcrG24Descripcion = "SI,NO";
                G2CbCit_incfrm_sprt = new List<CrtForms.ListaComboBox>();
                G2CbCit_incfrm_sprt = CrtForms.flsCargarLista(lcrG24Seleccion, lcrG24Descripcion);
                #endregion
            }
            catch (NotImplementedException ex)
            {
