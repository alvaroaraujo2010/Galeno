...
namespace Sistema.Dian
{
    ...
    public class DocumentoNotaCredito
    {
        ...
        public TipoDocumentoElectrónico Tipo { get; set; } = TipoDocumentoElectrónico.NotaCrédito;
        ...
        public bool FlgCrearDocumento(ModeloFeFacturaMa toboRegFactura, out string mensaje)
        {
            ...
            { // 1..1 CAB14.
                IdentificationCode = new IdentificationCodeType
                {
                    ...
                    listSchemeURI = UriEsquemaIdentificaciónPaís // 1..1 CAB17.
                }
            };
            ...
            { // 1..1 CAB30.
                AuthorizationProviderID = new coID2Type
                {
                    ...
                    schemeID = DígitoVerificaciónNitDian, // 1..1 CAB34
                    schemeName = TipoDocIdentificacion.Nit.AValor(), // 1..1 CAB35.
                }
            };

            dianExtensions.QRCode = FcrGenerarCodigoQR(toboRegFactura, CudeEfectivo); // 1..1 CAB36.
            ...
            invoice.UUID = new UUIDType
            {
                ...
                schemeID = Empresa.AmbienteFacturaciónElectrónica.AValor(), // 1..1 CAD07.
            ...
            */
            ...
            { // 1..N CAV01.
                ...
                invoiceLine.CreditedQuantity = new CreditedQuantityType
                {
                    ...
                    unitCode = Validar(lobReg.Sis_codume_sium, "2..5"), // 1..1 CAV05.  
                };
                invoiceLine.LineExtensionAmount = new LineExtensionAmountType
                {
                    Value = Validar((decimal)lobReg.Fcm_valfac_dfac, "0..15 p (2..6)", 2), // 1..1 CAV06.
