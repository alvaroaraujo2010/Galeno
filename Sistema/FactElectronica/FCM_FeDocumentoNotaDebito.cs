...
namespace Sistema.Dian
{
    ...
    public class DocumentoNotaDebito
    {
        ...
        public TipoDocumentoElectrónico Tipo { get; set; } = TipoDocumentoElectrónico.NotaDébito;
        ...
        public bool FlgCrearDocumento(ModeloFeFacturaMa toboRegFactura, out string mensaje)
        {
            ...
            AddressType obtenerAddress(string tcrDireccion, Municipio tobRegMunicipio)
            {
                ...
                { // 1..1 FAJ08.
                    ID = new IDType { Value = Validar(tobRegMunicipio.CodigoMunicipio, "5") }, // 1..1 DAJ09.
            ...
            invoice.UUID = new UUIDType
            {
                ...
                schemeID = Empresa.AmbienteFacturaciónElectrónica.AValor(), // 1..1 DAD07.
            ...
            */
            ...
            { // 1..N CAV01.
                ...
                invoiceLine.DebitedQuantity = new DebitedQuantityType
                {
                    ...
                    unitCode = Validar(lobReg.Sis_codume_sium, "2..5"), // 1..1 DAV05.  
                };
                invoiceLine.LineExtensionAmount = new LineExtensionAmountType
                {
                    Value = Validar((decimal)lobReg.Fcm_valfac_dfac, "0..15 p (2..6)", 2), // 1..1 DAV06.
