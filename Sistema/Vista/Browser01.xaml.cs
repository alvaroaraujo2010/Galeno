...
namespace Sistema.Vista
{
    ...
    /// </summary>
    public partial class Browser01 : Window
    {
        ...
        /// </summary>
        public Browser01(string tcrCodigoModulo, string tcrTabla, string tcrFiltroTabla, string tcrTituloVentana)
        {
            InitializeComponent();
