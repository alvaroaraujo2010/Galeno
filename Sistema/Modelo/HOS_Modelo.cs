...
{
    /// <summary>
    /// Tabla hosestanciapaci: Lista de traslados de pacientes a nueva cama
    /// </summary>
    public class HosModeloTrasladoCama : clBaseInpc
    {
        ...
        /// </summary>
        public static List<HosModeloTrasladoCama> flsListaHosestanciapaci(string tcrBuscar)
        {
            using (_context = new DbAplicacion())
            {
                var lobConsulta = from hosestanciapaci in _context.Hosestanciapaci
                                  ...
                                  select new HosModeloTrasladoCama
                                  {
