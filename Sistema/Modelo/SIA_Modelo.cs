...
namespace Sistema.Modelo
{
    ...
    /// </summary>
    public class SIAModeloUsuariosAtendidos : clBaseInpc
    {
        ...
        /// <para>DESCRIPCION:
        ///Primer apellido del usuario o paciente - EJEMPLO 123
        /// </para>
        /// </summary>
        ...
        #endregion
        #region Sia_valibc_usua: Ingreso base cotizacion
        private int _sia_valibc_usua;
        /// <summary>
        /// <para>TABLA: siausuarioatend</para>
        /// <para>TABLA NATIVA: siausuarioatend</para>
        /// <para>CAMPO: Ingreso base cotizacion</para>
        ...
        private String _sia_nivedu_sine;
        /// <summary>
        /// <para>TABLA: siausuarioatend</para>
        /// <para>TABLA NATIVA: sianiveleducati</para>
        /// <para>CAMPO: Nivel educativo</para>
        /// <para>NOMBRE: sia_nivedu_sine (char:2)</para>
        ...
        /// </para>
        /// </summary>
        public String Sia_nivedu_sine
        {
            get { return _sia_nivedu_sine; }
            set
            {
                if (_sia_nivedu_sine == value) return;
                _sia_nivedu_sine = value;
                OnPropertyChanged("Sia_nivedu_sine");
            }
        }
        #endregion
        ...
        private String _sia_desper_pret;
        /// <summary>
        /// <para>TABLA: siausuarioatend</para>
        /// <para>TABLA NATIVA: siapertenetnica</para>
        ...
        /// </para>
        /// </summary>
        public String Sia_desper_pret
        {
            get { return _sia_desper_pret; }
            set
            {
                if (_sia_desper_pret == value) return;
                _sia_desper_pret = value;
                OnPropertyChanged("Sia_desper_pret");
            }
        }
        #endregion
        #region Sia_desedu_sine: Descripcion Nivel educativo
        private String _sia_desedu_sine;
        /// <summary>
        /// <para>TABLA: siausuarioatend</para>
        /// <para>TABLA NATIVA: sianiveleducati</para>
        ...
        /// </summary>
        public String Sia_desedu_sine
        {
            get { return _sia_desedu_sine; }
            set
            {
                if (_sia_desedu_sine == value) return;
                _sia_desedu_sine = value;
                OnPropertyChanged("Sia_desedu_sine");
            }
        }
        #endregion
        ...
        public static string flgAddRegistro(SIAModeloUsuariosAtendidos tobjModelo)
        {
            ...
            if (!flgBuscarSiausuarioatend(lcrCodigoGen))
            {
                using (_context = new DbAplicacion())
                {
                    var lobjRegistro = new EFsiausuarioatend
                    {
                        ...
                        sia_nivedu_sine = tobjModelo.Sia_nivedu_sine,
        ...
        public static void fcvActualizar(SIAModeloUsuariosAtendidos tobjModelo)
        {
            using (_context = new DbAplicacion())
            {
                ...
                if (lobjRegistro != null)
                {
                    ...
                    lobjRegistro.sia_nivedu_sine = tobjModelo.Sia_nivedu_sine;
        ...
        #endregion
        #region fcvActualizarDatos: Actualizar datos adicionales del usuario atendido
        /// <summary>
        /// Actualziar datos adicionlaes de historia clinica, direccion y otros
        /// </summary>
        public static void fcvActualizarDatos(EFsiausuarioatend tobjModelo)
        {
            using (_context = new DbAplicacion())
            {
                var lobjRegistro = _context.Siausuarioatend.FirstOrDefault(p => p.sia_idesec_usua == tobjModelo.sia_idesec_usua);
                if (lobjRegistro != null)
                {
                    lobjRegistro.hcl_nrohis_hicl = !String.IsNullOrWhiteSpace(tobjModelo.hcl_nrohis_hicl) ? tobjModelo.hcl_nrohis_hicl : lobjRegistro.hcl_nrohis_hicl;
                    lobjRegistro.sia_telres_usua = !String.IsNullOrWhiteSpace(tobjModelo.sia_telres_usua) ? tobjModelo.sia_telres_usua : lobjRegistro.sia_telres_usua;
                    lobjRegistro.sia_dirres_usua = !String.IsNullOrWhiteSpace(tobjModelo.sia_dirres_usua) ? tobjModelo.sia_dirres_usua : lobjRegistro.sia_dirres_usua;
                    lobjRegistro.sia_correo_usua = !String.IsNullOrWhiteSpace(tobjModelo.sia_correo_usua) ? tobjModelo.sia_correo_usua : lobjRegistro.sia_correo_usua;
                    _context.SaveChanges();
                }
            }
        }
        ...
        #endregion
        #region Listar Registros simple
        public static SIAModeloUsuariosAtendidos fobRegSiausuarioatend(string tcrIdUnicoUsuario)
        {
            SIAModeloUsuariosAtendidos lobRegistro = null;
            using (_context = new DbAplicacion())
            {
                var lobConsulta = (from siausuarioatend in _context.Siausuarioatend
                                   where siausuarioatend.sia_idesec_usua == tcrIdUnicoUsuario
                                   select new SIAModeloUsuariosAtendidos
                                   {
                                       #region Datos
                                       ...
                                       Sia_valibc_usua = (int)siausuarioatend.sia_valibc_usua,
                                       Sia_tippob_tpob = siausuarioatend.sia_tippob_tpob,
                                       Sia_codper_pret = siausuarioatend.sia_codper_pret,
                                       Sia_nivedu_sine = siausuarioatend.sia_nivedu_sine,
                ...
                if (lobConsulta.Count != 0 && lobConsulta != null)
                {
                    lobRegistro = lobConsulta.FirstOrDefault();
                }
            }
            return lobRegistro;
        }
        #endregion
        #region Listar Registros con relaciones
        public static List<SIAModeloUsuariosAtendidos> flsListaSiausuarioatend(string tcrBuscar)
        {
            using (_context = new DbAplicacion())
            {
                if (string.IsNullOrEmpty(tcrBuscar))
                {
                    ...
                    var lobConsulta = from siausuarioatend in _context.Siausuarioatend
                                      ...
                                      select new SIAModeloUsuariosAtendidos
                                      {
                                          ...
                                          Sia_desper_pret = _context.Siapertenetnica.FirstOrDefault(rxp => rxp.sia_codper_pret == siausuarioatend.sia_codper_pret).sia_desper_pret,
                                          Sia_desedu_sine = _context.Sianiveleducati.FirstOrDefault(rxp => rxp.sia_nivedu_sine == siausuarioatend.sia_nivedu_sine).sia_desedu_sine,
    ...
    /// </summary>
    public class ModeloSiamaeprofsalud : clBaseInpc
    {
        #region Modelo Attributos
        private static DbAplicacion _context;
        ...
        private String _sia_tipide_tide;
        private String _nom_nroide_nomi;
        private String _sia_nompro_prof;
        private String _sia_codprm_prom;
        private String _sia_codpat_tpat;
        private int _sia_conesp_prof;
        private String _sys_codusu_usux;
        private String _sis_estreg_esrg;
        private String _sia_deside_tide;
        private String _sia_desprm_prom;
        private String _sia_despat_tpat;
        private String _sys_nomusu_usux;
        private String _sis_desest_esrg;
        #endregion
        #region Modelo Propiedades Notificacion
        #region Sia_codpfa_prof: Codigo del profesional
        /// <summary>
        /// <para>TABLA: siamaeprofsalud</para>
        /// <para>TABLA NATIVA: siamaeprofsalud</para>
        /// <para>CAMPO: Codigo del profesional</para>
        /// <para>NOMBRE: sia_codpfa_prof (char:4)</para>
        /// <para>ORDEN VISTA EN TABLA: 1</para>
        /// <para>DESCRIPCION:
        /// Codigo unico del Profesional que presta servicio medico (generado
        /// por el sistema)
        /// </para>
        /// </summary>
        ...
        #endregion
        #region Nom_nroide_nomi: Identificacion
        /// <summary>
        /// <para>TABLA: siamaeprofsalud</para>
        /// <para>TABLA NATIVA: </para>
        /// <para>CAMPO: Identificacion</para>
        /// <para>NOMBRE: nom_nroide_nomi (char:20)</para>
        /// <para>ORDEN VISTA EN TABLA: 3</para>
        /// <para>DESCRIPCION:
        ///Numero de identificacion en nomina
        /// </para>
        /// </summary>
        public String Nom_nroide_nomi
        {
            get { return _nom_nroide_nomi; }
            set
            {
                if (_nom_nroide_nomi == value) return;
                _nom_nroide_nomi = value;
                OnPropertyChanged("Nom_nroide_nomi");
            }
        }
        #endregion
        #region Sia_rmedic_prof: Registro medico
        private String _sia_rmedic_prof;
        /// <summary>
        /// <para>TABLA: siamaeprofsalud</para>
        /// <para>TABLA NATIVA: siamaeprofsalud</para>
        /// <para>CAMPO: Registro medico</para>
        /// <para>NOMBRE: sia_rmedic_prof (char:30)</para>
        /// <para>ORDEN VISTA EN TABLA: 4</para>
        /// <para>DESCRIPCION:
        /// Numero del registro profesional de salud ante el ministerio
        /// </para>
        /// </summary>
        public String Sia_rmedic_prof
        {
            get { return _sia_rmedic_prof; }
            set
            {
                if (_sia_rmedic_prof == value) return;
                _sia_rmedic_prof = value;
                OnPropertyChanged("Sia_rmedic_prof");
            }
        }
        #endregion
        ...
        #endregion
        #region Sia_codprm_prom: Profesion salud
        /// <summary>
        /// <para>TABLA: siamaeprofsalud</para>
        /// <para>TABLA NATIVA: siaprofesisalud</para>
        /// <para>CAMPO: Profesion salud</para>
        /// <para>NOMBRE: sia_codprm_prom (char:2)</para>
        /// <para>ORDEN VISTA EN TABLA: 5</para>
        /// <para>DESCRIPCION:
        /// Codigo Tipo profesion medica o de salud ejm 01= Medico general
        /// 02=Medico Especialista 3= Enfermera jefe 4=Nutricionista 5=Odontologo
        /// 6=Auxiliar de enfermeria
        /// </para>
        /// </summary>
        public String Sia_codprm_prom
        {
            get { return _sia_codprm_prom; }
            set
            {
                if (_sia_codprm_prom == value) return;
                _sia_codprm_prom = value;
                OnPropertyChanged("Sia_codprm_prom");
            }
        }
        #endregion
        ...
        #endregion
        #region Sis_idterc_sitr: Codigo tercero (contable)
        private String _sis_idterc_sitr;
        /// <summary>
        /// <para>TABLA: siamaeprofsalud</para>
        /// <para>TABLA NATIVA: sismaesterceros</para>
        /// <para>CAMPO: Codigo tercero (contable)</para>
        ...
        #endregion
        #region Sia_conesp_prof: Contador especialidades
        /// <summary>
        /// <para>TABLA: siamaeprofsalud</para>
        /// <para>TABLA NATIVA: siamaeprofsalud</para>
        /// <para>CAMPO: Contador especialidades</para>
        /// <para>NOMBRE: sia_conesp_prof (int:4)</para>
        /// <para>ORDEN VISTA EN TABLA: 8</para>
        /// <para>DESCRIPCION:
        /// Contador para generar los codigos de  especialidades medicas
        /// asignadas al profesional
        /// </para>
        /// </summary>
        public int Sia_conesp_prof
        {
            get { return _sia_conesp_prof; }
            set
            {
                if (_sia_conesp_prof == value) return;
                _sia_conesp_prof = value;
                OnPropertyChanged("Sia_conesp_prof");
            }
        }
        #endregion
        #region Sia_ifirma_prof: Imagen firma
        private String _sia_ifirma_prof;
        /// <summary>
        /// <para>TABLA: siamaeprofsalud</para>
        /// <para>TABLA NATIVA: siamaeprofsalud</para>
        /// <para>CAMPO: Imagen firma</para>
        /// <para>NOMBRE: sia_ifirma_prof (char:50)</para>
        /// <para>ORDEN VISTA EN TABLA: 10</para>
        /// <para>DESCRIPCION:
        /// Imagen en formato jpg o png para la firma en historias clinicas
        /// </para>
        /// </summary>
        public String Sia_ifirma_prof
        {
            get { return _sia_ifirma_prof; }
            set
            {
                if (_sia_ifirma_prof == value) return;
                _sia_ifirma_prof = value;
                OnPropertyChanged("Sia_ifirma_prof");
            }
        }
        #endregion
        #region Sys_codusu_usux: codigo usuario sistema
        /// <summary>
        /// <para>TABLA: siamaeprofsalud</para>
        /// <para>TABLA NATIVA: sysusuarios</para>
        /// <para>CAMPO: codigo usuario sistema</para>
        /// <para>NOMBRE: sys_codusu_usux (char:5)</para>
        /// <para>ORDEN VISTA EN TABLA: 9</para>
        /// <para>DESCRIPCION:
        /// Código de  usuario en el sistema, correspondiente al codigo
        /// asignado al profesional para acceso al sistema al momento de
        /// realizar la atencion medica y diligenciamiento de datos
        /// </para>
        /// </summary>
        public String Sys_codusu_usux
        {
        ...
        #endregion
        #region Sia_deside_tide: Decripción Tipo Usuario
        /// <summary>
        /// <para>TABLA: siamaeprofsalud</para>
        /// <para>TABLA NATIVA: siatipideusario</para>
        /// <para>CAMPO: Decripción Tipo Usuario</para>
        /// <para>NOMBRE: sia_deside_tide (char:20)</para>
        /// <para>ORDEN VISTA EN TABLA: 2</para>
        /// <para>DESCRIPCION:
        /// Descripcion textual del Tipo de identificacin para el usuario
        /// o paciente
        /// </para>
        /// </summary>
        public String Sia_deside_tide
        ...
        #endregion
        #region Sia_desprm_prom: Nombre profesion
        /// <summary>
        /// <para>TABLA: siamaeprofsalud</para>
        /// <para>TABLA NATIVA: siaprofesisalud</para>
        /// <para>CAMPO: Nombre profesion</para>
        /// <para>NOMBRE: sia_desprm_prom (char:150)</para>
        /// <para>ORDEN VISTA EN TABLA: 2</para>
        /// <para>DESCRIPCION:
        ///Descripcion profesion salud
        /// </para>
        /// </summary>
        public String Sia_desprm_prom
        {
            get { return _sia_desprm_prom; }
            set
            {
                if (_sia_desprm_prom == value) return;
                _sia_desprm_prom = value;
                OnPropertyChanged("Sia_desprm_prom");
            }
        }
        #endregion
        #region Sia_despat_tpat: Nombre tipo profesional
        /// <summary>
        /// <para>TABLA: siamaeprofsalud</para>
        /// <para>TABLA NATIVA: siatipprofatien</para>
        /// <para>CAMPO: Nombre tipo profesional</para>
        /// <para>NOMBRE: sia_despat_tpat (char:40)</para>
        /// <para>ORDEN VISTA EN TABLA: 2</para>
        /// <para>DESCRIPCION:
        ///Descripcion del tipo profesional que atiende
        /// </para>
        /// </summary>
        public String Sia_despat_tpat
        {
            get { return _sia_despat_tpat; }
            set
            {
                if (_sia_despat_tpat == value) return;
                _sia_despat_tpat = value;
                OnPropertyChanged("Sia_despat_tpat");
            }
        }
        #endregion
        ...
        #region Metodos para edicion de registros
        #region Adicionar Registro
        public static string flgAddRegistro(ModeloSiamaeprofsalud tobjModelo)
        {
            var lcrCodigoGen = SysModelo.fcrGenerarNuevoCodigo("SIA-PROF-SERVSALUD", "SIA", "Profesionales prestan servicios salud");
            if (!flgBuscarSiamaeprofsalud(lcrCodigoGen))
            {
                // Generar nombre de imagen  que representa la firma
                if (tobjModelo.Sia_ifirma_prof == "JPG" || tobjModelo.Sia_ifirma_prof == "PNG" || tobjModelo.Sia_ifirma_prof == "BMP")
                {
                    tobjModelo.Sia_conesp_prof++;

                    tobjModelo.Sia_ifirma_prof = tobjModelo.Sia_codpfa_prof + "_FIRMA_" + 
                                                 tobjModelo.Sia_conesp_prof.ToString().Trim() + "." + tobjModelo.Sia_ifirma_prof;
                }

                using (_context = new DbAplicacion())
                {
                    var lobjRegistro = new EFsiamaeprofsalud
                    {
                        #region cargar Registro
                        sia_codpfa_prof = tobjModelo.Sia_codpfa_prof,
                        sia_tipide_tide = tobjModelo.Sia_tipide_tide,
                        nom_nroide_nomi = tobjModelo.Nom_nroide_nomi,
                        sia_rmedic_prof = tobjModelo.Sia_rmedic_prof,
                        sia_nompro_prof = tobjModelo.Sia_nompro_prof,
                        sia_codprm_prom = tobjModelo.Sia_codprm_prom,
                        sia_codpat_tpat = tobjModelo.Sia_codpat_tpat,
                        sis_idterc_sitr = tobjModelo.Sis_idterc_sitr,
                        sia_conesp_prof = tobjModelo.Sia_conesp_prof,
                        sia_ifirma_prof = tobjModelo.Sia_ifirma_prof,
                        sys_codusu_usux = tobjModelo.Sys_codusu_usux,
                        sis_estreg_esrg = tobjModelo.Sis_estreg_esrg,
                        #endregion
                    };
                    lobjRegistro.sia_codpfa_prof = lcrCodigoGen;
                    _context.AddToSiamaeprofsalud(lobjRegistro);
                    _context.SaveChanges();
                }
            }
            else
            {
                lcrCodigoGen = string.Empty;
                MessageBox.Show("Nuevo codigo Generado esta desactualizado, revisar llave: \n" +
                                "'SIA-PROF-SERVSALUD': Profesionales prestan servicios salud en Maestro Secuenciales.");
            }
            return lcrCodigoGen;
        }
        #endregion
        #region Modificar Registro
        public static void fcvActualizar(ModeloSiamaeprofsalud tobjModelo)
        {
            using (_context = new DbAplicacion())
            {
                // Generar nombre de imagen  que representa la firma
                ...
                var lobjRegistro = _context.Siamaeprofsalud.FirstOrDefault(p => p.sia_codpfa_prof == tobjModelo.Sia_codpfa_prof);
                if (lobjRegistro != null)
                {
                    lobjRegistro.sia_codpfa_prof = tobjModelo.Sia_codpfa_prof;
                    lobjRegistro.sia_tipide_tide = tobjModelo.Sia_tipide_tide;
                    lobjRegistro.nom_nroide_nomi = tobjModelo.Nom_nroide_nomi;
                    lobjRegistro.sia_rmedic_prof = tobjModelo.Sia_rmedic_prof;
                    lobjRegistro.sia_nompro_prof = tobjModelo.Sia_nompro_prof;
                    lobjRegistro.sia_codprm_prom = tobjModelo.Sia_codprm_prom;
                    lobjRegistro.sia_codpat_tpat = tobjModelo.Sia_codpat_tpat;
                    lobjRegistro.sis_idterc_sitr = tobjModelo.Sis_idterc_sitr;
                    lobjRegistro.sia_conesp_prof = tobjModelo.Sia_conesp_prof;
                    lobjRegistro.sia_ifirma_prof = tobjModelo.Sia_ifirma_prof;
                    lobjRegistro.sys_codusu_usux = tobjModelo.Sys_codusu_usux;
                    lobjRegistro.sis_estreg_esrg = tobjModelo.Sis_estreg_esrg;
                    _context.SaveChanges();
                }
        ...
        public static List<ModeloSiamaeprofsalud> flsListaSiamaeprofsalud(string tcrBuscar)
        {
            using (_context = new DbAplicacion())
            {
                if (string.IsNullOrEmpty(tcrBuscar))
                {
                    return _context.Siamaeprofsalud.Select(p => new ModeloSiamaeprofsalud
                    {
                        Sia_codpfa_prof = p.sia_codpfa_prof,
                        Sia_tipide_tide = p.sia_tipide_tide,
                        Nom_nroide_nomi = p.nom_nroide_nomi,
                        Sia_rmedic_prof = p.sia_rmedic_prof,
                        Sia_nompro_prof = p.sia_nompro_prof,
                        Sia_codprm_prom = p.sia_codprm_prom,
                        Sia_codpat_tpat = p.sia_codpat_tpat,
                        Sis_idterc_sitr = p.sis_idterc_sitr,
                        Sia_conesp_prof = (int)p.sia_conesp_prof,
                        Sia_ifirma_prof = p.sia_ifirma_prof,
                        Sys_codusu_usux = p.sys_codusu_usux,
                        Sis_estreg_esrg = p.sis_estreg_esrg,
                        Sia_deside_tide = _context.Siatipideusario.FirstOrDefault(rxp => rxp.sia_tipide_tide == p.sia_tipide_tide).sia_deside_tide,
                        Sia_desprm_prom = _context.Siaprofesisalud.FirstOrDefault(rxp => rxp.sia_codprm_prom == p.sia_codprm_prom).sia_desprm_prom,
                        Sia_despat_tpat = _context.Siatipprofatien.FirstOrDefault(rxp => rxp.sia_codpat_tpat == p.sia_codpat_tpat).sia_despat_tpat,
                        Sis_razsoc_sitr = _context.Sismaesterceros.FirstOrDefault(rxp => rxp.sis_idterc_sitr == p.sis_idterc_sitr).sis_razsoc_sitr,
                        Sys_nomusu_usux = _context.Sysusuarios.FirstOrDefault(rxp => rxp.sys_codusu_usux == p.sys_codusu_usux).sys_nomusu_usux,
                        Sis_desest_esrg = _context.Sisestadoregist.FirstOrDefault(rxp => rxp.sis_estreg_esrg == p.sis_estreg_esrg).sis_desest_esrg,
                    }).ToList();
                }
                else
                {
                    var lobConsulta = from tmp in _context.Siamaeprofsalud
                                      where tmp.sia_codpfa_prof.Contains(tcrBuscar) || tmp.sia_nompro_prof.Contains(tcrBuscar)
                                      select new ModeloSiamaeprofsalud
                                      {
                                          Sia_codpfa_prof = tmp.sia_codpfa_prof,
                                          Sia_tipide_tide = tmp.sia_tipide_tide,
                                          Nom_nroide_nomi = tmp.nom_nroide_nomi,
                                          Sia_rmedic_prof = tmp.sia_rmedic_prof,
                                          Sia_nompro_prof = tmp.sia_nompro_prof,
                                          Sia_codprm_prom = tmp.sia_codprm_prom,
                                          Sia_codpat_tpat = tmp.sia_codpat_tpat,
                                          Sis_idterc_sitr = tmp.sis_idterc_sitr,
                                          Sia_conesp_prof = (int)tmp.sia_conesp_prof,
                                          Sia_ifirma_prof = tmp.sia_ifirma_prof,
                                          ...
                                          Sia_desprm_prom = _context.Siaprofesisalud.FirstOrDefault(rxp => rxp.sia_codprm_prom == tmp.sia_codprm_prom).sia_desprm_prom,
                                          Sia_despat_tpat = _context.Siatipprofatien.FirstOrDefault(rxp => rxp.sia_codpat_tpat == tmp.sia_codpat_tpat).sia_despat_tpat,
                                          Sis_razsoc_sitr = _context.Sismaesterceros.FirstOrDefault(rxp => rxp.sis_idterc_sitr == tmp.sis_idterc_sitr).sis_razsoc_sitr,
        ...
        #endregion
        #region Registro completo del profesional
        /// <summary>
        /// Devuelve un Registro dado el codigo del profesional o numero de Identificacion
        /// <para>PARAMETRO:</para>
        /// <para>tcrTipoCodigo: "1"=Id unico "2"=Numero de identificacion 3=Usuario activo en el sistema</para>
        /// </summary>
        public static ModeloSiamaeprofsalud flsListaSiamaeprofsaludEx(String tcrTipoCodigo, String tcrCodigo)
        {
            using (_context = new DbAplicacion())
            {
                if (String.IsNullOrEmpty(tcrTipoCodigo) || tcrTipoCodigo=="1")
                {
                    // Id unico del registro
                    var lobConsulta = from tmp in _context.Siamaeprofsalud
                                      where tmp.sia_codpfa_prof.Equals(tcrCodigo)
                                      select new ModeloSiamaeprofsalud
                                      {
                                          Sia_codpfa_prof = tmp.sia_codpfa_prof,
                                          Sia_tipide_tide = tmp.sia_tipide_tide,
                ...
                else if (tcrTipoCodigo == "2")
                {
                    ...
                    var lobConsulta = from tmp in _context.Siamaeprofsalud
                                      where tmp.nom_nroide_nomi.Equals(tcrCodigo)
                                      select new ModeloSiamaeprofsalud
                                      {
                                          Sia_codpfa_prof = tmp.sia_codpfa_prof,
                                          Sia_tipide_tide = tmp.sia_tipide_tide,
                ...
                {
                    // Codigo usuario del sistema
                    var lobConsulta = from tmp in _context.Siamaeprofsalud
                                      where tmp.sys_codusu_usux.Equals(tcrCodigo)
                                      select new ModeloSiamaeprofsalud
                                      {
                                          Sia_codpfa_prof = tmp.sia_codpfa_prof,
                                          Sia_tipide_tide = tmp.sia_tipide_tide,
    ...
    /// <summary>
    /// Descripcion para la Vista de  la tabla: siamaeprofespas
    /// </summary>
    public class ModeloSiamaeprofespas : clBaseInpc
    {
        #region Modelo Attributos
        private static DbAplicacion _context;
        #region Modelo Propiedades pivadas
        private String _sia_codpfa_proa;
        private String _sia_codpfa_prof;
        private String _nom_nroide_nomi;
        ...
        #endregion
        #region Modelo Propiedades Notificacion
        #region Sia_codpfa_proa: Codigo unico asignacion
        /// <summary>
        /// <para>TABLA: siamaeprofespas</para>
        /// <para>TABLA NATIVA: siamaeprofespas</para>
        /// <para>CAMPO: Codigo unico asignacion</para>
        /// <para>NOMBRE: sia_codpfa_proa (char:10)</para>
        /// <para>ORDEN VISTA EN TABLA: 1</para>
        /// <para>DESCRIPCION:
        /// Codigo unico del Registro de asignacion de especialidades
        /// (generado por el sistema)
        /// </para>
        /// </summary>
        public String Sia_codpfa_proa
        {
            get { return _sia_codpfa_proa; }
            set
            {
                if (_sia_codpfa_proa == value) return;
                _sia_codpfa_proa = value;
                OnPropertyChanged("Sia_codpfa_proa");
            }
        }
        #endregion
        #region Sia_codpfa_prof: Codigo del profesional
        ...
        #endregion
        #region Sia_codesp_esme: Codigo especialidad
        /// <summary>
        /// <para>TABLA: siamaeprofespas</para>
        /// <para>TABLA NATIVA: siaespecialimed</para>
        /// <para>CAMPO: Codigo especialidad</para>
        /// <para>NOMBRE: sia_codesp_esme (char:5)</para>
        /// <para>ORDEN VISTA EN TABLA: 4</para>
        /// <para>DESCRIPCION:
        /// Codigo de la especialidad medica que se asigna al profesional
        /// </para>
        /// </summary>
        ...
        public static bool flgAddRegistro(ModeloSiamaeprofespas tobTempReg, string tcrCodigoR1)
        {
            bool llgReturn = false;
            try
            {
                ...
                {
                    llgReturn = true;
                    var lobEFReg = new EFsiamaeprofespas();
                    //-----------------------
                    if (tobTempReg.Sis_estado_imaen == "M")
                    {
                        lobEFReg = _context.Siamaeprofespas.FirstOrDefault(p => p.sia_codpfa_proa == tobTempReg.Sia_codpfa_proa);
                    }
                    if (tobTempReg.Sis_estado_imaen == "A" || tobTempReg.Sis_estado_imaen == "M") // Adicionar o Modificar
                    {
                        ...
                        if (lobEFReg != null)
                        {
                            lobEFReg.sia_codpfa_proa = tobTempReg.Sia_codpfa_proa;
                            lobEFReg.sia_codpfa_prof = tobTempReg.Sia_codpfa_prof;
                            lobEFReg.nom_nroide_nomi = tobTempReg.Nom_nroide_nomi;
                    ...
                    if (lobEFReg != null)
                    {
                        switch (tobTempReg.Sis_estado_imaen)
                        {
                            case "A": // Adicionar el registro
                                lobEFReg.sia_codpfa_proa = tcrCodigoR1 + lobEFReg.sia_codpfa_proa; // concatenar
                                _context.AddToSiamaeprofespas(lobEFReg);
                                _context.SaveChanges();
                                break;
                            ...
                            case "E": // Eliminar el registro
                                var lobjRegistro = _context.Siamaeprofespas.FirstOrDefault(p => p.sia_codpfa_proa == tobTempReg.Sia_codpfa_proa);
                                if (lobjRegistro != null)
                                {
                                    _context.DeleteObject(lobjRegistro);
                                    _context.SaveChanges();
        ...
        #endregion
        #region Listar Registros
        public static List<ModeloSiamaeprofespas> flsListaSiamaeprofespas(string tcrBuscar)
        {
            using (_context = new DbAplicacion())
            {
                var lobConsulta = from tmp in _context.Siamaeprofespas
                                  where tmp.sia_codpfa_prof == tcrBuscar
                                  select new ModeloSiamaeprofespas
                                  {
                                      Sia_codpfa_proa = tmp.sia_codpfa_proa,
                                      Sia_codpfa_prof = tmp.sia_codpfa_prof,
                                      Nom_nroide_nomi = tmp.nom_nroide_nomi,
