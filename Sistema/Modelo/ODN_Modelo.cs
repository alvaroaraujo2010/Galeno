...
namespace Sistema.Modelo
{
    ...
    public class ModeloOdnMaestroTratamiento : clBaseInpc
    {
        ...
        /// adultos 2= Odontograma niños 3= Odontograma Mixto
        /// </para>
        /// </summary>
        ...
        #endregion
        #region Odn_tipreg_odev: Tipo registro
        private String _odn_tipreg_odev;
        /// <summary>
        /// <para>TABLA: odneventosmaest</para>
        /// <para>TABLA NATIVA: odneventosmaest</para>
        /// <para>CAMPO: Tipo registro</para>
        /// <para>NOMBRE: odn_tipreg_odev (char:1)</para>
        /// <para>ORDEN VISTA EN TABLA: 11</para>
        /// <para>DESCRIPCION:
        /// Tipo tratamiento odontologico: 1=Tratamiento odontologico
        /// 2=Consulta externa o Urgencias
        /// </para>
        /// </summary>
        public String Odn_tipreg_odev
        {
            get { return _odn_tipreg_odev; }
            set
            {
                if (_odn_tipreg_odev == value) return;
                _odn_tipreg_odev = value;
                OnPropertyChanged("Odn_tipreg_odev");
            }
        }
        #endregion
        ...
        public static string flgAddRegistro(ModeloOdnMaestroTratamiento tobjModelo)
        {
            ...
            {
                var lnullaveIndice = Funciones.fnuFechaLlaveIndiceRegistro(tobjModelo.Odn_fecape_odev, tobjModelo.Odn_sishor_odev);
                ...
                using (_context = new DbAplicacion())
                {
                    var lobjRegistro = new EFodneventosmaest
                    {
                        ...
                        odn_tipreg_odev = tobjModelo.Odn_tipreg_odev,
        ...
        public static void fcvActualizar(ModeloOdnMaestroTratamiento tobjModelo)
        {
            using (_context = new DbAplicacion())
            {
                ...
                if (lobjRegistro != null)
                {
                    ...
                    lobjRegistro.odn_secreg_odev = (long)tobjModelo.Odn_secreg_odev;
                    ...
                    lobjRegistro.odn_tipreg_odev = tobjModelo.Odn_tipreg_odev;
                ...
                if (!String.IsNullOrEmpty(lcrIDCodigo))
                {
                    ...
                    var lobConsulta = from odneventosmaest in _context.Odneventosmaest
                                      ...
                                      select new ModeloOdnMaestroTratamiento
                                      {
                                          ...
                                          Odn_secreg_odev = (long)odneventosmaest.odn_secreg_odev,
                                          ...
                                          Odn_tipreg_odev = odneventosmaest.odn_tipreg_odev,
    ...
    public class ModeloOdnMsActivTratamiento : clBaseInpc
    {
        ...
        #endregion
        #region flsListaOdneventosactmsRefEx: Devolver Registro actividad por tipo en un tratamiento
        /// <summary>
        /// <para>Devuelve un registro  tipo ModeloOdnMsActivTratamiento segun el parametro tcrTipo dado</para>
        /// <para>tcrTipo: "1" = Diagnostico inicial "2" = Plan de tratamiento "3" =Actividades Evolucion "4" = Imagenes.</para> 
        /// <para>tcrIdTratamiento: Codigo del Registro maestro de todo el tratamiento</para>
        /// </summary>
        public static ModeloOdnMsActivTratamiento flsListaOdneventosactmsRefEx(String tcrTipo, String tcrIdTratamiento)
        {
            using (_context = new DbAplicacion())
            {
                #region consulta
    ...
    public class ModeloOdnDeActivTratamiento : clBaseInpc
    {
        ...
        #endregion
        #region Odn_aplvis_odde: Aplicar grafica
        private String _odn_aplvis_odde;
        /// <summary>
        /// <para>TABLA: odneventosactde</para>
        /// <para>TABLA NATIVA: odneventosactde</para>
        /// <para>CAMPO: Aplicar grafica</para>
        /// <para>NOMBRE: odn_aplvis_odde (char:1)</para>
        /// <para>ORDEN VISTA EN TABLA: 26</para>
        /// <para>DESCRIPCION:
        /// Aplicar Grafica: 1=Aplicar grafica en lista dientes del odontograma 
        /// 2= Solo aplicar en registro o diente activo
        /// </para>
        /// </summary>
        public String Odn_aplvis_odde
        {
            get { return _odn_aplvis_odde; }
            set
            {
                if (_odn_aplvis_odde == value) return;
                _odn_aplvis_odde = value;
                OnPropertyChanged("Odn_aplvis_odde");
            }
        }
        #endregion
        #region Odn_aplist_odde: Lista aplicar grafica
        private String _odn_aplist_odde;
        /// <summary>
        /// <para>TABLA: odneventosactde</para>
        /// <para>TABLA NATIVA: odneventosactde</para>
        /// <para>CAMPO: Lista aplicar grafica</para>
        /// <para>NOMBRE: odn_aplist_odde (char:200)</para>
        /// <para>ORDEN VISTA EN TABLA: 27</para>
        /// <para>DESCRIPCION:
        /// Lista (separada por  gion al medio) de dientes para aplicar
        /// grafica según valor parametro del campo ODN_APLVIS_ODDE ejemplo: 21-23-27-22...
        /// </para>
        /// </summary>
        public String Odn_aplist_odde
        {
            get { return _odn_aplist_odde; }
            set
            {
                if (_odn_aplist_odde == value) return;
                _odn_aplist_odde = value;
                OnPropertyChanged("Odn_aplist_odde");
            }
        }
        #endregion
        ...
        /// <para>ORDEN VISTA EN TABLA: 5</para>
        /// <para>DESCRIPCION: Tipo Vista Grafica: 1=Graficar caras corona Odontograma 2= Graficar diente</para>
        /// <para> odontograma 3 = Otras graficas</para>
        /// </summary>
        ...
        #endregion
        #region RefObjeto: Referencia a instancia del Objeto imagen en vista
        /// <summary>
        /// <para>Referencia a instancia de Objeto en vista</para>
        /// </summary>
                ...
                using (_context = new DbAplicacion())
                {
                    ...
                    if (tobTempReg.Sis_estado_imaen == "A" || tobTempReg.Sis_estado_imaen == "M") // Adicionar o Modificar
                    {
                        ...
                        if (lobEFReg != null)
                        {
                            ...
                            lobEFReg.odn_aplvis_odde = tobTempReg.Odn_aplvis_odde;
                            lobEFReg.odn_aplist_odde = tobTempReg.Odn_aplist_odde;
        ...
        public static void fcvActualizar(ModeloOdnDeActivTratamiento tobjModelo)
        {
            using (_context = new DbAplicacion())
            {
                ...
                if (lobjRegistro != null)
                {
                    ...
                    lobjRegistro.odn_estact_odac = tobjModelo.Odn_estact_odac;
                    lobjRegistro.odn_aplvis_odde = tobjModelo.Odn_aplvis_odde;
                    lobjRegistro.odn_aplist_odde = tobjModelo.Odn_aplist_odde;
                ...
                if (tcrTipo == "R1")
                {
                    ...
                    var lobConsulta = from odneventosactde in _context.Odneventosactde
                                      ...
                                      select new ModeloOdnDeActivTratamiento
                                      {
                                          ...
                                          Odn_aplvis_odde = odneventosactde.odn_aplvis_odde,
                                          Odn_aplist_odde = odneventosactde.odn_aplist_odde,
        ...
        #endregion
        #region flsListaOdneventosactdeDxPlanTra: Registros diagnosticos y plan tratamiento
        /// <summary>
        /// <para>DESCRIPCION</para>
        /// <para>Devuelve un grupo de registros  de tipo Diagnostico y Plan de tratamiento relacionados a un ID maestro de tratamiento</para>
        /// <para>PARAMETROS:</para>
        /// <para>tcrIdTratamiento: Codigo del Registro Maestro evento principal (Id principal de todo el tratamiento)</para>
        /// <para>Devuelve un temporal con todos los registros del diagnostico inicial y el plan de tratamiento</para>
        /// </summary>
        public static List<ModeloOdnDeActivTratamiento> flsListaOdneventosactdeDxPlanTra(String tcrIdTratamiento)
        {
            using (_context = new DbAplicacion())
            {
                #region consulta
                var lobConsulta = from odneventosactde in _context.Odneventosactde
                                  ...
                                  from oddi in tmodnmaestdientes.DefaultIfEmpty()
                                  from odan in tmodnanatomdiente.DefaultIfEmpty()
                                  where (odneventosactde.odn_tipreg_odac == "1" || 
                                         odneventosactde.odn_tipreg_odac == "2") &&
                                        odneventosactde.odn_nroreg_odev == tcrIdTratamiento
                                  orderby odneventosactde.odn_coddie_oddi, odneventosactde.odn_tipreg_odac
                                  select new ModeloOdnDeActivTratamiento
                                  {
                                      Odn_nroreg_odde = odneventosactde.odn_nroreg_odde,
                                      Odn_secreg_odde = (int)odneventosactde.odn_secreg_odde,
                                      ...
                                      Sia_idesec_usua = odneventosactde.sia_idesec_usua,
                                      Odn_tipreg_odac = odneventosactde.odn_tipreg_odac,
                                      Odn_auxreg_odde = odneventosactde.odn_auxreg_odde != null ? odneventosactde.odn_auxreg_odde: "NA",
                                      Odn_fecact_odac = (DateTime)odneventosactde.odn_fecact_odac,
                                      Odn_coddia_oddx = odneventosactde.odn_coddia_oddx,
                                      Sia_coddia_tdia = odneventosactde.sia_coddia_tdia,
                                      Odn_codser_odsi = odneventosactde.odn_codser_odsi,
                                      ...
                                      Odn_imagen_odde = odneventosactde.odn_imagen_odde,
                                      Sis_estpro_espr = odneventosactde.sis_estpro_espr,
                                      Odn_desdie_oddi = odneventosactde.odn_coddie_oddi == "NA" ? "GENERAL" : oddi.odn_desdie_oddi,
                                      Odn_desana_odan = odan.odn_desana_odan,
                                  };
                return lobConsulta.ToList();
                #endregion
        ...
        #endregion
        #region flsListaOdneventosactdeDetallesTodos: Registros diagnosticos Plan tratamiento y Actividades evolucion
        /// <summary>
        /// <para>DESCRIPCION</para>
        /// <para>Devuelve un grupo de registros  de tipo Diagnostico, Plan de tratamiento y Actividades evolucion, relacionados a un ID maestro de tratamiento</para>
        /// <para>PARAMETROS:</para>
        /// <para>tcrIdTratamiento: Codigo del Registro Maestro evento principal (Id principal de todo el tratamiento)</para>
        /// <para>Devuelve un temporal con todos los registros de diagnosticos Plan tratamiento y Actividades evolucion</para>
        /// </summary>
        public static List<ModeloOdnDeActivTratamiento> flsListaOdneventosactdeDetallesTodos(String tcrIdTratamiento)
        {
            using (_context = new DbAplicacion())
            {
                #region consulta
                var lobConsulta = from odneventosactde in _context.Odneventosactde
                                  join odneventosactms in _context.Odneventosactms on odneventosactde.odn_nroreg_odac equals odneventosactms.odn_nroreg_odac into tmodneventosactms
                                  join odnmaestdientes in _context.Odnmaestdientes on odneventosactde.odn_coddie_oddi equals odnmaestdientes.odn_coddie_oddi into tmodnmaestdientes
                                  join odnanatomdiente in _context.Odnanatomdiente on odneventosactde.odn_codana_odan equals odnanatomdiente.odn_codana_odan into tmodnanatomdiente
                                  from odac in tmodneventosactms.DefaultIfEmpty()
                                  from oddi in tmodnmaestdientes.DefaultIfEmpty()
                                  from odan in tmodnanatomdiente.DefaultIfEmpty()
                                  where odneventosactde.odn_nroreg_odev == tcrIdTratamiento
                                  orderby odneventosactde.odn_fecact_odac,
                                          odneventosactde.odn_coddie_oddi, 
                                          odneventosactde.odn_tipreg_odac descending
                                  select new ModeloOdnDeActivTratamiento
                                  {
                                      Odn_nroreg_odde = odneventosactde.odn_nroreg_odde,
                                      Odn_secreg_odde = (int)odneventosactde.odn_secreg_odde,
                                      ...
                                      Odn_desdie_oddi = odneventosactde.odn_coddie_oddi == "NA" ? "GENERAL" : oddi.odn_desdie_oddi,
                                      Odn_desana_odan = odan.odn_desana_odan,
                                      Sia_nompro_prof = _context.Siamaeprofsalud.FirstOrDefault(rxp => rxp.sia_codpfa_prof == odac.sia_codpfa_prof).sia_nompro_prof,
                                  };
                return lobConsulta.ToList();
                #endregion
            }
    ...
    /// <summary>
    /// odngrupovistama: Vista grupos diagnosticos y servicios para gestion captura
    /// </summary>
    public class ModeloOdngrupovistama : clBaseInpc
    {
        #region Modelo Attributos
        private static DbAplicacion _context;
        #region Modelo Propiedades Notificacion
        #region Odn_codgru_odva: Codigo grupo
        private String _odn_codgru_odva;
        /// <summary>
        /// <para>TABLA: odngrupovistama</para>
        /// <para>TABLA NATIVA: odngrupovistama</para>
        /// <para>CAMPO: Codigo grupo</para>
        /// <para>NOMBRE: odn_codgru_odva (char:4)</para>
        /// <para>ORDEN VISTA EN TABLA: 1</para>
        /// <para>DESCRIPCION:
        ///codigo del grupo vista generado por el sistema
        /// </para>
        /// </summary>
        public String Odn_codgru_odva
        {
            get { return _odn_codgru_odva; }
            set
            {
                if (_odn_codgru_odva == value) return;
                _odn_codgru_odva = value;
                OnPropertyChanged("Odn_codgru_odva");
            }
        }
        #endregion
        #region Odn_desgru_odva: Descripcion grupo
        private String _odn_desgru_odva;
        /// <summary>
        /// <para>TABLA: odngrupovistama</para>
        /// <para>TABLA NATIVA: odngrupovistama</para>
        /// <para>CAMPO: Descripcion grupo</para>
        /// <para>NOMBRE: odn_desgru_odva (char:40)</para>
        /// <para>ORDEN VISTA EN TABLA: 2</para>
        /// <para>DESCRIPCION:
        ///Descripcion grupo vista
        /// </para>
        /// </summary>
        public String Odn_desgru_odva
        {
            get { return _odn_desgru_odva; }
            set
            {
                if (_odn_desgru_odva == value) return;
                _odn_desgru_odva = value;
                OnPropertyChanged("Odn_desgru_odva");
            }
        }
        #endregion
        #region Odn_tipgru_odva: Tipo grupo vista
        private String _odn_tipgru_odva;
        /// <summary>
        /// <para>TABLA: odngrupovistama</para>
        /// <para>TABLA NATIVA: odngrupovistama</para>
        /// <para>CAMPO: Tipo grupo vista</para>
        /// <para>NOMBRE: odn_tipgru_odva (char:1)</para>
        /// <para>ORDEN VISTA EN TABLA: 3</para>
        /// <para>DESCRIPCION:
        /// Tipo GrupoVista Grafica: 1=Graficar grupos  diagnosticos,
        /// 2= Grupo Graficaras Servicios
        /// </para>
        /// </summary>
        public String Odn_tipgru_odva
        {
            get { return _odn_tipgru_odva; }
            set
            {
                if (_odn_tipgru_odva == value) return;
                _odn_tipgru_odva = value;
                OnPropertyChanged("Odn_tipgru_odva");
            }
        }
        #endregion
        #region Odn_ordvis_odva: Orden visualizacion
        private int _odn_ordvis_odva;
        /// <summary>
        /// <para>TABLA: odngrupovistama</para>
        /// <para>TABLA NATIVA: odngrupovistama</para>
        /// <para>CAMPO: Orden visualizacion</para>
        /// <para>NOMBRE: odn_ordvis_odva (int:3)</para>
        /// <para>ORDEN VISTA EN TABLA: 4</para>
        /// <para>DESCRIPCION:
        ///Orden visualizacion dentro del a lista
        /// </para>
        /// </summary>
        public int Odn_ordvis_odva
        {
            get { return _odn_ordvis_odva; }
            set
            {
                if (_odn_ordvis_odva == value) return;
                _odn_ordvis_odva = value;
                OnPropertyChanged("Odn_ordvis_odva");
            }
        }
        #endregion
        #region Odn_codimg_odim: Codigo imagen
        ...
        /// <para>ORDEN VISTA EN TABLA: 5</para>
        /// <para>DESCRIPCION:
        ///codigo unico de la imagen que representa el grupo
        /// </para>
        /// </summary>
        public String Odn_codimg_odim
        {
        ...
        #endregion
        #region Odn_secdet_odva: Secuencial registro
        private int _odn_secdet_odva;
        /// <summary>
        /// <para>TABLA: odngrupovistama</para>
        /// <para>TABLA NATIVA: odngrupovistama</para>
        /// <para>CAMPO: Secuencial registro</para>
        /// <para>NOMBRE: odn_secdet_odva (int:5)</para>
        /// <para>ORDEN VISTA EN TABLA: 6</para>
        /// <para>DESCRIPCION:
        /// Campo para generar el secuencial para detalles registros en
        /// vista
        /// </para>
        /// </summary>
        public int Odn_secdet_odva
        {
            get { return _odn_secdet_odva; }
            set
            {
                if (_odn_secdet_odva == value) return;
                _odn_secdet_odva = value;
                OnPropertyChanged("Odn_secdet_odva");
            }
        }
        #endregion
        #region Odn_estreg_odva: Estado registro
        private String _odn_estreg_odva;
        /// <summary>
        /// <para>TABLA: odngrupovistama</para>
        /// <para>TABLA NATIVA: odngrupovistama</para>
        /// <para>CAMPO: Estado registro</para>
        /// <para>NOMBRE: odn_estreg_odva (char:1)</para>
        /// <para>ORDEN VISTA EN TABLA: 7</para>
        /// <para>DESCRIPCION: Codigo estado del Registro: 1= Activo 2= Inactivo</para>
        /// </summary>
        public String Odn_estreg_odva
        {
            get { return _odn_estreg_odva; }
            set
            {
                if (_odn_estreg_odva == value) return;
                _odn_estreg_odva = value;
                OnPropertyChanged("Odn_estreg_odva");
            }
        }
        #endregion
        ...
        #endregion
        #region Odn_imagen_odim: Nombre de la imagen en png/jpg
        private String _odn_imagen_odim;
        /// <summary>
        ...
        /// </para>
        /// </summary>
        public String Odn_imagen_odim
        {
            get { return _odn_imagen_odim; }
            set
            {
                if (_odn_imagen_odim == value) return;
                _odn_imagen_odim = value;
                OnPropertyChanged("Odn_imagen_odim");
            }
        }
        #endregion
        #endregion
        ...
        #region Metodos para edicion de registros
        #region Adicionar Registro
        public static String flgAddRegistro(ModeloOdngrupovistama tobjModelo)
        {
            var lcrCodigoGen = SysModelo.fcrGenerarNuevoCodigo("ODN-ODNGRUPOVISTAMA", "ODN", "Vista grupos diagnosticos y servicios para gestion captura");
            try
            {
                if (!flgBuscarOdngrupovistama(lcrCodigoGen))
                {
                    using (_context = new DbAplicacion())
                    {
                        var lobjRegistro = new EFodngrupovistama
                        {
                            #region cargar Registro
                            odn_codgru_odva = tobjModelo.Odn_codgru_odva,
                            odn_desgru_odva = tobjModelo.Odn_desgru_odva,
                            odn_tipgru_odva = tobjModelo.Odn_tipgru_odva,
                            odn_ordvis_odva = tobjModelo.Odn_ordvis_odva,
                            odn_codimg_odim = tobjModelo.Odn_codimg_odim,
                            odn_secdet_odva = tobjModelo.Odn_secdet_odva,
                            odn_estreg_odva = tobjModelo.Odn_estreg_odva,
                            #endregion
                        };
                        lobjRegistro.odn_codgru_odva = lcrCodigoGen;
                        _context.AddToOdngrupovistama(lobjRegistro);
                        _context.SaveChanges();
                    }
                }
                else
                {
                    lcrCodigoGen = String.Empty;
                    MessageBox.Show("Nuevo codigo Generado esta desactualizado, revisar llave: \n" +
                                "'ODN-ODNGRUPOVISTAMA': Vista grupos diagnosticos y servicios para gestion captura en Maestro Secuenciales.");
                }
            }
            catch (Exception ex)
            {
        ...
        #endregion
        #region Modificar Registro
        public static void fcvActualizar(ModeloOdngrupovistama tobjModelo)
        {
            try
            {
                using (_context = new DbAplicacion())
                {
                    var lobjRegistro = _context.Odngrupovistama.FirstOrDefault(p => p.odn_codgru_odva == tobjModelo.Odn_codgru_odva);
                    if (lobjRegistro != null)
                    {
                        #region cargar Registro
                        lobjRegistro.odn_codgru_odva = tobjModelo.Odn_codgru_odva;
                        lobjRegistro.odn_desgru_odva = tobjModelo.Odn_desgru_odva;
                        lobjRegistro.odn_tipgru_odva = tobjModelo.Odn_tipgru_odva;
                        lobjRegistro.odn_ordvis_odva = (int)tobjModelo.Odn_ordvis_odva;
                        lobjRegistro.odn_codimg_odim = tobjModelo.Odn_codimg_odim;
                        lobjRegistro.odn_secdet_odva = (int)tobjModelo.Odn_secdet_odva;
                        lobjRegistro.odn_estreg_odva = tobjModelo.Odn_estreg_odva;
                        #endregion
                        _context.SaveChanges();
                    }
                }
        ...
        public static void fcvEliminar(String tcrCodigo)
        {
            try
            {
                using (_context = new DbAplicacion())
                {
                    var lobjRegistro = _context.Odngrupovistama.FirstOrDefault(p => p.odn_codgru_odva == tcrCodigo);
                    if (lobjRegistro != null)
                    {
                        _context.DeleteObject(lobjRegistro);
                        _context.SaveChanges();
        ...
        #endregion
        #region Buscar ODNGRUPOVISTAMA: Logica
        /// <summary>
        /// <para>TABLA: odngrupovistama</para>
        /// <para>TITULO: Vista grupos diagnosticos y servicios para gestion captura</para>
        /// <para>MODULO: ODN</para>
        /// <para>VALOR RETORNO:
        /// Devuelve valor de tipo logico True/False pa indicar si existe
        /// o no el código.
        /// </para>
        /// <para>DESCRIPCION TABLA:
        /// Vista para organizar grupos de elementos para facilitar captura
        /// diagnosticos y servicios utilizados en Odontologia
        /// </para>
        /// </summary>
        public static bool flgBuscarOdngrupovistama(String tcrCodigo)
        {
            bool llgReturn = false;
            using (_context = new DbAplicacion())
            {
        ...
        public static List<ModeloOdngrupovistama> flsListaOdngrupovistama(String tcrBuscar)
        {
            using (_context = new DbAplicacion())
            {
                if (String.IsNullOrEmpty(tcrBuscar))
                {
                    var lobConsulta = from odngrupovistama in _context.Odngrupovistama
                                      join odnimagengrafms in _context.Odnimagengrafms on odngrupovistama.odn_codimg_odim equals odnimagengrafms.odn_codimg_odim into tmodnimagengrafms
                                      from odim in tmodnimagengrafms.DefaultIfEmpty()
                                      orderby odngrupovistama.odn_tipgru_odva, odngrupovistama.odn_ordvis_odva
                                      select new ModeloOdngrupovistama
                                      {
                                          #region Datos
                                          Odn_codgru_odva = odngrupovistama.odn_codgru_odva,
                                          Odn_desgru_odva = odngrupovistama.odn_desgru_odva,
                                          Odn_tipgru_odva = odngrupovistama.odn_tipgru_odva,
                                          Odn_ordvis_odva = (int)odngrupovistama.odn_ordvis_odva,
                                          Odn_codimg_odim = odngrupovistama.odn_codimg_odim,
                                          Odn_secdet_odva = (int)odngrupovistama.odn_secdet_odva,
                                          Odn_estreg_odva = odngrupovistama.odn_estreg_odva,
                                          Odn_imagen_odim = odim.odn_imagen_odim,
                                          #endregion
                                      };
                    return lobConsulta.ToList();
                }
                else
                {
                    var lobConsulta = from odngrupovistama in _context.Odngrupovistama
                                      join odnimagengrafms in _context.Odnimagengrafms on odngrupovistama.odn_codimg_odim equals odnimagengrafms.odn_codimg_odim into tmodnimagengrafms
                                      from odim in tmodnimagengrafms.DefaultIfEmpty()
                                      where odngrupovistama.odn_codgru_odva.Contains(tcrBuscar) || odngrupovistama.odn_desgru_odva.Contains(tcrBuscar)
                                      orderby odngrupovistama.odn_tipgru_odva, odngrupovistama.odn_ordvis_odva
                                      select new ModeloOdngrupovistama
                                      {
                                          #region Datos
        ...
        #endregion
        #region Listar Registros segun tipo grupo
        public static List<ModeloOdngrupovistama> flsListaOdngrupovistamaTipo(String tcrTipo)
        {
            List<ModeloOdngrupovistama> lobConsulta = null;
            using (_context = new DbAplicacion())
            {
                lobConsulta = (from odngrupovistama in _context.Odngrupovistama
                               join odnimagengrafms in _context.Odnimagengrafms on odngrupovistama.odn_codimg_odim equals odnimagengrafms.odn_codimg_odim into tmodnimagengrafms
                               from odim in tmodnimagengrafms.DefaultIfEmpty()
                               where odngrupovistama.odn_tipgru_odva == tcrTipo && odngrupovistama.odn_estreg_odva == "1"
                               orderby odngrupovistama.odn_ordvis_odva
                               select new ModeloOdngrupovistama
                               {
                                   #region Datos
                                   Odn_codgru_odva = odngrupovistama.odn_codgru_odva,
    ...
    /// <summary>
    /// odngrupovistamd: Registros detalles vista grupos diagnosticos y servicios para gestion captura
    /// </summary>
    public class ModeloOdngrupovistamd : clBaseInpc
    {
        #region Modelo Attributos
        private static DbAplicacion _context;
        #region Modelo Propiedades Notificacion
        #region Odn_codgru_odvd: Codigo del registro
        private String _odn_codgru_odvd;
        /// <summary>
        /// <para>TABLA: odngrupovistamd</para>
        /// <para>TABLA NATIVA: odngrupovistamd</para>
        /// <para>CAMPO: Codigo del registro</para>
        /// <para>NOMBRE: odn_codgru_odvd (char:10)</para>
        /// <para>ORDEN VISTA EN TABLA: 1</para>
        /// <para>DESCRIPCION:
        /// codigo del registo detalle grupo vista generado por el sistema
        /// </para>
        /// </summary>
        public String Odn_codgru_odvd
        {
            get { return _odn_codgru_odvd; }
            set
            {
                if (_odn_codgru_odvd == value) return;
                _odn_codgru_odvd = value;
                OnPropertyChanged("Odn_codgru_odvd");
            }
        }
        #endregion
        #region Odn_codgru_odva: Codigo grupo
        ...
        /// <para>ORDEN VISTA EN TABLA: 2</para>
        /// <para>DESCRIPCION:
        ///Codigo del grupo vista al cual esta asociado el registro
        /// </para>
        /// </summary>
        public String Odn_codgru_odva
        {
        ...
        #endregion
        #region Odn_desreg_odvd: Descripcion registro
        private String _odn_desreg_odvd;
        /// <summary>
        /// <para>TABLA: odngrupovistamd</para>
        /// <para>TABLA NATIVA: odngrupovistamd</para>
        /// <para>CAMPO: Descripcion registro</para>
        /// <para>NOMBRE: odn_desreg_odvd (char:40)</para>
        /// <para>ORDEN VISTA EN TABLA: 3</para>
        /// <para>DESCRIPCION:
        ///Descripcion del registro en la vista
        /// </para>
        /// </summary>
        public String Odn_desreg_odvd
        {
            get { return _odn_desreg_odvd; }
            set
            {
                if (_odn_desreg_odvd == value) return;
                _odn_desreg_odvd = value;
                OnPropertyChanged("Odn_desreg_odvd");
            }
        }
        #endregion
        #region Odn_codaux_odvd: Codigo auxiliar
        private String _odn_codaux_odvd;
        /// <summary>
        /// <para>TABLA: odngrupovistamd</para>
        /// <para>TABLA NATIVA: odngrupovistamd</para>
        /// <para>CAMPO: Codigo auxiliar</para>
        /// <para>NOMBRE: odn_codaux_odvd (char:20)</para>
        /// <para>ORDEN VISTA EN TABLA: 4</para>
        /// <para>DESCRIPCION:
        /// Codigo auxiliar  registro según tipo grupo  diagnostico/procedimiento
        /// es CIE 10 SIA_CODDIA_TDIA o Codigo servicio IPS activo en tarifario
        /// de ventas FCM_IDESEC_SIPS
        /// </para>
        /// </summary>
        public String Odn_codaux_odvd
        {
            get { return _odn_codaux_odvd; }
            set
            {
                if (_odn_codaux_odvd == value) return;
                _odn_codaux_odvd = value;
                OnPropertyChanged("Odn_codaux_odvd");
            }
        }
        #endregion
        #region Odn_ordvis_odvd: Orden visualizacion
        private int _odn_ordvis_odvd;
        /// <summary>
        /// <para>TABLA: odngrupovistamd</para>
        /// <para>TABLA NATIVA: odngrupovistamd</para>
        /// <para>CAMPO: Orden visualizacion</para>
        /// <para>NOMBRE: odn_ordvis_odvd (int:3)</para>
        /// <para>ORDEN VISTA EN TABLA: 5</para>
        /// <para>DESCRIPCION:
        ///Orden visualizacion dentro lista del grupo
        /// </para>
        /// </summary>
        public int Odn_ordvis_odvd
        {
            get { return _odn_ordvis_odvd; }
            set
            {
                if (_odn_ordvis_odvd == value) return;
                _odn_ordvis_odvd = value;
                OnPropertyChanged("Odn_ordvis_odvd");
            }
        }
        #endregion
        #region Odn_codimg_odim: Codigo imagen
        ...
        /// <para>ORDEN VISTA EN TABLA: 6</para>
        /// <para>DESCRIPCION:
        /// Codigo imagen que representa el registro (no tiene relacion
        /// directa con la grafica que se muestra en odontograma)
        /// </para>
        /// </summary>
        public String Odn_codimg_odim
        {
        ...
        #endregion
        #region Odn_estreg_odvd: Estado registro
        private String _odn_estreg_odvd;
        /// <summary>
        /// <para>TABLA: odngrupovistamd</para>
        /// <para>TABLA NATIVA: odngrupovistamd</para>
        /// <para>CAMPO: Estado registro</para>
        /// <para>NOMBRE: odn_estreg_odvd (char:1)</para>
        /// <para>ORDEN VISTA EN TABLA: 6</para>
        /// <para>DESCRIPCION: Codigo estado del Registro: 1= Activo 2= Inactivo </para>
        /// </summary>
        public String Odn_estreg_odvd
        {
            get { return _odn_estreg_odvd; }
            set
            {
                if (_odn_estreg_odvd == value) return;
                _odn_estreg_odvd = value;
                OnPropertyChanged("Odn_estreg_odvd");
            }
        }
        #endregion
        #region Fcm_desreg_odvd: Descripcion Diagnostico o Nombre servicio
        private String _fcm_desreg_odvd;
        /// <summary>
        /// <para>TABLA: temporal</para>
        ...
        /// <para>ORDEN VISTA EN TABLA: 7</para>
        /// <para>DESCRIPCION:
        ///Descripción textual del diagnosticdo o servicio en el manual
        /// </para>
        /// </summary>
        public String Fcm_desreg_odvd
        {
            get { return _fcm_desreg_odvd; }
            set
            {
                if (_fcm_desreg_odvd == value) return;
                _fcm_desreg_odvd = value;
                OnPropertyChanged("Fcm_desreg_odvd");
            }
        }
        #endregion
        #region Odn_desgru_odva: Descripcion grupo
        ...
        /// <para>ORDEN VISTA EN TABLA: 3</para>
        /// <para>DESCRIPCION:
        /// Tipo GrupoVista Grafica: 1=Graficar grupos  diagnosticos, 2= Grupo Graficaras Servicios
        /// </para>
        /// </summary>
        public String Odn_tipgru_odva
        {
        ...
        public static bool flgAddRegistro(ModeloOdngrupovistamd tobTempReg, String tcrCodigoR1)
        {
            bool llgReturn = false;
            try
            {
                ...
                {
                    llgReturn = true;
                    var lobEFReg = new EFodngrupovistamd();
                    //-----------------------
                    if (tobTempReg.Sis_estado_imaen == "M")
                    {
                        lobEFReg = _context.Odngrupovistamd.FirstOrDefault(p => p.odn_codgru_odvd == tobTempReg.Odn_codgru_odvd);
                    }
                    if (tobTempReg.Sis_estado_imaen == "A" || tobTempReg.Sis_estado_imaen == "M") // Adicionar o Modificar
                    {
                        #region cargar Registro
                        if (lobEFReg != null)
                        {
                            lobEFReg.odn_codgru_odvd = tobTempReg.Odn_codgru_odvd;
                            lobEFReg.odn_codgru_odva = tobTempReg.Odn_codgru_odva;
                            lobEFReg.odn_desreg_odvd = tobTempReg.Odn_desreg_odvd;
                            lobEFReg.odn_codaux_odvd = tobTempReg.Odn_codaux_odvd;
                            lobEFReg.odn_ordvis_odvd = (int)tobTempReg.Odn_ordvis_odvd;
                            lobEFReg.odn_codimg_odim = tobTempReg.Odn_codimg_odim;
                            lobEFReg.odn_estreg_odvd = tobTempReg.Odn_estreg_odvd;
                        }
                        #endregion
                    }
                    //---------------------------
                    ...
                    if (lobEFReg != null)
                    {
                        ...
                        {
                            case "A": // Adicionar el registro
                                lobEFReg.odn_codgru_odvd = tcrCodigoR1 + lobEFReg.odn_codgru_odvd; // concatenar
                                _context.AddToOdngrupovistamd(lobEFReg);
                                _context.SaveChanges();
                                break;
                            ...
                            case "E": // Eliminar el registro
                                var lobjRegistro = _context.Odngrupovistamd.FirstOrDefault(p => p.odn_codgru_odvd == tobTempReg.Odn_codgru_odvd);
                                if (lobjRegistro != null)
                                {
                                    _context.DeleteObject(lobjRegistro);
                                    _context.SaveChanges();
        ...
        #endregion
        #region Buscar ODNGRUPOVISTAMD: Logica
        /// <summary>
        /// <para>TABLA: odngrupovistamd</para>
        /// <para>TITULO: Registros detalles vista grupos diagnosticos y servicios par</para>
        /// <para>MODULO: ODN</para>
        /// <para>VALOR RETORNO:
        /// Devuelve valor de tipo logico True/False pa indicar si existe
        /// o no el código.
        /// </para>
        /// <para>DESCRIPCION TABLA:
        /// lista detalles Vista para organizar grupos de elementos para
        /// facilitar captura diagnosticos y servicios
        /// </para>
        /// </summary>
        public static bool flgBuscarOdngrupovistamd(String tcrCodigo)
        {
            bool llgReturn = false;
            using (_context = new DbAplicacion())
            {
                var lobjRegistro = _context.Odngrupovistamd.FirstOrDefault(p => p.odn_codgru_odvd == tcrCodigo);
                if (lobjRegistro != null)
                {
                    llgReturn = true;
                };
        ...
        #endregion
        #region Listar Registros
        public static List<ModeloOdngrupovistamd> flsListaOdngrupovistamd(String tcrBuscar)
        {
            using (_context = new DbAplicacion())
            {
                var lobConsulta = from odngrupovistamd in _context.Odngrupovistamd
                                  join odngrupovistama in _context.Odngrupovistama on odngrupovistamd.odn_codgru_odva equals odngrupovistama.odn_codgru_odva into tmodngrupovistama
                                  from odva in tmodngrupovistama.DefaultIfEmpty()
                                  where odngrupovistamd.odn_codgru_odva == tcrBuscar
                                  select new ModeloOdngrupovistamd
                                  {
                                      Odn_codgru_odvd = odngrupovistamd.odn_codgru_odvd,
                                      Odn_codgru_odva = odngrupovistamd.odn_codgru_odva,
                                      Odn_desreg_odvd = odngrupovistamd.odn_desreg_odvd,
                                      Odn_codaux_odvd = odngrupovistamd.odn_codaux_odvd,
                                      Odn_ordvis_odvd = (int)odngrupovistamd.odn_ordvis_odvd,
                                      Odn_codimg_odim = odngrupovistamd.odn_codimg_odim,
                                      Odn_estreg_odvd = odngrupovistamd.odn_estreg_odvd,
                                      Odn_desgru_odva = odva.odn_desgru_odva,
                                      Sis_estado_imaen = "I",
        ...
        #endregion
        #region Listar Registros servicios procedimientos
        /// <summary>
        /// Devuelve un listado de servicios/procedimientos/consultas activos para gestion vista captura odontologia
        /// </summary>
        /// <param name="tcrTarifario">Codigo del tarifario de ventas activo</param>
        /// <returns></returns>
        public static List<ModeloOdngrupovistamd> flsListaOdngrupovistamdServicios(String tcrTarifario)
        {
            List<ModeloOdngrupovistamd> lobConsulta = null;
            using (_context = new DbAplicacion())
            {
                var tmpLista = from odngrupovistamd in _context.Odngrupovistamd
                               join grupos in _context.Odngrupovistama on odngrupovistamd.odn_codgru_odva equals grupos.odn_codgru_odva
                               join servicios in _context.Fcmmanservicios on odngrupovistamd.odn_codaux_odvd equals servicios.fcm_idesec_sips
                               where odngrupovistamd.odn_estreg_odvd == "1" &&
                                     grupos.odn_estreg_odva == "1" &&
                                     grupos.odn_tipgru_odva == "2" &&
                                     servicios.fcm_codman_mans == tcrTarifario &&
                                     servicios.fcm_estser_mant == "1"
                               orderby grupos.odn_ordvis_odva, odngrupovistamd.odn_ordvis_odvd 
                               select new ModeloOdngrupovistamd
                               {
                                   Odn_codgru_odvd = odngrupovistamd.odn_codgru_odvd,
                                   Odn_codgru_odva = odngrupovistamd.odn_codgru_odva,
                                   ...
                                   Odn_codimg_odim = odngrupovistamd.odn_codimg_odim,
                                   Odn_estreg_odvd = odngrupovistamd.odn_estreg_odvd,
                                   Odn_desgru_odva = grupos.odn_desgru_odva,
                                   Odn_tipgru_odva = grupos.odn_tipgru_odva,
                                   Fcm_desreg_odvd = servicios.fcm_desser_mant,
                                   Fcm_idesec_sips = servicios.fcm_idesec_sips,
                                   Fcm_coddig_mant = servicios.fcm_coddig_mant,
                                   Odn_imagen_odim = _context.Odnimagengrafms.FirstOrDefault(x => x.odn_codimg_odim == odngrupovistamd.odn_codimg_odim).odn_imagen_odim,
                                   Sis_estado_imaen = "I",
                                   GestionEstadoRegistro = "XX",
                                   GestionLlaveBusqueda = servicios.fcm_coddig_mant + " " + servicios.fcm_idesec_sips + " " + servicios.fcm_desser_mant,
                               };
                // Verificar que si esten activos en lista servicios IPS para odontologia
                if (tmpLista != null && tmpLista.ToList().Count != 0)
                {
                    var tmpServIPs = (from tm in _context.Odnserviciosips where tm.odn_estreg_odsi == "1" select tm).ToList();

                    if (tmpServIPs != null && tmpServIPs.ToList().Count != 0)
                    {
                        foreach (var lobReg in tmpLista)
                        {
                            var lobRegAux = tmpServIPs.FirstOrDefault(x => x.fcm_idesec_sips == lobReg.Odn_codaux_odvd);
                            lobReg.Sis_estado_imaen = lobRegAux == null ? "E" : "I";
                        }
                        lobConsulta = (from tm in tmpLista where tm.Sis_estado_imaen == "I" select tm).ToList();
                    }
                }
                return lobConsulta;
            }
        ...
        #endregion
        #region Listar Registros Diagnosticos
        /// <summary>
        /// Devuelve un listado de diagnosticos activos para gestion vista captura odontologia
        /// </summary>
        /// <returns>Retorna lista de diagnosticos odontologicos</returns>
        public static List<ModeloOdngrupovistamd> flsListaOdngrupovistamdDiagnost()
        {
            using (_context = new DbAplicacion())
            {
                ...
                var tmpLista = from odngrupovistamd in _context.Odngrupovistamd
                               join grupos in _context.Odngrupovistama on odngrupovistamd.odn_codgru_odva equals grupos.odn_codgru_odva
                               join diagnost in _context.Odndiagnosticos on odngrupovistamd.odn_codaux_odvd equals diagnost.odn_coddia_oddx
                               where odngrupovistamd.odn_estreg_odvd == "1" &&
                                     grupos.odn_estreg_odva == "1" &&
                                     grupos.odn_tipgru_odva == "1" &&
                                     diagnost.odn_estreg_oddx == "1"
                               orderby grupos.odn_ordvis_odva, odngrupovistamd.odn_ordvis_odvd
                               select new ModeloOdngrupovistamd
                               {
                                   Odn_codgru_odvd = odngrupovistamd.odn_codgru_odvd,
                                   ...
                                   Odn_desgru_odva = grupos.odn_desgru_odva,
                                   Odn_tipgru_odva = grupos.odn_tipgru_odva,
                                   Fcm_desreg_odvd = diagnost.odn_desdia_oddx,
                                   Fcm_idesec_sips = "NA",
                                   Fcm_coddig_mant = "NA",
                                   Odn_imagen_odim = _context.Odnimagengrafms.FirstOrDefault(x => x.odn_codimg_odim == odngrupovistamd.odn_codimg_odim).odn_imagen_odim,
                                   Sis_estado_imaen = "I",
                                   GestionEstadoRegistro = "XX",
                                   GestionLlaveBusqueda = diagnost.odn_coddia_oddx + " " + diagnost.odn_desdia_oddx,
                               };
                return tmpLista.ToList();
            }
        }
        #endregion
        #endregion
