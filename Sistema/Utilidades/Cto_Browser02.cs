...
{
    public class CTO_Browser02 : AuxBrowser02
    {
        ...
        public void ConfigInicial()
        {
            ...
            switch (gcrTabla.ToUpper())
            {
                case "CTOMAEAFILIADOS":
                    ...
                    gobDataGrid.ItemsSource = flsBuscar_Ctomaeafiliados().DefaultView;
                    break;
        ...
        */
        #endregion
        //----------------------------------------------------------------------
        //    TABLA: CTOMAEAFILIADOS - Maestro afiliados de un contrato
        //----------------------------------------------------------------------
        #region CTOMAEAFILIADOS
        #region Filtro de busquedas
        public DataTable flsBuscar_Ctomaeafiliados()
        {
            var lcrFiltro1 = " WHERE ctomaeafiliados.sis_estreg_esrg = '1'";
            var lcrFiltro2 = String.Empty;

            if (gcrIndiceActivo == "1") // Numero de identificacion
            {
                lcrFiltro2 = " AND ctomaeafiliados.sia_nroide_usua LIKE '" + gobjTextBox11.Text.Trim() + "%'";
                /*
                if (gobjTextBox11.Text.Trim().Length <= 4)
                {
                    lcrFiltro2 = " AND ctomaeafiliados.sia_nroide_usua LIKE '" + gobjTextBox11.Text.Trim() + "%'";
                }
                else
                {
                    lcrFiltro2 = " AND ctomaeafiliados.sia_nroide_usua = '" + gobjTextBox11.Text.Trim() + "'";
                }
                */
            ...
            else if (gcrIndiceActivo == "2") // P.Apellido S.Apellido P.Nombre
            {
                ...
                var lcrApell1 = !String.IsNullOrWhiteSpace(lcrApe1) ? "ctomaeafiliados.sia_priape_usua LIKE '" + lcrApe1 + "%'" : "";
                var lcrApell2 = !String.IsNullOrWhiteSpace(lcrApe2) ? "ctomaeafiliados.sia_segape_usua LIKE '" + lcrApe2 + "%'" : "";
                var lcrNombr1 = !String.IsNullOrWhiteSpace(lcrNom1) ? "ctomaeafiliados.sia_prinom_usua LIKE '" + lcrNom1 + "%'" : "";
            ...
            //var lcrOrderBy = " ORDER BY ctomaeafiliados.sia_priape_usua DESC LIMIT 60";
            var lcrOrderBy = " LIMIT 100";
            var lcrLineaSqlSelct = fcrLineaSqlLineas() + lcrFiltro1 + lcrFiltro2 + lcrOrderBy;

            var lobjDatosTabla = Funciones.fobConsultaSqlDataAdapter(lcrLineaSqlSelct);
            return lobjDatosTabla;
        }
        public String fcrLineaSqlLineas()
        {
            var lcrLinea = "SELECT ctomaeafiliados.cto_idesec_ctou," +
                           "ctomaeafiliados.sia_nroide_usua," +
                           "ctomaeafiliados.sia_codeps_teps," +
                           "ctomaeafiliados.sia_priape_usua," +
                           "ctomaeafiliados.sia_segape_usua," +
                           "ctomaeafiliados.sia_prinom_usua," +
                           "ctomaeafiliados.sia_segnom_usua," +
                           "ctomaeafiliados.sia_fecnac_usua," +
                           "ctomaeafiliados.sis_codsex_sexo" +
                     " FROM ctomaeafiliados";
        ...
        {
            gobGridView.Columns.Add(new GridViewColumn { Header = "Identificacion", Width = 120, DisplayMemberBinding = new Binding("sia_nroide_usua") });
            gobGridView.Columns.Add(new GridViewColumn { Header = "P.Apellido", Width = 120, DisplayMemberBinding = new Binding("sia_priape_usua") });
            gobGridView.Columns.Add(new GridViewColumn { Header = "S.Apellido", Width = 120, DisplayMemberBinding = new Binding("sia_segape_usua") });
            gobGridView.Columns.Add(new GridViewColumn { Header = "P.Nombre", Width = 120, DisplayMemberBinding = new Binding("sia_prinom_usua") });
            gobGridView.Columns.Add(new GridViewColumn { Header = "S.Nombre", Width = 120, DisplayMemberBinding = new Binding("sia_segnom_usua") });
            ...
            gobGridView.Columns.Add(new GridViewColumn { Header = "Codigo", Width = 80, DisplayMemberBinding = new Binding("sia_codeps_teps") });
        ...
        public string fcrSelect_Admregadmision()
        {
            ...
            if (gobDataGrid.SelectedIndex != -1)
            {
                ...
                lcrReturn = objReg["cto_idesec_ctou"].ToString().Trim();
            }
            return lcrReturn;
        }
        #endregion
