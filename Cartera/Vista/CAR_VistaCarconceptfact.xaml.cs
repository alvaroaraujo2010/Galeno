//- MARMOTA-GENCODE: VERSION 2.0 - 26/09/2017 06:22:00 AM
using System;
...
namespace Cartera.Vista
{
    ...
    /// </summary>
    public partial class VistaCarconceptfact : Window, SIS_Interface
    {
        //-------------------------------------------------
        // Inicio Formulario
        //-------------------------------------------------
        ...
        VistaModeloCarconceptfact vm = null;
        DialogVistaErrores lobDlgLogs = null;
        /// <summary>
        /// Inicializar nueva instancia de la clase
        /// </summary>
        public VistaCarconceptfact()
        {
            InitializeComponent();

            vm = this.DataContext as VistaModeloCarconceptfact;
            vm.Restaurar();
        ...
        private void fcvNuevoRegistro(object sender, RoutedEventArgs e)
        {
            ...
            FocusManager.SetFocusedElement(this, txtG1Car_descon_cacf);
        }
        ...
        public void fcvActivarModoEdicion(string tcrTipoEdicion)
        {
            ...
            {
                FocusManager.SetFocusedElement(this, txtG1Car_codcon_cacf);
        ...
        {
            vm.Restaurar();
            LocalizadorVistaModelo.fcvLiberarVistaModeloCarconceptfact();
        ...
        #region KeyDown para campos con F2 Tabla: CARCONCEPTFACT
        #endregion
        #endregion
        //-------------------------------------------------
        ...
        private void SeleccionComboBoxOpcion(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "cboG1Car_estreg_cacf":
                            txtG1Car_estreg_cacf.Text = CrtForms.fcrSeletDesdeComb(lobList.IdIndice,
                                                                                    txtG1Car_estreg_cacf.Text, ",",
                                                                                    lobList.ListaValoresSel);
                            lobCombo.SelectedIndex = CrtForms.fnuMostrarItemCombo(txtG1Car_estreg_cacf.Text, ",", lobList.ListaValoresSel);
                            break;
                    }
                }
            }
        ...
        private void ActualizarComboBoxOpcion(object sender, TextChangedEventArgs e)
        {
            try
            {
                if (llgObjetosCargados == true)
                {
                    ...
                    {
                        case "txtG1Car_estreg_cacf":
                            CrtForms.ListaComboBox lobG1ComboBox1 = (CrtForms.ListaComboBox)cboG1Car_estreg_cacf.SelectedItem;
                            cboG1Car_estreg_cacf.SelectedIndex = CrtForms.fnuMostrarItemCombo(lcrValor, ",", lobG1ComboBox1.ListaValoresSel);
                            break;
                    }
                }
            }
